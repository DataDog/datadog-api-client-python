...
class TestIncidentUpdateAttributes(unittest.TestCase):
    """IncidentUpdateAttributes unit test stubs"""
    ...
    def testIncidentUpdateAttributes(self):
        """Test IncidentUpdateAttributes"""
        # FIXME: construct object with mandatory attributes with example values
        # model = IncidentUpdateAttributes()  # noqa: E501
        pass
