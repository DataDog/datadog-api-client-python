...
class TestRelationshipToOrganizations(unittest.TestCase):
    """RelationshipToOrganizations unit test stubs"""
    ...
    def testRelationshipToOrganizations(self):
        """Test RelationshipToOrganizations"""
        # FIXME: construct object with mandatory attributes with example values
        # model = RelationshipToOrganizations()  # noqa: E501
        pass
