...
class TestIncidentResponseIncludedItem(unittest.TestCase):
    """IncidentResponseIncludedItem unit test stubs"""
    ...
    def testIncidentResponseIncludedItem(self):
        """Test IncidentResponseIncludedItem"""
        # FIXME: construct object with mandatory attributes with example values
        # model = IncidentResponseIncludedItem()  # noqa: E501
        pass
