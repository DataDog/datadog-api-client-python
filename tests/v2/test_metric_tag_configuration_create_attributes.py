...
class TestMetricTagConfigurationCreateAttributes(unittest.TestCase):
    """MetricTagConfigurationCreateAttributes unit test stubs"""
    ...
    def testMetricTagConfigurationCreateAttributes(self):
        """Test MetricTagConfigurationCreateAttributes"""
        # FIXME: construct object with mandatory attributes with example values
        # model = MetricTagConfigurationCreateAttributes()  # noqa: E501
        pass
