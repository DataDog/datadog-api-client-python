...
Feature: Security Monitoring
  ...
  @generated @skip @team:DataDog/k9-cloud-siem
  Scenario: Get Cloud SIEM log formatting issues returns "OK" response
    Given operation "ListLogFormattingIssues" enabled
    And new "ListLogFormattingIssues" request
    When the request is sent
    Then the response status is 200 OK
