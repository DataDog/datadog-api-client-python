...
Feature: Cloud Cost Management
  ...
  Scenario: Update ruleset returns "OK" response
    ...
    And request contains "ruleset_id" parameter with value "1c5dae14-237d-4b9a-a515-aa55b3939142"
    And body with value {"data": {"attributes": {"enabled": true, "last_version": 3601919, "rules": [{"enabled": true, "mapping": {"destination_key": "team_owner", "if_not_exists": true, "source_keys": ["account_name", "account_id"]}, "metadata": null, "name": "Account Name Mapping", "query": null, "reference_table": null}]}, "type": "update_ruleset"}}
    When the request is sent
    Then the response status is 200 OK
