...
class TestRelationshipToIncidentPostmortem(unittest.TestCase):
    """RelationshipToIncidentPostmortem unit test stubs"""
    ...
    def testRelationshipToIncidentPostmortem(self):
        """Test RelationshipToIncidentPostmortem"""
        # FIXME: construct object with mandatory attributes with example values
        # model = RelationshipToIncidentPostmortem()  # noqa: E501
        pass
