...
class TestMetricAllTagsResponse(unittest.TestCase):
    """MetricAllTagsResponse unit test stubs"""
    ...
    def testMetricAllTagsResponse(self):
        """Test MetricAllTagsResponse"""
        # FIXME: construct object with mandatory attributes with example values
        # model = MetricAllTagsResponse()  # noqa: E501
        pass
