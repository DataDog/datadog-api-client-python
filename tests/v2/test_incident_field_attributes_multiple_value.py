...
class TestIncidentFieldAttributesMultipleValue(unittest.TestCase):
    """IncidentFieldAttributesMultipleValue unit test stubs"""
    ...
    def testIncidentFieldAttributesMultipleValue(self):
        """Test IncidentFieldAttributesMultipleValue"""
        # FIXME: construct object with mandatory attributes with example values
        # model = IncidentFieldAttributesMultipleValue()  # noqa: E501
        pass
