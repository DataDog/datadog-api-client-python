...
class TestApplicationKeyCreateRequest(unittest.TestCase):
    """ApplicationKeyCreateRequest unit test stubs"""
    ...
    def testApplicationKeyCreateRequest(self):
        """Test ApplicationKeyCreateRequest"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ApplicationKeyCreateRequest()  # noqa: E501
        pass
