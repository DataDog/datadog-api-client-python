...
class TestSecurityFiltersResponse(unittest.TestCase):
    """SecurityFiltersResponse unit test stubs"""
    ...
    def testSecurityFiltersResponse(self):
        """Test SecurityFiltersResponse"""
        # FIXME: construct object with mandatory attributes with example values
        # model = SecurityFiltersResponse()  # noqa: E501
        pass
