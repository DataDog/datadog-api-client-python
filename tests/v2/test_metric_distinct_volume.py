...
class TestMetricDistinctVolume(unittest.TestCase):
    """MetricDistinctVolume unit test stubs"""
    ...
    def testMetricDistinctVolume(self):
        """Test MetricDistinctVolume"""
        # FIXME: construct object with mandatory attributes with example values
        # model = MetricDistinctVolume()  # noqa: E501
        pass
