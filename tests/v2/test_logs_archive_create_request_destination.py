...
class TestLogsArchiveCreateRequestDestination(unittest.TestCase):
    """LogsArchiveCreateRequestDestination unit test stubs"""
    ...
    def testLogsArchiveCreateRequestDestination(self):
        """Test LogsArchiveCreateRequestDestination"""
        # FIXME: construct object with mandatory attributes with example values
        # model = LogsArchiveCreateRequestDestination()  # noqa: E501
        pass
