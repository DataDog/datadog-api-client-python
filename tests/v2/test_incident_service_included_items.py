...
class TestIncidentServiceIncludedItems(unittest.TestCase):
    """IncidentServiceIncludedItems unit test stubs"""
    ...
    def testIncidentServiceIncludedItems(self):
        """Test IncidentServiceIncludedItems"""
        # FIXME: construct object with mandatory attributes with example values
        # model = IncidentServiceIncludedItems()  # noqa: E501
        pass
