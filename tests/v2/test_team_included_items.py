...
class TestTeamIncludedItems(unittest.TestCase):
    """TeamIncludedItems unit test stubs"""
    ...
    def testTeamIncludedItems(self):
        """Test TeamIncludedItems"""
        # FIXME: construct object with mandatory attributes with example values
        # model = TeamIncludedItems()  # noqa: E501
        pass
