...
def service(vcr_cassette, client, unique):
    ...
    from datadog_api_client.v2.exceptions import ApiException
    from datadog_api_client.v2.model import service_request
    from datadog_api_client.v2.model import service
    from datadog_api_client.v2.model import service_attributes
    ...
    body = service_request.ServiceRequest(
        data=service.Service(
            ...
            attributes=service_attributes.ServiceAttributes(
                name=str(unique), ),
        ), )
...
def team(vcr_cassette, client, unique):
    ...
    from datadog_api_client.v2.exceptions import ApiException
    from datadog_api_client.v2.model import team_request
    from datadog_api_client.v2.model import team
    from datadog_api_client.v2.model import team_attributes
    ...
    api = TeamsApi(client)
    body = team_request.TeamRequest(
        data=team.Team(
            type=team_type.TeamType(value="teams"),
            attributes=team_attributes.TeamAttributes(
                name=str(unique), ),
        ), )
