...
class TestSecurityFilterUpdateRequest(unittest.TestCase):
    """SecurityFilterUpdateRequest unit test stubs"""
    ...
    def testSecurityFilterUpdateRequest(self):
        """Test SecurityFilterUpdateRequest"""
        # FIXME: construct object with mandatory attributes with example values
        # model = SecurityFilterUpdateRequest()  # noqa: E501
        pass
