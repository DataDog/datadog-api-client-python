...
try:
    ...
    distribution_widget_definition_type = sys.modules["datadog_api_client.v1.model.distribution_widget_definition_type"]
try:
    from datadog_api_client.v1.model import distribution_widget_request
except ImportError:
    distribution_widget_request = sys.modules["datadog_api_client.v1.model.distribution_widget_request"]
try:
