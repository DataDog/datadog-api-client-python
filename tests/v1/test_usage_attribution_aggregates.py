...
class TestUsageAttributionAggregates(unittest.TestCase):
    """UsageAttributionAggregates unit test stubs"""
    ...
    def testUsageAttributionAggregates(self):
        """Test UsageAttributionAggregates"""
        # FIXME: construct object with mandatory attributes with example values
        # model = UsageAttributionAggregates()  # noqa: E501
        pass
