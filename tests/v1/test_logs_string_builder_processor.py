...
try:
    from datadog_api_client.v1.model import logs_string_builder_processor_type
except ImportError:
    logs_string_builder_processor_type = sys.modules["datadog_api_client.v1.model.logs_string_builder_processor_type"]
