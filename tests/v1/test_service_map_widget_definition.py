...
try:
    from datadog_api_client.v1.model import service_map_widget_definition_type
except ImportError:
    service_map_widget_definition_type = sys.modules["datadog_api_client.v1.model.service_map_widget_definition_type"]
try:
