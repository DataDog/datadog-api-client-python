...
class TestUsageTopAvgMetricsMetadata(unittest.TestCase):
    """UsageTopAvgMetricsMetadata unit test stubs"""
    ...
    def testUsageTopAvgMetricsMetadata(self):
        """Test UsageTopAvgMetricsMetadata"""
        # FIXME: construct object with mandatory attributes with example values
        # model = UsageTopAvgMetricsMetadata()  # noqa: E501
        pass
