...
try:
    ...
    logs_arithmetic_processor = sys.modules["datadog_api_client.v1.model.logs_arithmetic_processor"]
try:
    from datadog_api_client.v1.model import logs_attribute_remapper
except ImportError:
    logs_attribute_remapper = sys.modules["datadog_api_client.v1.model.logs_attribute_remapper"]
try:
    from datadog_api_client.v1.model import logs_category_processor
except ImportError:
    logs_category_processor = sys.modules["datadog_api_client.v1.model.logs_category_processor"]
try:
...
try:
    ...
    logs_date_remapper = sys.modules["datadog_api_client.v1.model.logs_date_remapper"]
try:
...
try:
    ...
    logs_geo_ip_parser = sys.modules["datadog_api_client.v1.model.logs_geo_ip_parser"]
try:
    from datadog_api_client.v1.model import logs_grok_parser
except ImportError:
    logs_grok_parser = sys.modules["datadog_api_client.v1.model.logs_grok_parser"]
try:
...
try:
    ...
    logs_lookup_processor = sys.modules["datadog_api_client.v1.model.logs_lookup_processor"]
try:
    from datadog_api_client.v1.model import logs_message_remapper
except ImportError:
    logs_message_remapper = sys.modules["datadog_api_client.v1.model.logs_message_remapper"]
try:
    from datadog_api_client.v1.model import logs_pipeline_processor
except ImportError:
    logs_pipeline_processor = sys.modules["datadog_api_client.v1.model.logs_pipeline_processor"]
try:
    from datadog_api_client.v1.model import logs_service_remapper
except ImportError:
    logs_service_remapper = sys.modules["datadog_api_client.v1.model.logs_service_remapper"]
try:
    from datadog_api_client.v1.model import logs_status_remapper
except ImportError:
    logs_status_remapper = sys.modules["datadog_api_client.v1.model.logs_status_remapper"]
try:
    from datadog_api_client.v1.model import logs_string_builder_processor
except ImportError:
    logs_string_builder_processor = sys.modules["datadog_api_client.v1.model.logs_string_builder_processor"]
try:
    from datadog_api_client.v1.model import logs_trace_remapper
except ImportError:
    logs_trace_remapper = sys.modules["datadog_api_client.v1.model.logs_trace_remapper"]
try:
    from datadog_api_client.v1.model import logs_trace_remapper_type
except ImportError:
    logs_trace_remapper_type = sys.modules["datadog_api_client.v1.model.logs_trace_remapper_type"]
try:
    from datadog_api_client.v1.model import logs_url_parser
except ImportError:
    logs_url_parser = sys.modules["datadog_api_client.v1.model.logs_url_parser"]
try:
    from datadog_api_client.v1.model import logs_user_agent_parser
except ImportError:
    logs_user_agent_parser = sys.modules["datadog_api_client.v1.model.logs_user_agent_parser"]
