...
try:
    ...
    change_widget_definition_type = sys.modules["datadog_api_client.v1.model.change_widget_definition_type"]
try:
    from datadog_api_client.v1.model import change_widget_request
except ImportError:
    change_widget_request = sys.modules["datadog_api_client.v1.model.change_widget_request"]
try:
