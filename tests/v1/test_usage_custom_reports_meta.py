...
try:
    from datadog_api_client.v1.model import usage_custom_reports_page
except ImportError:
    usage_custom_reports_page = sys.modules["datadog_api_client.v1.model.usage_custom_reports_page"]
