...
try:
    from datadog_api_client.v1.model import usage_billable_summary_body
except ImportError:
    usage_billable_summary_body = sys.modules["datadog_api_client.v1.model.usage_billable_summary_body"]
