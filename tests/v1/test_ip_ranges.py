...
try:
    ...
    ip_prefixes_agents = sys.modules["datadog_api_client.v1.model.ip_prefixes_agents"]
try:
    from datadog_api_client.v1.model import ip_prefixes_api
except ImportError:
    ip_prefixes_api = sys.modules["datadog_api_client.v1.model.ip_prefixes_api"]
try:
    from datadog_api_client.v1.model import ip_prefixes_apm
except ImportError:
    ip_prefixes_apm = sys.modules["datadog_api_client.v1.model.ip_prefixes_apm"]
try:
    from datadog_api_client.v1.model import ip_prefixes_logs
except ImportError:
    ip_prefixes_logs = sys.modules["datadog_api_client.v1.model.ip_prefixes_logs"]
try:
    from datadog_api_client.v1.model import ip_prefixes_process
except ImportError:
    ip_prefixes_process = sys.modules["datadog_api_client.v1.model.ip_prefixes_process"]
try:
    from datadog_api_client.v1.model import ip_prefixes_synthetics
except ImportError:
    ip_prefixes_synthetics = sys.modules["datadog_api_client.v1.model.ip_prefixes_synthetics"]
try:
    from datadog_api_client.v1.model import ip_prefixes_webhooks
except ImportError:
    ip_prefixes_webhooks = sys.modules["datadog_api_client.v1.model.ip_prefixes_webhooks"]
