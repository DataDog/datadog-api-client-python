...
try:
    ...
    query_value_widget_definition_type = sys.modules["datadog_api_client.v1.model.query_value_widget_definition_type"]
try:
    from datadog_api_client.v1.model import query_value_widget_request
except ImportError:
    query_value_widget_request = sys.modules["datadog_api_client.v1.model.query_value_widget_request"]
try:
