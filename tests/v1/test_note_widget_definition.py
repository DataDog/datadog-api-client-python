...
class TestNoteWidgetDefinition(unittest.TestCase):
    """NoteWidgetDefinition unit test stubs"""
    ...
    def testNoteWidgetDefinition(self):
        """Test NoteWidgetDefinition"""
        # FIXME: construct object with mandatory attributes with example values
        # model = NoteWidgetDefinition()  # noqa: E501
        pass
