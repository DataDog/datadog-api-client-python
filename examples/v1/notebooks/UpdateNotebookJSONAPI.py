"""
Update a notebook returns "OK" response using JSON:API models
"""
...
from datadog_api_client.v1.model.notebook_update_request import NotebookUpdateRequestJSON
...
body = NotebookUpdateRequestJSON(
    cells=[
