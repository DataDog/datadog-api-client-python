...
from datadog_api_client.v1.model.synthetics_global_variable import (
    SyntheticsGlobalVariable,
)
from datadog_api_client.v1.model.synthetics_global_variable_options import (
...
SYNTHETICS_API_TEST_MULTI_STEP_PUBLIC_ID = environ[
