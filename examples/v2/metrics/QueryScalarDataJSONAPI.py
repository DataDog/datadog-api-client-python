"""
Query scalar data across multiple products returns "OK" response using JSON:API models
"""
...
from datadog_api_client.v2.model.scalar_formula_query_request import ScalarFormulaQueryRequestJSON
from datadog_api_client.v2.model.scalar_formula_request_queries import ScalarFormulaRequestQueries

body = ScalarFormulaQueryRequestJSON(
    formulas=[
        QueryFormula(
            formula="a+b",
            limit=FormulaLimit(
