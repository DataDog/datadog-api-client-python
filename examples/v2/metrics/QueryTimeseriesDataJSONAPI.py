"""
Query timeseries data across multiple products returns "OK" response using JSON:API models
"""
...
from datadog_api_client.v2.model.timeseries_formula_query_request import TimeseriesFormulaQueryRequestJSON
from datadog_api_client.v2.model.timeseries_formula_request_queries import TimeseriesFormulaRequestQueries

body = TimeseriesFormulaQueryRequestJSON(
    formulas=[
        QueryFormula(
            formula="a+b",
            limit=FormulaLimit(
