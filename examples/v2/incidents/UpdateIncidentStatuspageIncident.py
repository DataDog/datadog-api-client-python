...
configuration.unstable_operations["update_incident_statuspage_incident"] = True
with ApiClient(configuration) as api_client:
    api_instance = IncidentsApi(api_client)
    response = api_instance.update_incident_statuspage_incident(
        incident_id="incident_id", page_id="page_id", statuspage_incident_id="statuspage_incident_id", body=body
    )
