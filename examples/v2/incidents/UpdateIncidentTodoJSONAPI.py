"""
Update an incident todo returns "OK" response using JSON:API models
"""
...
from datadog_api_client.v2.model.incident_todo_patch_request import IncidentTodoPatchRequestJSON
...
body = IncidentTodoPatchRequestJSON(
