...
configuration.unstable_operations["patch_incident_notification_rule"] = True
with ApiClient(configuration) as api_client:
    api_instance = IncidentsApi(api_client)
    response = api_instance.patch_incident_notification_rule(id=UUID("00000000-0000-0000-0000-000000000001"), body=body)
