"""
Create an incident integration metadata returns "CREATED" response using JSON:API models
"""
...
from datadog_api_client.v2.model.incident_integration_metadata_create_request import (
    IncidentIntegrationMetadataCreateRequestJSON,
)
...
body = IncidentIntegrationMetadataCreateRequestJSON(
