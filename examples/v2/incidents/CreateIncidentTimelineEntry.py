...
configuration.unstable_operations["create_incident_timeline_entry"] = True
with ApiClient(configuration) as api_client:
    api_instance = IncidentsApi(api_client)
    response = api_instance.create_incident_timeline_entry(incident_id="incident_id", body=body)
