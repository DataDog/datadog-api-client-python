            ...
            query=ProductAnalyticsJourneyListQuery(
                computed_columns=[
                    ProductAnalyticsJourneyComputedColumn(
                        name=ProductAnalyticsJourneyComputedColumnName.FIRST_CONVERSION_TIMESTAMPS,
                    ),
                ],
                conversion_type=ProductAnalyticsJourneyConversionType.CONVERSION,
                entity_columns=[],
                group_by=[
...
configuration.unstable_operations["query_product_analytics_journey_list"] = True
with ApiClient(configuration) as api_client:
    api_instance = ProductAnalyticsApi(api_client)
    response = api_instance.query_product_analytics_journey_list(body=body)
