...
body = ScheduleUpdateRequest(
    data=ScheduleUpdateRequestData(
        ...
        attributes=ScheduleUpdateRequestDataAttributes(
            layers=[
                ScheduleUpdateRequestDataAttributesLayersItems(
                    effective_date=datetime(2025, 2, 3, 5, 0, tzinfo=tzutc()),
                    end_date=datetime(2025, 12, 31, 0, 0, tzinfo=tzutc()),
                    ...
                    rotation_start=datetime(2025, 2, 1, 0, 0, tzinfo=tzutc()),
                ),
            ],
...
with ApiClient(configuration) as api_client:
    ...
    response = api_instance.update_on_call_schedule(schedule_uuid=SCHEDULE_DATA_ID, body=body)
