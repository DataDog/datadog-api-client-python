"""
Update a span-based metric returns "OK" response using JSON:API models
"""
...
from datadog_api_client.v2.model.spans_metric_update_request import SpansMetricUpdateRequestJSON
...
body = SpansMetricUpdateRequestJSON(
