"""
Update a single service object returns "OK" response using JSON:API models
"""
...
from datadog_api_client.v2.model.opsgenie_service_update_request import OpsgenieServiceUpdateRequestJSON
