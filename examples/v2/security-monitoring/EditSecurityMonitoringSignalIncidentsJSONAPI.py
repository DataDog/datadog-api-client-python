"""
Change the related incidents of a security signal returns "OK" response using JSON:API models
"""
...
from datadog_api_client.v2.model.security_monitoring_signal_incidents_update_request import (
    SecurityMonitoringSignalIncidentsUpdateRequestJSON,
)

body = SecurityMonitoringSignalIncidentsUpdateRequestJSON(
