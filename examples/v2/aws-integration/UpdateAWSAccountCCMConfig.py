...
configuration.unstable_operations["update_aws_account_ccm_config"] = True
with ApiClient(configuration) as api_client:
    api_instance = AWSIntegrationApi(api_client)
    response = api_instance.update_aws_account_ccm_config(aws_account_config_id="aws_account_config_id", body=body)
