...
from datadog_api_client.v2.api.authentication_api import AuthenticationApi
...
def main():
    ...
    delegated_config = DelegatedTokenConfig(org_uuid=org_uuid, provider="aws", provider_auth=aws_auth)
    ...
    with ApiClient(configuration) as api_client:
        ...
        try:
            # Test the authentication by validating credentials
            api_response = api_instance.validate()
            print("Authentication successful!")
            print(f"Valid: {api_response.valid}")
