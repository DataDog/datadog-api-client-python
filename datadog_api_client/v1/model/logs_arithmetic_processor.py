...
class LogsArithmeticProcessor(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (logs_arithmetic_processor_type.LogsArithmeticProcessorType,),  # noqa: E501
    ...
    def __init__(self, expression, target, type, *args, **kwargs):  # noqa: E501
        """logs_arithmetic_processor.LogsArithmeticProcessor - a model defined in OpenAPI
        ...
        Args:
            ...
            type (logs_arithmetic_processor_type.LogsArithmeticProcessorType):
