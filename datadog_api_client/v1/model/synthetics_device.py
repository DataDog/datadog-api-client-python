...
class SyntheticsDevice(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'id': (synthetics_device_id.SyntheticsDeviceID,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'width': (int,),  # noqa: E501
    ...
    def __init__(self, height, id, name, width, *args, **kwargs):  # noqa: E501
        """synthetics_device.SyntheticsDevice - a model defined in OpenAPI

        Args:
            height (int): Screen height of the device.
            id (synthetics_device_id.SyntheticsDeviceID):
