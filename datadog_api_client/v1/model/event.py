...
class Event(ModelNormal):
    ...
    def __init__(self, text, title, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            date_happened (int): POSIX timestamp of the event. Must be sent as an integer (i.e. no quotes). Limited to events no older than 1 year, 24 days (389 days).. [optional]  # noqa: E501
