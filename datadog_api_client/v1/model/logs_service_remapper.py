...
class LogsServiceRemapper(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (logs_service_remapper_type.LogsServiceRemapperType,),  # noqa: E501
    ...
    def __init__(self, sources, type, *args, **kwargs):  # noqa: E501
        """logs_service_remapper.LogsServiceRemapper - a model defined in OpenAPI

        Args:
            sources ([str]): Array of source attributes.
            type (logs_service_remapper_type.LogsServiceRemapperType):
