...
class SyntheticsBrowserTestResultFullCheck(ModelNormal):
    ...
    def __init__(self, config, *args, **kwargs):  # noqa: E501
        """synthetics_browser_test_result_full_check.SyntheticsBrowserTestResultFullCheck - a model defined in OpenAPI

        Args:
            config (synthetics_test_config.SyntheticsTestConfig):
