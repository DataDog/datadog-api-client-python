...
class WorkflowAutomationApi:
    ...
    def create_workflow_instance(
        ...
        Execute the given workflow. This API requires a `registered application key <https://docs.datadoghq.com/api/latest/action-connection/#register-a-new-app-key>`_. Alternatively, you can also configure these permissions `in our UI <https://docs.datadoghq.com/account_management/api-app-keys/#actions-api-access>`_.
    ...
    def delete_workflow(
        ...
        Delete a workflow by ID. This API requires a `registered application key <https://docs.datadoghq.com/api/latest/action-connection/#register-a-new-app-key>`_. Alternatively, you can also configure these permissions `in our UI <https://docs.datadoghq.com/account_management/api-app-keys/#actions-api-access>`_.
    ...
    def get_workflow(
        ...
        Get a workflow by ID. This API requires a `registered application key <https://docs.datadoghq.com/api/latest/action-connection/#register-a-new-app-key>`_. Alternatively, you can also configure these permissions `in our UI <https://docs.datadoghq.com/account_management/api-app-keys/#actions-api-access>`_.
    ...
    def update_workflow(
        ...
        Update a workflow by ID. This API requires a `registered application key <https://docs.datadoghq.com/api/latest/action-connection/#register-a-new-app-key>`_. Alternatively, you can also configure these permissions `in our UI <https://docs.datadoghq.com/account_management/api-app-keys/#actions-api-access>`_.
