...
class ErrorTrackingApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._get_issue_endpoint = _Endpoint(
            ...
            params_map={
                ...
                "include": {
                    "openapi_types": ([IssueIncludeQueryParameterItem],),
                    "attribute": "include",
                    "location": "query",
    ...
    def get_issue(
        ...
        issue_id: str,
        *,
        include: Union[List[IssueIncludeQueryParameterItem], UnsetType] = unset,
    ) -> IssueResponse:
        ...
        :type include: [IssueIncludeQueryParameterItem], optional
        :rtype: IssueResponse
        """
        kwargs: Dict[str, Any] = {}
