...
class CIVisibilityGitHubAccountsApi:
    ...
    `CI Visibility GitHub Actions setup page <https://docs.datadoghq.com/continuous_integration/setup_dd_ci_visibility_pipelines/github_actions/>`_ for more information.
    """
