...
class ActionsDatastoresApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._write_datastore_item_endpoint = _Endpoint(
            settings={
                "response_type": (PutAppsDatastoreItemResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/actions-datastores/{datastore_id}/items",
                "operation_id": "write_datastore_item",
                "http_method": "POST",
                "version": "v2",
            },
            params_map={
    ...
    def write_datastore_item(
        ...
        return self._write_datastore_item_endpoint.call_with_http_info(**kwargs)
