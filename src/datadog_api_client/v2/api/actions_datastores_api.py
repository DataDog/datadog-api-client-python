...
from datadog_api_client.v2.model.create_apps_datastore_from_import_response import CreateAppsDatastoreFromImportResponse
...
class ActionsDatastoresApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._create_datastore_from_import_endpoint = _Endpoint(
            settings={
                "response_type": (CreateAppsDatastoreFromImportResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/actions-datastores/import",
                "operation_id": "create_datastore_from_import",
                "http_method": "POST",
                "version": "v2",
            },
            params_map={
                "body": {
                    "required": True,
                    "openapi_types": (CreateAppsDatastoreFromImportRequest,),
                    "location": "body",
                },
            },
            headers_map={"accept": ["application/json"], "content_type": ["application/json"]},
        ...
        self._put_datastore_item_endpoint = _Endpoint(
            settings={
                "response_type": (PutAppsDatastoreItemResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/actions-datastores/{datastore_id}/items",
                "operation_id": "put_datastore_item",
                "http_method": "POST",
                "version": "v2",
            },
            params_map={
                ...
                "body": {
                    "required": True,
                    "openapi_types": (PutAppsDatastoreItemRequest,),
                    "location": "body",
                },
            },
            headers_map={"accept": ["application/json"], "content_type": ["application/json"]},
    ...
    def bulk_put_datastore_items(
        ...
        return self._bulk_put_datastore_items_endpoint.call_with_http_info(**kwargs)
    ...
    def create_datastore_from_import(
        self,
        ...
        :type body: CreateAppsDatastoreFromImportRequest
        :rtype: CreateAppsDatastoreFromImportResponse
        """
        kwargs: Dict[str, Any] = {}
        kwargs["body"] = body

        return self._create_datastore_from_import_endpoint.call_with_http_info(**kwargs)
    ...
    def list_datastore_items(
        ...
        *,
        ...
        :param datastore_id: The ID of the datastore.
        :type datastore_id: str
        :param filter: Optional filter to filter the list of items.
        :type filter: str, optional
        :param item_key: Optional item key to filter the list of items.
        :type item_key: str, optional
        :param page_limit: Optional limit to limit the number of items in the list.
        :type page_limit: int, optional
        :param page_offset: Optional offset to offset the list of items.
        :type page_offset: int, optional
        :param sort: Optional sort to sort the list of items.
    ...
    def put_datastore_item(
        ...
        :param datastore_id: The ID of the datastore.
        :type datastore_id: str
        :type body: PutAppsDatastoreItemRequest
        :rtype: PutAppsDatastoreItemResponse
        """
        kwargs: Dict[str, Any] = {}
        kwargs["datastore_id"] = datastore_id
        ...
        return self._put_datastore_item_endpoint.call_with_http_info(**kwargs)
