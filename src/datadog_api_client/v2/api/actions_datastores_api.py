...
from datadog_api_client.v2.model.delete_apps_datastore_response import DeleteAppsDatastoreResponse
...
class ActionsDatastoresApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._delete_datastore_endpoint = _Endpoint(
            settings={
                "response_type": (DeleteAppsDatastoreResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
    ...
    def delete_datastore(
        ...
        :param datastore_id: The ID of the datastore.
        :type datastore_id: str
        :rtype: DeleteAppsDatastoreResponse
        """
        kwargs: Dict[str, Any] = {}
        kwargs["datastore_id"] = datastore_id
