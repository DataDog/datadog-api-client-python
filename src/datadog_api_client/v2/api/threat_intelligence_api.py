...
class ThreatIntelligenceApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._ingest_stix_threat_intel_endpoint = _Endpoint(
            settings={
                "response_type": (STIXIngestResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth", "AuthZ"],
                "endpoint_path": "/api/v2/security/threat-intel/stix",
                "operation_id": "ingest_stix_threat_intel",
                "http_method": "POST",
                "version": "v2",
            },
            params_map={
    ...
    def ingest_stix_threat_intel(
        ...
        *,
        ...
        return self._ingest_stix_threat_intel_endpoint.call_with_http_info(**kwargs)
