...
class ThreatIntelligenceApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._submit_stix_threat_intel_endpoint = _Endpoint(
            settings={
                "response_type": (STIXIngestResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/security/threat-intel/stix",
                "operation_id": "submit_stix_threat_intel",
                "http_method": "POST",
                "version": "v2",
            },
            params_map={
    ...
    def submit_stix_threat_intel(
        ...
        *,
        ...
        :type ti_vendor: str
        :param body: A STIX 2.1 bundle containing indicator objects. The maximum request size is 50 MB. When ``Content-Encoding: gzip`` is used, the limit applies to the compressed bytes received.
        ...
        return self._submit_stix_threat_intel_endpoint.call_with_http_info(**kwargs)
