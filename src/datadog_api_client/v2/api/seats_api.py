...
class SeatsApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._assign_seats_user_v2_endpoint = _Endpoint(
            settings={
                "response_type": (AssignSeatsUserResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/seats/users",
                "operation_id": "assign_seats_user_v2",
                "http_method": "POST",
                "version": "v2",
            },
            params_map={
        ...
        self._get_seats_users_v2_endpoint = _Endpoint(
            settings={
                "response_type": (SeatUserDataArray,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/seats/users",
                "operation_id": "get_seats_users_v2",
                "http_method": "GET",
                "version": "v2",
            },
            params_map={
        ...
        self._unassign_seats_user_v2_endpoint = _Endpoint(
            settings={
                "response_type": None,
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/seats/users",
                "operation_id": "unassign_seats_user_v2",
                "http_method": "DELETE",
                "version": "v2",
            },
            params_map={
    ...
    def assign_seats_user_v2(
        ...
        return self._assign_seats_user_v2_endpoint.call_with_http_info(**kwargs)

    def get_seats_users_v2(
        self,
        product_code: str,
        *,
        ...
        return self._get_seats_users_v2_endpoint.call_with_http_info(**kwargs)

    def unassign_seats_user_v2(
        self,
        ...
        return self._unassign_seats_user_v2_endpoint.call_with_http_info(**kwargs)
