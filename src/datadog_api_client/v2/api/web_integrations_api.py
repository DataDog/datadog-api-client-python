...
class WebIntegrationsApi:
    ...
    * databricks
    ...
    def create_web_integration_account(
        ...
        Note: Returns 403 Forbidden if the integration is not enabled for API access or if the user
        lacks the required permissions to manage integrations.
    ...
    def delete_web_integration_account(
        ...
        Note: Returns 403 Forbidden if the integration is not enabled for API access or if the user
        lacks the required permissions to manage this specific account.
