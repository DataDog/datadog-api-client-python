...
class TagRulesApi:
    ...
    def delete_tag_rule(
        ...
        *,
        ...
        :param policy_id: The unique identifier of the tag rule to delete.
        :type policy_id: str
    ...
    def get_tag_rule(
        ...
        *,
        ...
        :param policy_id: The unique identifier of the tag rule.
        :type policy_id: str
    ...
    def update_tag_rule(
        ...
        :param policy_id: The unique identifier of the tag rule to update.
        :type policy_id: str
