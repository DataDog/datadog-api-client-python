...
class SecurityMonitoringApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._create_security_monitoring_notification_rule_endpoint = _Endpoint(
            settings={
                ...
                "auth": ["apiKeyAuth", "appKeyAuth", "AuthZ"],
                "endpoint_path": "/api/v2/security_monitoring/configuration/notification_profiles",
        ...
        self._delete_security_monitoring_notification_rule_endpoint = _Endpoint(
            settings={
                "response_type": None,
                "auth": ["apiKeyAuth", "appKeyAuth", "AuthZ"],
                "endpoint_path": "/api/v2/security_monitoring/configuration/notification_profiles/{notification_profile_id}",
    ...
    def delete_security_monitoring_notification_rule(
        ...
        :param notification_profile_id: The ID of the notification rule.
        :type notification_profile_id: str
        :rtype: None
        """
        kwargs: Dict[str, Any] = {}
        kwargs["notification_profile_id"] = notification_profile_id
