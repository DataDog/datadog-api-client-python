...
class SecurityMonitoringApi:
    ...
    def list_vulnerabilities(
        ...
        *,
        ...
        filter_cvss_base_severity: Union[Severity, UnsetType] = unset,
        filter_cvss_base_vector: Union[str, UnsetType] = unset,
        filter_cvss_datadog_score_op: Union[float, UnsetType] = unset,
        filter_cvss_datadog_severity: Union[Severity, UnsetType] = unset,
        filter_cvss_datadog_vector: Union[str, UnsetType] = unset,
        filter_status: Union[Status, UnsetType] = unset,
        filter_tool: Union[Tool, UnsetType] = unset,
        ...
        filter_risks_epss_severity: Union[Severity, UnsetType] = unset,
        filter_language: Union[str, UnsetType] = unset,
        filter_ecosystem: Union[Ecosystem, UnsetType] = unset,
        ...
        **Filtering**
        ...
        The request can include some filter params to filter the data to be retrieved. The format of the filter params follows the `JSON:API format <https://jsonapi.org/format/#fetching-filtering>`_ : ``filter[$prop_name]`` , where ``prop_name`` is the property name in the entity being filtered by.
        ...
        **Metadata**
        ...
        :type filter_cvss_base_severity: Severity, optional
        ...
        :type filter_cvss_datadog_severity: Severity, optional
        ...
        :type filter_status: Status, optional
        :param filter_tool: Filter by the tool of the vulnerability.
        :type filter_tool: Tool, optional
