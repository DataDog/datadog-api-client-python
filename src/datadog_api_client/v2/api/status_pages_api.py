...
class StatusPagesApi:
    """
    Manage your status pages and communicate service disruptions to stakeholders via Datadog's API. See the `Status Pages documentation <https://docs.datadoghq.com/incident_response/status_pages/>`_ for more information.
    """
    ...
    def list_maintenances(
        ...
        *,
        ...
        :param include: Comma-separated list of resources to include. Supported values: created_by_user, last_modified_by_user, status_page.
        :type include: str, optional
        :param filter_status: Optional maintenance status filter. Supported values: scheduled, in_progress, completed, canceled.
        :type filter_status: str, optional
