...
class TeamsApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._get_team_hierarchy_links_endpoint = _Endpoint(
            settings={
                "response_type": (TeamHierarchyLinksResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth", "AuthZ"],
                "endpoint_path": "/api/v2/team-hierarchy-links",
                "operation_id": "get_team_hierarchy_links",
                "http_method": "GET",
                "version": "v2",
            },
            params_map={
    ...
    def get_team_hierarchy_links(
        ...
        *,
        ...
        return self._get_team_hierarchy_links_endpoint.call_with_http_info(**kwargs)

    def get_team_hierarchy_links_with_pagination(
        self,
        *,
        page_number: Union[int, UnsetType] = unset,
        page_size: Union[int, UnsetType] = unset,
        ...
        Provide a paginated version of :meth:`get_team_hierarchy_links`, returning all items.
        ...
        endpoint = self._get_team_hierarchy_links_endpoint
