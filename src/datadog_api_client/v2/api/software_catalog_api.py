...
from datadog_api_client.v2.model.accept_recommended_entities_response import AcceptRecommendedEntitiesResponse
...
class SoftwareCatalogApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._accept_recommended_entities_endpoint = _Endpoint(
            settings={
                "response_type": (AcceptRecommendedEntitiesResponse,),
    ...
    def accept_recommended_entities(
    ...
    ) -> AcceptRecommendedEntitiesResponse:
        ...
        :rtype: AcceptRecommendedEntitiesResponse
        """
        kwargs: Dict[str, Any] = {}
        kwargs["body"] = body
