...
class DashboardsApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._search_dashboards_endpoint = _Endpoint(
            settings={
                "response_type": (DashboardSearchResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/dashboards/search",
                "operation_id": "search_dashboards",
                "http_method": "GET",
                "version": "v2",
            },
            params_map={
    ...
    def search_dashboards(
        ...
        *,
        ...
        return self._search_dashboards_endpoint.call_with_http_info(**kwargs)
