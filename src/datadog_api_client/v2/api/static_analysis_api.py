...
class StaticAnalysisApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._post_sca_resolve_vulnerable_symbols_endpoint = _Endpoint(
            settings={
                ...
                "operation_id": "post_sca_resolve_vulnerable_symbols",
                "http_method": "POST",
                "version": "v2",
            },
            params_map={
        ...
        self._post_sca_result_endpoint = _Endpoint(
            settings={
                "response_type": None,
                "auth": ["apiKeyAuth", "appKeyAuth", "AuthZ"],
                "endpoint_path": "/api/v2/static-analysis-sca/dependencies",
                "operation_id": "post_sca_result",
                "http_method": "POST",
                "version": "v2",
            },
            params_map={
    ...
    def post_sca_resolve_vulnerable_symbols(
        self,
        ...
        return self._post_sca_resolve_vulnerable_symbols_endpoint.call_with_http_info(**kwargs)
    ...
    def post_sca_result(
        ...
        return self._post_sca_result_endpoint.call_with_http_info(**kwargs)
