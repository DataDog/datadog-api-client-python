...
class StaticAnalysisApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._show_custom_rule_endpoint = _Endpoint(
            settings={
                "response_type": (CustomRuleResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/static-analysis/custom/rulesets/{ruleset_name}/rules/{rule_name}",
                "operation_id": "show_custom_rule",
                "http_method": "GET",
                "version": "v2",
            },
            params_map={
        ...
        self._show_custom_rule_revision_endpoint = _Endpoint(
            settings={
                ...
                "operation_id": "show_custom_rule_revision",
                "http_method": "GET",
                "version": "v2",
            },
            params_map={
        ...
        self._show_custom_ruleset_endpoint = _Endpoint(
            settings={
                "response_type": (CustomRulesetResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/static-analysis/custom/rulesets/{ruleset_name}",
                "operation_id": "show_custom_ruleset",
                "http_method": "GET",
                "version": "v2",
            },
            params_map={
    ...
    def show_custom_rule(
        ...
        return self._show_custom_rule_endpoint.call_with_http_info(**kwargs)

    def show_custom_rule_revision(
        self,
        ruleset_name: str,
        rule_name: str,
        id: str,
        ...
        return self._show_custom_rule_revision_endpoint.call_with_http_info(**kwargs)

    def show_custom_ruleset(
        self,
        ruleset_name: str,
        ...
        return self._show_custom_ruleset_endpoint.call_with_http_info(**kwargs)
