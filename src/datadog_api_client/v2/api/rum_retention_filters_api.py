...
class RumRetentionFiltersApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._create_retention_filter_endpoint = _Endpoint(
            ...
            params_map={
                ...
                "create_retention_filter_request": {
                    "required": True,
                    "openapi_types": (RumRetentionFilterCreateRequest,),
                    "attribute": "CreateRetentionFilterRequest",
                    "location": "",
                },
            },
        ...
        self._order_retention_filters_endpoint = _Endpoint(
            ...
            params_map={
                ...
                "order_retention_filters_request": {
                    "required": True,
                    "openapi_types": (RumRetentionFiltersOrderRequest,),
                    "attribute": "OrderRetentionFiltersRequest",
                    "location": "",
                },
            },
            headers_map={"accept": ["application/json"], "content_type": ["application/json"]},
        ...
        self._update_retention_filter_endpoint = _Endpoint(
            ...
            params_map={
                ...
                "update_retention_filter_request": {
                    "required": True,
                    "openapi_types": (RumRetentionFilterUpdateRequest,),
                    "attribute": "UpdateRetentionFilterRequest",
                    "location": "",
                },
            },
            headers_map={"accept": ["application/json"], "content_type": ["application/json"]},
    ...
    def create_retention_filter(
        self,
        app_id: str,
        create_retention_filter_request: RumRetentionFilterCreateRequest,
    ) -> RumRetentionFilterResponse:
        """Create a RUM retention filter.

        Create a RUM retention filter for an application.
        Returns RUM retention filter object from the request body when the request is successful.

        :param app_id: Application ID.
        :type app_id: str
        :param create_retention_filter_request: The definition of the new RUM retention filter.
        :type create_retention_filter_request: RumRetentionFilterCreateRequest
        :rtype: RumRetentionFilterResponse
        """
        kwargs: Dict[str, Any] = {}
        kwargs["app_id"] = app_id

        kwargs["create_retention_filter_request"] = create_retention_filter_request
    ...
    def order_retention_filters(
        self,
        app_id: str,
        order_retention_filters_request: RumRetentionFiltersOrderRequest,
        ...
        :param app_id: Application ID.
        :type app_id: str
        :param order_retention_filters_request: New definition of the RUM retention filter.
        :type order_retention_filters_request: RumRetentionFiltersOrderRequest
        :rtype: RumRetentionFiltersOrderResponse
        """
        kwargs: Dict[str, Any] = {}
        kwargs["app_id"] = app_id

        kwargs["order_retention_filters_request"] = order_retention_filters_request
    ...
    def update_retention_filter(
        ...
        app_id: str,
        rf_id: str,
        update_retention_filter_request: RumRetentionFilterUpdateRequest,
    ) -> RumRetentionFilterResponse:
        ...
        :param rf_id: Retention filter ID.
        :type rf_id: str
        :param update_retention_filter_request: New definition of the RUM retention filter.
        :type update_retention_filter_request: RumRetentionFilterUpdateRequest
        :rtype: RumRetentionFilterResponse
        """
        kwargs: Dict[str, Any] = {}
        kwargs["app_id"] = app_id
        ...
        kwargs["update_retention_filter_request"] = update_retention_filter_request
