...
class CSMThreatsApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._batch_update_csm_threats_agent_policy_endpoint = _Endpoint(
            ...
            params_map={
                "body": {
                    "required": True,
                    "openapi_types": (CloudWorkloadSecurityAgentPolicyBatchUpdateRequest,),
                    "location": "body",
                },
            },
    ...
    def batch_update_csm_threats_agent_policy(
        self,
        ...
        :param body: New definition of Agent policies
        :type body: CloudWorkloadSecurityAgentPolicyBatchUpdateRequest
        :rtype: CloudWorkloadSecurityAgentPoliciesListResponse
        """
        kwargs: Dict[str, Any] = {}
        kwargs["body"] = body

        return self._batch_update_csm_threats_agent_policy_endpoint.call_with_http_info(**kwargs)
