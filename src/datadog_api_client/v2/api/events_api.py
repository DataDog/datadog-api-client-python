...
from datadog_api_client.v2.model.change_event_create_response_payload import ChangeEventCreateResponsePayload
...
class EventsApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._create_event_endpoint = _Endpoint(
            settings={
                "response_type": (ChangeEventCreateResponsePayload,),
                "auth": ["apiKeyAuth"],
            ...
            params_map={
                "body": {
                    "required": True,
                    "openapi_types": (ChangeEventCreateRequestPayload,),
                    "location": "body",
                },
            },
    ...
    def create_event(
        ...
        :type body: ChangeEventCreateRequestPayload
        :rtype: ChangeEventCreateResponsePayload
        """
        kwargs: Dict[str, Any] = {}
        kwargs["body"] = body
