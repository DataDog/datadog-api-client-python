...
class AWSIntegrationApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._delete_aws_accountv2_endpoint = _Endpoint(
            settings={
                "response_type": None,
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/integration/aws/accounts/{aws_account_config_id}",
                "operation_id": "delete_aws_accountv2",
                "http_method": "DELETE",
                "version": "v2",
            },
            params_map={
        ...
        self._get_aws_accountv2_endpoint = _Endpoint(
            settings={
                "response_type": (AWSAccountResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/integration/aws/accounts/{aws_account_config_id}",
                "operation_id": "get_aws_accountv2",
                "http_method": "GET",
                "version": "v2",
            },
            params_map={
        ...
        self._list_aws_accountsv2_endpoint = _Endpoint(
            settings={
                "response_type": (AWSAccountsResponse,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/integration/aws/accounts",
                "operation_id": "list_aws_accountsv2",
                "http_method": "GET",
                "version": "v2",
            },
            params_map={},
        ...
        self._patch_aws_accountv2_endpoint = _Endpoint(
            settings={
                "response_type": None,
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/integration/aws/accounts/{aws_account_config_id}",
                "operation_id": "patch_aws_accountv2",
                "http_method": "PATCH",
                "version": "v2",
            },
            params_map={
    ...
    def create_aws_accountv2(
        ...
        return self._create_aws_accountv2_endpoint.call_with_http_info(**kwargs)

    def delete_aws_accountv2(
        self,
        ...
        :param aws_account_config_id: None
        ...
        return self._delete_aws_accountv2_endpoint.call_with_http_info(**kwargs)

    def get_aws_accountv2(
        self,
        aws_account_config_id: str,
    ) -> AWSAccountResponse:
        ...
        return self._get_aws_accountv2_endpoint.call_with_http_info(**kwargs)

    def list_aws_accountsv2(
        self,
    ) -> AWSAccountsResponse:
        ...
        """
        kwargs: Dict[str, Any] = {}
        return self._list_aws_accountsv2_endpoint.call_with_http_info(**kwargs)

    def patch_aws_accountv2(
        self,
        aws_account_config_id: str,
        ...
        return self._patch_aws_accountv2_endpoint.call_with_http_info(**kwargs)
