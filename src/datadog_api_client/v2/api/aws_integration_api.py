...
class AWSIntegrationApi:
    ...
    def __init__(self, api_client=None):
        ...
        self._list_aws_namespaces_endpoint = _Endpoint(
            settings={
                ...
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v2/integration/aws/namespaces",
    ...
    def generate_new_external_id(
        ...
        """
        kwargs: Dict[str, Any] = {}
        return self._generate_new_external_id_endpoint.call_with_http_info(**kwargs)
    ...
    def list_aws_log_services(
        ...
        """
        kwargs: Dict[str, Any] = {}
        return self._list_aws_log_services_endpoint.call_with_http_info(**kwargs)
