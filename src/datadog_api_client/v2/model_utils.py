...
def validate_get_composed_info(constant_args, model_args, self):
    ...
    var_name_to_model_instances = get_var_name_to_model_instances(self, composed_instances)

    # set additional_properties_model_instances
    additional_properties_model_instances = get_additional_properties_model_instances(composed_instances, self)
    ...
    if (
        ...
        and (self._configuration is None or not self._configuration.discard_unknown_keys)
    ):
        raise ApiValueError(
    ...
    return [composed_instances, var_name_to_model_instances, additional_properties_model_instances, unused_args]
