...
class FleetDeploymentV2Cancel(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.fleet_deployment_v2_cancel_attributes import FleetDeploymentV2CancelAttributes
        from datadog_api_client.v2.model.fleet_deployment_resource_type import FleetDeploymentResourceType
    ...
    def __init__(
        self_, attributes: FleetDeploymentV2CancelAttributes, id: str, type: FleetDeploymentResourceType, **kwargs
    ):
        """
        A deployment cancellation response.

        :param attributes: Attributes of a deployment cancellation response.
        :type attributes: FleetDeploymentV2CancelAttributes
