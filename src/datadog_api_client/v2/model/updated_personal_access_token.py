...
class UpdatedPersonalAccessToken(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.personal_access_token_attributes import PersonalAccessTokenAttributes
        from datadog_api_client.v2.model.updated_personal_access_token_relationships import (
    ...
    def __init__(
        ...
        relationships: Union[UpdatedPersonalAccessTokenRelationships, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :type relationships: UpdatedPersonalAccessTokenRelationships, optional
