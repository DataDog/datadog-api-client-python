...
class ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param options: The definition of ``ObservabilityPipelineSensitiveDataScannerProcessorScopeOptions`` object.
        :type options: ObservabilityPipelineSensitiveDataScannerProcessorScopeOptions

        :param target: The definition of ``ObservabilityPipelineSensitiveDataScannerProcessorScopeIncludeTarget`` object.
