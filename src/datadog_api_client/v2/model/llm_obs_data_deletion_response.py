...
class LLMObsDataDeletionResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.llm_obs_data_deletion_response_data import LLMObsDataDeletionResponseData
    ...
    def __init__(self_, data: LLMObsDataDeletionResponseData, **kwargs):
        """
        Response containing details of a submitted LLM Observability data deletion request.

        :param data: Data object for an LLM Observability data deletion response.
        :type data: LLMObsDataDeletionResponseData
        """
