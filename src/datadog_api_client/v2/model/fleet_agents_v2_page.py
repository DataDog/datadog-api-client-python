...
class FleetAgentsV2Page(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "total_count": (int,),
    ...
    def __init__(
        ...
        :param total_count: Total number of agents in the fleet, regardless of any filter.
        :type total_count: int, optional

        :param total_filtered_count: Total number of agents matching the current filter criteria.
