...
class CreateAppsDatastoreFromImportRequestDataAttributesPrimaryKeyGenerationStrategy(ModelSimple):
    """
...
CreateAppsDatastoreFromImportRequestDataAttributesPrimaryKeyGenerationStrategy.NONE = (
    CreateAppsDatastoreFromImportRequestDataAttributesPrimaryKeyGenerationStrategy("none")
)
CreateAppsDatastoreFromImportRequestDataAttributesPrimaryKeyGenerationStrategy.UUID = (
    CreateAppsDatastoreFromImportRequestDataAttributesPrimaryKeyGenerationStrategy("uuid")
)
