...
class NotificationChannelPhoneConfig(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param formatted_number: Formatted number is the formatted international version of Number (e.g. +33 7 1 23 45 67).
        :type formatted_number: str

        :param number: Number is the E-164 formatted phone number (e.g. +3371234567)
        :type number: str

        :param region: Region is the ISO 3166-1 alpha-2 two-letter country code.
        :type region: str
        ...
        :param verified: Verified indicates whether this phone has been verified by the user in Datadog On-Call
        :type verified: bool
        """
