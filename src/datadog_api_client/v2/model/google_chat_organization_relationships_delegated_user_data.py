...
class GoogleChatOrganizationRelationshipsDelegatedUserData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.google_chat_delegated_user_type import GoogleChatDelegatedUserType
    ...
    def __init__(
        self_, id: Union[str, UnsetType] = unset, type: Union[GoogleChatDelegatedUserType, UnsetType] = unset, **kwargs
    ):
        """
