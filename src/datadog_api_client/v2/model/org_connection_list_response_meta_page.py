...
class OrgConnectionListResponseMetaPage(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "total_count": (int,),
    ...
    def __init__(
        ...
        :param total_count: Total number of org connections.
        :type total_count: int, optional

        :param total_filtered_count: Total number of org connections matching the filter.
