...
class SnowflakeIntegrationAccountUpdateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.snowflake_integration_account_update_attributes import (
            SnowflakeIntegrationAccountUpdateAttributes,
    ...
    def __init__(
        self_, attributes: SnowflakeIntegrationAccountUpdateAttributes, id: str, type: IntegrationAccountType, **kwargs
    ):
        """
        ...
        :type attributes: SnowflakeIntegrationAccountUpdateAttributes

        :param id: Unique identifier of the Snowflake integration account to update.
        :type id: str
