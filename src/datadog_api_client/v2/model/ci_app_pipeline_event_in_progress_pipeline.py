...
class CIAppPipelineEventInProgressPipeline(ModelNormal):
    validations = {
        "queue_time": {
            "inclusive_minimum": 0,
        },
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param status: The in progress status of the pipeline.
        :type status: CIAppPipelineEventPipelineInProgressStatus

        :param tags: A list of user-defined tags. The tags must follow the ``key:value`` pattern.
        :type tags: [str], none_type, optional

        :param unique_id: UUID of the pipeline run. The ID has to be the same as the finished pipeline.
        :type unique_id: str
