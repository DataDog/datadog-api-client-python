...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.snowflake_integration_account_authentication_update import (
...
class SnowflakeIntegrationAccountUpdateAttributes(ModelNormal):
    ...
    def __init__(
        ...
        authentication: Union[
            SnowflakeIntegrationAccountAuthenticationUpdate, SnowflakeIntegrationAccountPrivateKeyAuthRequest, UnsetType
        ] = unset,
        ...
        **kwargs,
        ...
        :param authentication: Authentication for updating the Snowflake integration account. Exactly one method is set. An update replaces the authentication object entirely, so it requires the same fields as creating an account.
        :type authentication: SnowflakeIntegrationAccountAuthenticationUpdate, optional
