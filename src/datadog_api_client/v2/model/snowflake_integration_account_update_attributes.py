...
class SnowflakeIntegrationAccountUpdateAttributes(ModelNormal):
    ...
    def __init__(
        ...
        authentication: Union[
            SnowflakeIntegrationAccountAuthenticationUpdate, SnowflakeIntegrationAccountPrivateKeyAuthUpdate, UnsetType
        ] = unset,
        ...
        **kwargs,
        ...
        :param authentication: Authentication for updating the Snowflake integration account. Exactly one method is set.
