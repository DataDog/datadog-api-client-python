...
class UpdateConnectionGroupResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.connection_group_data_response import ConnectionGroupDataResponse
    ...
    def __init__(self_, data: ConnectionGroupDataResponse, **kwargs):
        """
        Response for updating a connection group.

        :param data: Data object for a connection group.
