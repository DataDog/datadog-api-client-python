...
class OnCallNotificationRuleData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.on_call_notification_rule_attributes import OnCallNotificationRuleAttributes
    ...
    def __init__(
        self_,
        type: OnCallNotificationRuleType,
        attributes: Union[OnCallNotificationRuleAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param attributes: Attributes for an on-call notification rule.
        :type attributes: OnCallNotificationRuleAttributes, optional
