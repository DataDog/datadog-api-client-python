...
class AwsWifPersonaMappingAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
    ...
    def __init__(
        self_, account_identifier: str, arn_pattern: str, account_uuid: Union[UUID, UnsetType] = unset, **kwargs
    ):
        """
        ...
        :param account_uuid: The Datadog user UUID corresponding to ``account_identifier``. Read-only — set by the server.
        :type account_uuid: UUID, optional
