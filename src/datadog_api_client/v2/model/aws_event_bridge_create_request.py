...
class AWSEventBridgeCreateRequest(ModelNormal):
    ...
    def __init__(self_, data: AWSEventBridgeCreateRequestData, **kwargs):
        """
        Amazon EventBridge create request body.

        :param data: Amazon EventBridge create request data.
        :type data: AWSEventBridgeCreateRequestData
        """
