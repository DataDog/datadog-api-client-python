...
class GetIoCIndicatorResponseData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.get_io_c_indicator_response_attributes import GetIoCIndicatorResponseAttributes
    ...
    def __init__(
        self_,
        attributes: Union[GetIoCIndicatorResponseAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param attributes: Attributes of the get indicator response.
        :type attributes: GetIoCIndicatorResponseAttributes, optional
