...
class SyntheticsTestResultRedirect(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "location": (str,),
    ...
    def __init__(self_, location: Union[str, UnsetType] = unset, status_code: Union[int, UnsetType] = unset, **kwargs):
        ...
        :param location: Target location of the redirect.
        :type location: str, optional

        :param status_code: HTTP status code of the redirect response.
