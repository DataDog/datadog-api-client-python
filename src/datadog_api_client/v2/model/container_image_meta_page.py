...
class ContainerImageMetaPage(ModelNormal):
    validations = {
        "limit": {
    ...
    def __init__(
        ...
        type: Union[ContainerImageMetaPageType, UnsetType] = unset,
        **kwargs,
    ):
        """
        Paging attributes.
        ...
        :param type: Type of Container Image pagination.
        :type type: ContainerImageMetaPageType, optional
        """
