...
class CoverageSummaryCodeownerStats(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param evaluated_flags_count: Number of coverage flags evaluated for the code owner.
        :type evaluated_flags_count: int, optional

        :param evaluated_reports_count: Number of coverage reports evaluated for the code owner.
        :type evaluated_reports_count: int, optional

        :param patch_coverage: Patch coverage percentage for the code owner.
        :type patch_coverage: float, none_type, optional

        :param total_coverage: Total coverage percentage for the code owner.
