...
class ListInvestigationsResponseData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.list_investigations_response_data_attributes import (
            ListInvestigationsResponseDataAttributes,
    ...
    def __init__(
        self_, attributes: ListInvestigationsResponseDataAttributes, id: str, type: InvestigationType, **kwargs
    ):
        """
        Data for an investigation list item.

        :param attributes: Attributes of an investigation list item.
        :type attributes: ListInvestigationsResponseDataAttributes
