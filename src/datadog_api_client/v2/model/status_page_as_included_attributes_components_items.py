...
class StatusPageAsIncludedAttributesComponentsItems(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.status_page_as_included_attributes_components_items_components_items import (
            StatusPageAsIncludedAttributesComponentsItemsComponentsItems,
        ...
        return {
            "components": ([StatusPageAsIncludedAttributesComponentsItemsComponentsItems],),
            "id": (UUID,),
            "name": (str,),
            "position": (int,),
    ...
    def __init__(
        self_,
        components: Union[List[StatusPageAsIncludedAttributesComponentsItemsComponentsItems], UnsetType] = unset,
