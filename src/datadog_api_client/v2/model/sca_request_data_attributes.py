...
class ScaRequestDataAttributes(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param commit: The definition of ``ScaRequestDataAttributesCommit`` object.
        :type commit: ScaRequestDataAttributesCommit, optional

        :param dependencies: The ``attributes`` ``dependencies``.
        :type dependencies: [ScaRequestDataAttributesDependenciesItems], optional

        :param env: The ``attributes`` ``env``.
        :type env: str, optional

        :param files: The ``attributes`` ``files``.
        :type files: [ScaRequestDataAttributesFilesItems], optional

        :param relations: The ``attributes`` ``relations``.
        :type relations: [ScaRequestDataAttributesRelationsItems], optional

        :param repository: The definition of ``ScaRequestDataAttributesRepository`` object.
        :type repository: ScaRequestDataAttributesRepository, optional

        :param service: The ``attributes`` ``service``.
        :type service: str, optional

        :param tags: The ``attributes`` ``tags``.
        :type tags: {str: (str,)}, optional

        :param vulnerabilities: The ``attributes`` ``vulnerabilities``.
