...
class StatusPageDataAttributesComponentsItemsComponentsItems(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.status_pages_component_group_attributes_components_items_status import (
            StatusPagesComponentGroupAttributesComponentsItemsStatus,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param position: The zero-indexed position of the component. Relative to the other components in the group.
