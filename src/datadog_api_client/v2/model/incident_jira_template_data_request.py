...
class IncidentJiraTemplateDataRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_jira_template_data_attributes_request import (
            IncidentJiraTemplateDataAttributesRequest,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: Attributes for creating or updating an incident Jira template.
        :type attributes: IncidentJiraTemplateDataAttributesRequest
