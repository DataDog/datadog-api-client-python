...
class GetMultipleRulesetsResponseDataAttributesRulesetsItemsRulesItems(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param arguments: The ``items`` ``arguments``.
        ...
        :param checksum: The ``items`` ``checksum``.
        ...
        :param created_by: The ``items`` ``created_by``.
        :type created_by: str, optional

        :param cve: The ``items`` ``cve``.
        :type cve: str, optional

        :param cwe: The ``items`` ``cwe``.
        :type cwe: str, optional

        :param data: The definition of ``GetMultipleRulesetsResponseDataAttributesRulesetsItemsRulesItemsData`` object.
        ...
        :param documentation_url: The ``items`` ``documentation_url``.
        :type documentation_url: str, optional

        :param entity_checked: The ``items`` ``entity_checked``.
        :type entity_checked: str, optional

        :param is_published: The ``items`` ``is_published``.
        :type is_published: bool, optional

        :param is_testing: The ``items`` ``is_testing``.
        :type is_testing: bool, optional

        :param language: The ``items`` ``language``.
        :type language: str, optional

        :param last_updated_at: The ``items`` ``last_updated_at``.
        :type last_updated_at: datetime, optional

        :param last_updated_by: The ``items`` ``last_updated_by``.
        :type last_updated_by: str, optional

        :param name: The ``items`` ``name``.
        :type name: str, optional

        :param regex: The ``items`` ``regex``.
        :type regex: str, optional

        :param severity: The ``items`` ``severity``.
        :type severity: str, optional

        :param short_description: The ``items`` ``short_description``.
        :type short_description: str, optional

        :param should_use_ai_fix: The ``items`` ``should_use_ai_fix``.
        :type should_use_ai_fix: bool, optional

        :param tests: The ``items`` ``tests``.
        :type tests: [GetMultipleRulesetsResponseDataAttributesRulesetsItemsRulesItemsTestsItems], optional

        :param tree_sitter_query: The ``items`` ``tree_sitter_query``.
