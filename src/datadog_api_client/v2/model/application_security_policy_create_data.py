...
class ApplicationSecurityPolicyCreateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.application_security_policy_create_attributes import (
            ApplicationSecurityPolicyCreateAttributes,
    ...
    def __init__(
        self_, attributes: ApplicationSecurityPolicyCreateAttributes, type: ApplicationSecurityPolicyType, **kwargs
    ):
        """
        Object for a single WAF policy.

        :param attributes: Create a new WAF policy.
        :type attributes: ApplicationSecurityPolicyCreateAttributes
