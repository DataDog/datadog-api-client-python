...
class SecurityMonitoringSignalInvestigationRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.security_monitoring_signal_investigation_request_data import (
            SecurityMonitoringSignalInvestigationRequestData,
    ...
    def __init__(self_, data: SecurityMonitoringSignalInvestigationRequestData, **kwargs):
        """
        Request body for creating a security signal investigation.

        :param data: Data for creating a signal investigation.
        :type data: SecurityMonitoringSignalInvestigationRequestData
        """
