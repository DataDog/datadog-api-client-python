...
class SecureEmbedViewingPreferences(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.secure_embed_viewing_preferences_theme import (
    ...
    def __init__(
        ...
        theme: Union[SecureEmbedViewingPreferencesTheme, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :type theme: SecureEmbedViewingPreferencesTheme, optional
        """
