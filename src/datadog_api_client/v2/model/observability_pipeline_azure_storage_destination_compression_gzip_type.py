...
class ObservabilityPipelineAzureStorageDestinationCompressionGzipType(ModelSimple):
    """
    ...
    GZIP: ClassVar["ObservabilityPipelineAzureStorageDestinationCompressionGzipType"]
