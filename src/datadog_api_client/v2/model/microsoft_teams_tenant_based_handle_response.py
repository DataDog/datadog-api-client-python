...
class MicrosoftTeamsTenantBasedHandleResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.microsoft_teams_tenant_based_handle_response_data import (
            MicrosoftTeamsTenantBasedHandleResponseData,
    ...
    def __init__(self_, data: MicrosoftTeamsTenantBasedHandleResponseData, **kwargs):
        """
        Response of a tenant-based handle.

        :param data: Tenant-based handle data from a response.
        :type data: MicrosoftTeamsTenantBasedHandleResponseData
        """
