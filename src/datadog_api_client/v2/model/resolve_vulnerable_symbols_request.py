...
class ResolveVulnerableSymbolsRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.resolve_vulnerable_symbols_request_data import (
    ...
    def __init__(self_, data: Union[ResolveVulnerableSymbolsRequestData, UnsetType] = unset, **kwargs):
        ...
        :param data: The definition of ``ResolveVulnerableSymbolsRequestData`` object.
