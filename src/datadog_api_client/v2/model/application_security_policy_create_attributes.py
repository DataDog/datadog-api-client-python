...
class ApplicationSecurityPolicyCreateAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.application_security_policy_rule_override import (
            ApplicationSecurityPolicyRuleOverride,
    ...
    def __init__(
        ...
        rulesets: Union[List[ApplicationSecurityPolicyRulesetOverride], UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param based_on: When creating a new policy, clone the policy indicated by this identifier.
        :type based_on: str

        :param description: Description of the WAF policy.
        :type description: str

        :param is_default: Make this policy the default policy. The default policy is applied to
        ...
        :param rulesets: Deprecated: Ruleset overrides. Use ``protectionPresets`` instead. **Deprecated**.
        :type rulesets: [ApplicationSecurityPolicyRulesetOverride], optional
