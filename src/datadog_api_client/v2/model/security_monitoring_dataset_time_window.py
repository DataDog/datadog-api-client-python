...
class SecurityMonitoringDatasetTimeWindow(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "_from": (int,),
    ...
    def __init__(self_, _from: Union[int, UnsetType] = unset, to: Union[int, UnsetType] = unset, **kwargs):
        ...
        :param _from: Inclusive start of the time window, in milliseconds since the Unix epoch.
        :type _from: int, optional

        :param to: Exclusive end of the time window, in milliseconds since the Unix epoch.
