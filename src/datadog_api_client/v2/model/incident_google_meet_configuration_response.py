...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.incident_google_meet_configuration_data_response import (
        IncidentGoogleMeetConfigurationDataResponse,
    )
    from datadog_api_client.v2.model.incident_user_data import IncidentUserData


class IncidentGoogleMeetConfigurationResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_google_meet_configuration_data_response import (
            IncidentGoogleMeetConfigurationDataResponse,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param data: Google Meet configuration data in a response.
        :type data: IncidentGoogleMeetConfigurationDataResponse
