...
class AiCustomRuleRevisionResponseAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.custom_rule_revision_attributes_category import (
            CustomRuleRevisionAttributesCategory,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param checksum: Checksum of the revision content.
        :type checksum: str
        ...
        :param created_by: The identifier of the user who created the revision.
        :type created_by: str
        ...
        :param is_default: Whether this is a default Datadog rule.
