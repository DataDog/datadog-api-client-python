...
class SecurityMonitoringSuppressionSort(ModelSimple):
    ...
    :param value: Must be one of ["name", "start_date", "expiration_date", "update_date", "creation_date", "enabled", "-name", "-start_date", "-expiration_date", "-update_date", "-creation_date", "-enabled"].
    :type value: str
    """
    ...
    CREATION_DATE: ClassVar["SecurityMonitoringSuppressionSort"]
...
SecurityMonitoringSuppressionSort.CREATION_DATE = SecurityMonitoringSuppressionSort("creation_date")
