...
class AssigneeRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.assignee_request_data import AssigneeRequestData
    ...
    def __init__(self_, data: AssigneeRequestData, **kwargs):
        """
        Request to assign or unassign security findings.

        :param data: Data of the assignee request.
        :type data: AssigneeRequestData
        """
