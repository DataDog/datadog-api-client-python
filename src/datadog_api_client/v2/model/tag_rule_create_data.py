...
class TagRuleCreateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.tag_rule_create_attributes import TagRuleCreateAttributes
        from datadog_api_client.v2.model.tag_rule_resource_type import TagRuleResourceType
    ...
    def __init__(self_, attributes: TagRuleCreateAttributes, type: TagRuleResourceType, **kwargs):
        """
        Data object for creating a tag rule.

        :param attributes: Attributes that can be supplied when creating a tag rule.
        :type attributes: TagRuleCreateAttributes
