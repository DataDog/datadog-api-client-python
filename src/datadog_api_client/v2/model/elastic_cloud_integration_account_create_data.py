...
class ElasticCloudIntegrationAccountCreateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.elastic_cloud_integration_account_create_attributes import (
            ElasticCloudIntegrationAccountCreateAttributes,
    ...
    def __init__(
        self_, attributes: ElasticCloudIntegrationAccountCreateAttributes, type: IntegrationAccountType, **kwargs
    ):
        """
        Data envelope for creating an Elastic Cloud integration account.

        :param attributes: Writable attributes used to create an Elastic Cloud integration account.
        :type attributes: ElasticCloudIntegrationAccountCreateAttributes
