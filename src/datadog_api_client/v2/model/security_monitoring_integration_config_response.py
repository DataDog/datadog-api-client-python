...
class SecurityMonitoringIntegrationConfigResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.security_monitoring_integration_config_data import (
            SecurityMonitoringIntegrationConfigData,
    ...
    def __init__(self_, data: SecurityMonitoringIntegrationConfigData, **kwargs):
        """
        Response containing a single entity context sync configuration.

        :param data: An entity context sync configuration.
