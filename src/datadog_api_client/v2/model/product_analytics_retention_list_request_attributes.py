...
class ProductAnalyticsRetentionListRequestAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.product_analytics_retention_list_query import (
    ...
    def __init__(self_, _from: int, query: ProductAnalyticsRetentionListQuery, to: int, **kwargs):
        """
        ...
        :param query: Query definition for a retention list request.
        :type query: ProductAnalyticsRetentionListQuery
