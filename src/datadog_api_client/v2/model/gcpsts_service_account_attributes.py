...
class GCPSTSServiceAccountAttributes(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param is_global_location_enabled: When enabled, metrics where location is explicitly stated as “global” or where location information cannot be deduced from GCP labels is collected.
        ...
        :param region_filter_configs: Filters to limit metric collection by GCP location, such as region, multi-region, or zone. By default, Datadog collects from all locations.
