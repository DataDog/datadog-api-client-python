...
class PatchDegradationTemplateRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.patch_degradation_template_request_data_attributes import (
            PatchDegradationTemplateRequestDataAttributes,
    ...
    def __init__(
        ...
        id: str,
        type: PatchDegradationTemplateRequestDataType,
        attributes: Union[PatchDegradationTemplateRequestDataAttributes, UnsetType] = unset,
        **kwargs,
    ):
        """
        The data object for updating a degradation template.

        :param attributes: The supported attributes for updating a degradation template.
        :type attributes: PatchDegradationTemplateRequestDataAttributes, optional
