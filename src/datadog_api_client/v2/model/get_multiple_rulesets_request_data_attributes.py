...
class GetMultipleRulesetsRequestDataAttributes(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param include_testing_rules: The ``attributes`` ``include_testing_rules``.
        :type include_testing_rules: bool, optional

        :param include_tests: The ``attributes`` ``include_tests``.
        :type include_tests: bool, optional

        :param rulesets: The ``attributes`` ``rulesets``.
