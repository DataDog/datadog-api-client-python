...
class DeviceDetailsDataAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "agent_key": (str,),
    ...
    def __init__(
        ...
        battery_charge_pct: Union[int, UnsetType] = unset,
        battery_charge_rate: Union[int, UnsetType] = unset,
        battery_cycle_count: Union[int, UnsetType] = unset,
        ...
        packets_in_drop: Union[float, UnsetType] = unset,
        packets_in_error: Union[float, UnsetType] = unset,
        packets_out_drop: Union[float, UnsetType] = unset,
        packets_out_error: Union[float, UnsetType] = unset,
        resource_id: Union[str, UnsetType] = unset,
        serial_number: Union[str, UnsetType] = unset,
        status: Union[str, UnsetType] = unset,
        tcp_out_segs: Union[float, UnsetType] = unset,
        tcp_retrans_segs: Union[float, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param battery_charge_pct: Current battery charge level as a percentage between 0 and 100.
        :type battery_charge_pct: int, optional

        :param battery_charge_rate: Rate at which the battery is charging or discharging, in milliamperes.
            Negative values indicate discharge.
        :type battery_charge_rate: int, optional

        :param battery_cycle_count: Number of full charge cycles the battery has gone through.
        :type battery_cycle_count: int, optional
        ...
        :param packets_in_drop: Average rate of dropped inbound network packets, in packets per second.
        :type packets_in_drop: float, optional

        :param packets_in_error: Average rate of inbound network packets received with errors, in packets per second.
        :type packets_in_error: float, optional

        :param packets_out_drop: Average rate of dropped outbound network packets, in packets per second.
        :type packets_out_drop: float, optional

        :param packets_out_error: Average rate of outbound network packets sent with errors, in packets per second.
        :type packets_out_error: float, optional
        ...
        :param tcp_out_segs: Average rate of TCP segments sent by the device, in segments per second.
        :type tcp_out_segs: float, optional

        :param tcp_retrans_segs: Average rate of TCP segments retransmitted by the device, in segments per second.
        :type tcp_retrans_segs: float, optional
        ...
        if battery_charge_pct is not unset:
            kwargs["battery_charge_pct"] = battery_charge_pct
        if battery_charge_rate is not unset:
            kwargs["battery_charge_rate"] = battery_charge_rate
        if battery_cycle_count is not unset:
            kwargs["battery_cycle_count"] = battery_cycle_count
        ...
        if packets_in_drop is not unset:
            kwargs["packets_in_drop"] = packets_in_drop
        if packets_in_error is not unset:
            kwargs["packets_in_error"] = packets_in_error
        if packets_out_drop is not unset:
            kwargs["packets_out_drop"] = packets_out_drop
        if packets_out_error is not unset:
            kwargs["packets_out_error"] = packets_out_error
        ...
        if tcp_out_segs is not unset:
            kwargs["tcp_out_segs"] = tcp_out_segs
        if tcp_retrans_segs is not unset:
            kwargs["tcp_retrans_segs"] = tcp_retrans_segs
