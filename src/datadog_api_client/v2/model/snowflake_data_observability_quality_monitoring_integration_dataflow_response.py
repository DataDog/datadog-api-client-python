...
class SnowflakeDataObservabilityQualityMonitoringIntegrationDataflowResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.snowflake_data_observability_quality_monitoring_integration_dataflow_settings_response import (
            SnowflakeDataObservabilityQualityMonitoringIntegrationDataflowSettingsResponse,
    ...
    def __init__(
        ...
        settings: Union[
            SnowflakeDataObservabilityQualityMonitoringIntegrationDataflowSettingsResponse, UnsetType
        ] = unset,
        **kwargs,
    ):
        """
        ...
        :type settings: SnowflakeDataObservabilityQualityMonitoringIntegrationDataflowSettingsResponse, optional
        """
