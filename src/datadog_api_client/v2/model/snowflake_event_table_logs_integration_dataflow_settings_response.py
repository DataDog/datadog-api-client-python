...
class SnowflakeEventTableLogsIntegrationDataflowSettingsResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param event_table_events_enabled: Whether records with a ``record_type`` of ``event`` are collected.
        :type event_table_events_enabled: bool, optional

        :param event_table_logs_enabled: Whether records with a ``record_type`` of ``log`` are collected.
        :type event_table_logs_enabled: bool, optional

        :param event_table_logs_interval_min: How often event table records are collected, in minutes.
        :type event_table_logs_interval_min: int, optional

        :param event_table_span_events_enabled: Whether records with a ``record_type`` of ``span_event`` are collected.
        :type event_table_span_events_enabled: bool, optional

        :param event_table_spans_enabled: Whether records with a ``record_type`` of ``span`` are collected.
