...
class GoogleChatOrganizationsResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.google_chat_organization_data import GoogleChatOrganizationData
    ...
    def __init__(self_, data: List[GoogleChatOrganizationData], **kwargs):
        """
        Response containing a list of Google Chat organization bindings.

        :param data: An array of Google Chat organization bindings.
