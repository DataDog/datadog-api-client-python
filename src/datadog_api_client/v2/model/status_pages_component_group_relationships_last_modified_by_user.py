...
class StatusPagesComponentGroupRelationshipsLastModifiedByUser(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.status_pages_component_group_relationships_last_modified_by_user_data import (
            StatusPagesComponentGroupRelationshipsLastModifiedByUserData,
    ...
    def __init__(self_, data: StatusPagesComponentGroupRelationshipsLastModifiedByUserData, **kwargs):
        """
