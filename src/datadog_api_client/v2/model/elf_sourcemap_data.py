...
class ELFSourcemapData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.elf_sourcemap_attributes import ELFSourcemapAttributes
        from datadog_api_client.v2.model.sourcemap_data_type import SourcemapDataType
    ...
    def __init__(self_, attributes: ELFSourcemapAttributes, id: str, type: SourcemapDataType, **kwargs):
        """
        ELF symbol file data object.

        :param attributes: Attributes of an ELF symbol file.
        :type attributes: ELFSourcemapAttributes
