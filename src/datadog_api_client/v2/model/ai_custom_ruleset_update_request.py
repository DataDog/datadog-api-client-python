...
class AiCustomRulesetUpdateRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.ai_custom_ruleset_update_data import AiCustomRulesetUpdateData
    ...
    def __init__(self_, data: Union[AiCustomRulesetUpdateData, UnsetType] = unset, **kwargs):
        """
        Request body for updating an AI custom ruleset.

        :param data: Request data for updating an AI custom ruleset.
        :type data: AiCustomRulesetUpdateData, optional
        """
