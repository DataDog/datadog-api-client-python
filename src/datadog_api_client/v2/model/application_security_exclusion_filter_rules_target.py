...
class ApplicationSecurityExclusionFilterRulesTarget(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.application_security_exclusion_filter_rules_target_tags import (
            ApplicationSecurityExclusionFilterRulesTargetTags,
    ...
    def __init__(
        ...
        tags: Union[ApplicationSecurityExclusionFilterRulesTargetTags, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :type tags: ApplicationSecurityExclusionFilterRulesTargetTags, optional
        """
