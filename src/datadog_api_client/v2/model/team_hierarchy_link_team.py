...
class TeamHierarchyLinkTeam(ModelNormal):
    ...
    def __init__(self_, attributes: TeamHierarchyLinkTeamAttributes, id: str, type: TeamType, **kwargs):
        """
        Team information in hierarchy link context

        :param attributes: Team attributes in hierarchy link context
        :type attributes: TeamHierarchyLinkTeamAttributes
