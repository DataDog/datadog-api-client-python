...
class SalesforceIncidentsTemplateResponseData(ModelNormal):
    validations = {
        "id": {
            "max_length": 100,
            "min_length": 1,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: Salesforce incident template attributes returned by the API.
        :type attributes: SalesforceIncidentsTemplateResponseAttributes

        :param id: The ID of the Salesforce incident template.
        :type id: str
