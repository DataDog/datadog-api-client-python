...
class IntegrationAccountResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.integration_account_data import IntegrationAccountData
    ...
    def __init__(self_, data: Union[IntegrationAccountData, UnsetType] = unset, **kwargs):
        """
        Response payload for a single integration account.

        :param data: Data envelope of an integration account, including server-assigned identity.
