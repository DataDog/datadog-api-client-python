...
class ProductAnalyticsJourneyFunnelRequestAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.product_analytics_journey_funnel_query import (
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param query: Query definition for a journey funnel request.
        :type query: ProductAnalyticsJourneyFunnelQuery
