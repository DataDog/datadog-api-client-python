...
class PostmortemTemplateAttributesResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.confluence_postmortem_settings import ConfluencePostmortemSettings
        from datadog_api_client.v2.model.google_docs_postmortem_settings import GoogleDocsPostmortemSettings
    ...
    def __init__(
        ...
        content: str,
        created_at: datetime,
        is_default: Union[datetime, none_type],
        location: PostmortemTemplateLocation,
        modified_at: datetime,
        name: str,
        ...
        **kwargs,
        ...
        :param is_default: When set, marks this template as a default. The effective default for an incident type is the template with the most recent ``is_default`` timestamp.
        :type is_default: datetime, none_type

        :param location: The location where the postmortem is created and stored.
        :type location: PostmortemTemplateLocation

        :param modified_at: When the template was last modified.
