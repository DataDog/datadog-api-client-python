...
class JVMSourcemapData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.jvm_sourcemap_attributes import JVMSourcemapAttributes
        from datadog_api_client.v2.model.sourcemap_data_type import SourcemapDataType
    ...
    def __init__(self_, attributes: JVMSourcemapAttributes, id: str, type: SourcemapDataType, **kwargs):
        """
        JVM (ProGuard/R8) mapping file data object.

        :param attributes: Attributes of a JVM mapping file.
        :type attributes: JVMSourcemapAttributes
