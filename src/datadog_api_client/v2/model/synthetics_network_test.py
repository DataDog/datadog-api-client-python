...
class SyntheticsNetworkTest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.synthetics_network_test_config import SyntheticsNetworkTestConfig
        from datadog_api_client.v2.model.synthetics_test_options import SyntheticsTestOptions
    ...
    def __init__(
        ...
        subtype: Union[SyntheticsNetworkTestSubType, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param config: Configuration object for a Network Path test.
        :type config: SyntheticsNetworkTestConfig

        :param locations: Array of locations used to run the test. Network Path tests can be run from managed locations to test public endpoints,
            or from a `Datadog Agent <https://docs.datadoghq.com/synthetics/network_path_tests/#agent-configuration>`_ to test private environments.
        :type locations: [str]
        ...
        :param subtype: Subtype of the Synthetic Network Path test: ``tcp`` , ``udp`` , or ``icmp``.
        :type subtype: SyntheticsNetworkTestSubType, optional

        :param tags: Array of tags attached to the test.
        :type tags: [str], optional

        :param type: Type of the Synthetic test, ``network``.
        :type type: SyntheticsNetworkTestType
        """
