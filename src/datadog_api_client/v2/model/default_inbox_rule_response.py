...
class DefaultInboxRuleResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.default_inbox_rule_data_response import DefaultInboxRuleDataResponse
    ...
    def __init__(self_, data: DefaultInboxRuleDataResponse, **kwargs):
        """
        A single default inbox rule response.

        :param data: The data object for a default inbox rule returned by the API.
