...
class GlobalOrgsMetaPage(ModelNormal):
    validations = {
        "limit": {
    ...
    def __init__(
        ...
        type: Union[GlobalOrgsMetaPageType, UnsetType] = unset,
        **kwargs,
    ):
        """
        Paging attributes.
        ...
        :param type: Type of global orgs pagination.
        :type type: GlobalOrgsMetaPageType, optional
        """
