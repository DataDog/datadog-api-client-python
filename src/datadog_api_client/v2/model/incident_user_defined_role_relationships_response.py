...
class IncidentUserDefinedRoleRelationshipsResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.relationship_to_user import RelationshipToUser
        from datadog_api_client.v2.model.incident_user_defined_role_incident_type_relationship import (
    ...
    def __init__(
        ...
        incident_type: Union[IncidentUserDefinedRoleIncidentTypeRelationship, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type incident_type: IncidentUserDefinedRoleIncidentTypeRelationship, optional
