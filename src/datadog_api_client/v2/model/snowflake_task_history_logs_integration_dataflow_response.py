...
class SnowflakeTaskHistoryLogsIntegrationDataflowResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.snowflake_task_history_logs_integration_dataflow_settings_response import (
            SnowflakeTaskHistoryLogsIntegrationDataflowSettingsResponse,
    ...
    def __init__(
        ...
        settings: Union[SnowflakeTaskHistoryLogsIntegrationDataflowSettingsResponse, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param settings: Settings of the task history logs dataflow.
        :type settings: SnowflakeTaskHistoryLogsIntegrationDataflowSettingsResponse, optional
        """
