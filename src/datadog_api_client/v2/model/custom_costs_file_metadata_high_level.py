...
class CustomCostsFileMetadataHighLevel(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.custom_costs_file_metadata import CustomCostsFileMetadata
    ...
    def __init__(
        self_,
        attributes: Union[CustomCostsFileMetadata, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param attributes: Schema of a Custom Costs metadata.
        :type attributes: CustomCostsFileMetadata, optional
