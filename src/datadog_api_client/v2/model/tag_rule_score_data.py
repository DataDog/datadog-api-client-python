...
class TagRuleScoreData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.tag_rule_score_attributes import TagRuleScoreAttributes
        from datadog_api_client.v2.model.tag_rule_score_resource_type import TagRuleScoreResourceType
    ...
    def __init__(self_, attributes: TagRuleScoreAttributes, id: str, type: TagRuleScoreResourceType, **kwargs):
        """
        A compliance score resource for a tag rule.

        :param attributes: Attributes of a tag rule compliance score.
        :type attributes: TagRuleScoreAttributes
