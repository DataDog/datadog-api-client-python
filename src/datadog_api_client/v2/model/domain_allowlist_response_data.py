...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.domain_allowlist_response_data_attributes import (
        DomainAllowlistResponseDataAttributes,
    )
    from datadog_api_client.v2.model.domain_allowlist_type import DomainAllowlistType


class DomainAllowlistResponseData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.domain_allowlist_response_data_attributes import (
            DomainAllowlistResponseDataAttributes,
    ...
    def __init__(
        self_,
        type: DomainAllowlistType,
        attributes: Union[DomainAllowlistResponseDataAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type attributes: DomainAllowlistResponseDataAttributes, optional
