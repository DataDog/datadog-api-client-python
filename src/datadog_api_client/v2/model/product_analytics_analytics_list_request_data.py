...
class ProductAnalyticsAnalyticsListRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.product_analytics_analytics_list_request_attributes import (
            ProductAnalyticsAnalyticsListRequestAttributes,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :type attributes: ProductAnalyticsAnalyticsListRequestAttributes

        :param type: The resource type for analytics list requests.
        :type type: ProductAnalyticsAnalyticsListRequestType
        """
