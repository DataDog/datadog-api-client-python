...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.aggregated_long_tasks_request_attributes import (
...
class AggregatedLongTasksRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.aggregated_long_tasks_request_attributes import (
            AggregatedLongTasksRequestAttributes,
    ...
    def __init__(
        self_, attributes: AggregatedLongTasksRequestAttributes, type: AggregatedLongTasksRequestType, **kwargs
    ):
        """
        Data envelope for an aggregated long tasks request.

        :param attributes: Attributes for an aggregated long tasks query.
        :type attributes: AggregatedLongTasksRequestAttributes
