...
class ObservabilityPipelineAmazonS3GenericCompressionSnappy(ModelNormal):
    ...
    def __init__(self_, algorithm: ObservabilityPipelineAmazonS3GenericCompressionSnappyType, **kwargs):
        """
        Snappy compression.

        :param algorithm: The compression type. Always ``snappy``.
        :type algorithm: ObservabilityPipelineAmazonS3GenericCompressionSnappyType
        """
