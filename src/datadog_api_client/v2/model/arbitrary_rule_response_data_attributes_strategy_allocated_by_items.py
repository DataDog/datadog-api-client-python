...
class ArbitraryRuleResponseDataAttributesStrategyAllocatedByItems(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.arbitrary_rule_response_data_attributes_strategy_allocated_by_items_allocated_tags_items import (
            ArbitraryRuleResponseDataAttributesStrategyAllocatedByItemsAllocatedTagsItems,
        ...
        return {
            "allocated_tags": ([ArbitraryRuleResponseDataAttributesStrategyAllocatedByItemsAllocatedTagsItems],),
            "percentage": (float,),
        }
    ...
    def __init__(
        self_,
        allocated_tags: List[ArbitraryRuleResponseDataAttributesStrategyAllocatedByItemsAllocatedTagsItems],
        percentage: float,
        **kwargs,
    ):
        """
        ...
        :type allocated_tags: [ArbitraryRuleResponseDataAttributesStrategyAllocatedByItemsAllocatedTagsItems]
