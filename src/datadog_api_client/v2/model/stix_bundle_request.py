...
class STIXBundleRequest(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param objects: The STIX objects included in the bundle. Indicator objects are processed and ingested; other STIX object types are accepted and counted in the ``unsupported`` response counter.
