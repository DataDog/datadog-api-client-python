...
class TestOptimizationGetFlakyTestsManagementPoliciesRequestDataType(ModelSimple):
    """
    ...
    :param value: If omitted defaults to "test_optimization_get_flaky_tests_management_policies_request". Must be one of ["test_optimization_get_flaky_tests_management_policies_request"].
    :type value: str
    """
    ...
    TEST_OPTIMIZATION_GET_FLAKY_TESTS_MANAGEMENT_POLICIES_REQUEST: ClassVar[
