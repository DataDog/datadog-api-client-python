...
class FunnelSuggestionRequestDataAttributesSearch(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.funnel_suggestion_request_data_attributes_search_steps_items import (
            FunnelSuggestionRequestDataAttributesSearchStepsItems,
        ...
        return {
            ...
            "query_string": (str,),
            "steps": ([FunnelSuggestionRequestDataAttributesSearchStepsItems],),
            "subquery_id": (str,),
        }
    ...
    def __init__(
        ...
        steps: Union[List[FunnelSuggestionRequestDataAttributesSearchStepsItems], UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param steps:
        :type steps: [FunnelSuggestionRequestDataAttributesSearchStepsItems], optional
