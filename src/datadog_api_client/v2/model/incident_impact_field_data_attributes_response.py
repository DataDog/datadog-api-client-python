...
class IncidentImpactFieldDataAttributesResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_impact_field_choice import IncidentImpactFieldChoice
        from datadog_api_client.v2.model.incident_impact_field_value_type import IncidentImpactFieldValueType
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param name: The normalized name of the impact field.
        :type name: str

        :param tag_key: The tag key associated with the field.
