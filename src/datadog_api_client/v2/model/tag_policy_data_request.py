...
class TagPolicyDataRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.tag_policy_attributes_request import TagPolicyAttributesRequest
        from datadog_api_client.v2.model.tag_policy_type import TagPolicyType
    ...
    def __init__(self_, attributes: TagPolicyAttributesRequest, type: TagPolicyType, **kwargs):
        """
        Data envelope for tag policy create request.

        :param attributes: Attributes for creating or updating a tag policy.
        :type attributes: TagPolicyAttributesRequest
