...
class ObservabilityPipelineGoogleCloudStorageDestinationCompressionZstd(ModelNormal):
    validations = {
        "level": {
    ...
    def __init__(
        self_, algorithm: ObservabilityPipelineGoogleCloudStorageDestinationCompressionZstdType, level: int, **kwargs
    ):
        """
        Zstd compression.
