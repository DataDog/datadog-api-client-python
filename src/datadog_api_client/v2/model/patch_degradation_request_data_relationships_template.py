...
class PatchDegradationRequestDataRelationshipsTemplate(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.patch_degradation_request_data_relationships_template_data import (
            PatchDegradationRequestDataRelationshipsTemplateData,
    ...
    def __init__(self_, data: PatchDegradationRequestDataRelationshipsTemplateData, **kwargs):
        """
        ...
        :type data: PatchDegradationRequestDataRelationshipsTemplateData
        """
