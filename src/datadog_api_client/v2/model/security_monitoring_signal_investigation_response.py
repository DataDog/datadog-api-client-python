...
class SecurityMonitoringSignalInvestigationResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.security_monitoring_signal_investigation_response_data import (
            SecurityMonitoringSignalInvestigationResponseData,
    ...
    def __init__(self_, data: SecurityMonitoringSignalInvestigationResponseData, **kwargs):
        """
        Response containing investigation details for a security signal.

        :param data: Data containing the investigation details.
        :type data: SecurityMonitoringSignalInvestigationResponseData
        """
