...
class CustomDestinationResponseForwardDestinationElasticsearchType(ModelSimple):
    """
    ...
    ELASTICSEARCH: ClassVar["CustomDestinationResponseForwardDestinationElasticsearchType"]
