...
class ExecutionPolicyUpdateRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.execution_policy_write_attributes import ExecutionPolicyWriteAttributes
        from datadog_api_client.v2.model.execution_policy_type import ExecutionPolicyType
    ...
    def __init__(self_, attributes: ExecutionPolicyWriteAttributes, id: str, type: ExecutionPolicyType, **kwargs):
        """
        Object for a single execution policy.

        :param attributes: Attributes used to create or update an execution policy.
        :type attributes: ExecutionPolicyWriteAttributes
