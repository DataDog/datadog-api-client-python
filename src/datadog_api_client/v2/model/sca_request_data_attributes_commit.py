...
class ScaRequestDataAttributesCommit(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param author_date: The ``commit`` ``author_date``.
        :type author_date: str, optional

        :param author_email: The ``commit`` ``author_email``.
        :type author_email: str, optional

        :param author_name: The ``commit`` ``author_name``.
        :type author_name: str, optional

        :param branch: The ``commit`` ``branch``.
        :type branch: str, optional

        :param committer_email: The ``commit`` ``committer_email``.
        :type committer_email: str, optional

        :param committer_name: The ``commit`` ``committer_name``.
