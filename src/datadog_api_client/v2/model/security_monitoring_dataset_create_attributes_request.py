...
class SecurityMonitoringDatasetCreateAttributesRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
    ...
    def __init__(self_, definition: SecurityMonitoringDatasetDefinition, description: str, **kwargs):
        """
