...
class SnowflakeTaskHistoryLogsIntegrationDataflowSettingsResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
    ...
    def __init__(self_, task_history_logs_interval_min: Union[int, UnsetType] = unset, **kwargs):
        ...
        :param task_history_logs_interval_min: How often task history logs are collected, in minutes.
