...
class DatabricksCloudCostMetricsIntegrationDataflowResponse(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Cost data collected from your Databricks system tables. Requires `Cloud Cost Management <https://docs.datadoghq.com/cloud_cost_management/>`_ to be set up for your organization.
