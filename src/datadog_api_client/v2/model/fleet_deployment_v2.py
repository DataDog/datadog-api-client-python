...
class FleetDeploymentV2(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.fleet_deployment_v2_attributes import FleetDeploymentV2Attributes
        from datadog_api_client.v2.model.fleet_deployment_resource_type import FleetDeploymentResourceType
    ...
    def __init__(self_, attributes: FleetDeploymentV2Attributes, id: str, type: FleetDeploymentResourceType, **kwargs):
        """
        A deployment in the v2 API response.

        :param attributes: Attributes of a deployment in the v2 API response.
        :type attributes: FleetDeploymentV2Attributes
