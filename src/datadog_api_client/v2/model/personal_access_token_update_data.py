...
class PersonalAccessTokenUpdateData(ModelNormal):
    ...
    def __init__(
        self_, attributes: PersonalAccessTokenUpdateAttributes, id: UUID, type: PersonalAccessTokenType, **kwargs
    ):
        """
        ...
        :param id: UUID of the personal access token. Must match the path parameter.
        :type id: UUID
