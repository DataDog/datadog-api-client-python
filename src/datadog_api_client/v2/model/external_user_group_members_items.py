...
class ExternalUserGroupMembersItems(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "_ref": (str,),
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param display: A human-readable name for the group member.
        :type display: str, optional

        :param type: A label indicating the type of resource.
