...
class IncidentReservedRoleResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_reserved_role_data_response import IncidentReservedRoleDataResponse
    ...
    def __init__(self_, data: IncidentReservedRoleDataResponse, **kwargs):
        """
        Response with a single reserved role.

        :param data: Reserved role data in a response.
