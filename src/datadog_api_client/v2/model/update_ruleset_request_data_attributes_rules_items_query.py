...
class UpdateRulesetRequestDataAttributesRulesItemsQuery(ModelNormal):
    _nullable = True
    ...
    def __init__(
        self_,
        addition: Union[UpdateRulesetRequestDataAttributesRulesItemsQueryAddition, none_type],
        if_not_exists: bool,
        query: str,
        ...
        **kwargs,
        ...
        :param addition: The definition of ``UpdateRulesetRequestDataAttributesRulesItemsQueryAddition`` object.
        :type addition: UpdateRulesetRequestDataAttributesRulesItemsQueryAddition, none_type
