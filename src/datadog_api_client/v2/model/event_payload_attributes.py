...
class EventPayloadAttributes(ModelComposed):
    def __init__(self, **kwargs):
        ...
        :param author: Object representing the entity that made the change. Optional field, but if provided it must include `type` and `name`.
        ...
        :param custom: Custom attributes. Supports up to 100 properties per object and a maximum nesting depth of 10 levels.
