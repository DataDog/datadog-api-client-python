...
class ResolveVulnerableSymbolsRequestData(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: The definition of ``ResolveVulnerableSymbolsRequestDataAttributes`` object.
        :type attributes: ResolveVulnerableSymbolsRequestDataAttributes, optional

        :param id: The ``ResolveVulnerableSymbolsRequestData`` ``id``.
        :type id: str, optional

        :param type: Resolve vulnerable symbols request resource type.
