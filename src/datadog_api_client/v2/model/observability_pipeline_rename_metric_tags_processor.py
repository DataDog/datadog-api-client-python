...
class ObservabilityPipelineRenameMetricTagsProcessor(ModelNormal):
    validations = {
        "tags": {
            "max_items": 15,
        },
    ...
    def openapi_types(_):
        ...
        return {
            ...
            "id": (str,),
            "include": (str,),
            "tags": ([ObservabilityPipelineRenameMetricTagsProcessorTag],),
    ...
    def __init__(
        ...
        id: str,
        include: str,
        tags: List[ObservabilityPipelineRenameMetricTagsProcessorTag],
        type: ObservabilityPipelineRenameMetricTagsProcessorType,
        ...
        **Supported pipeline types:** metrics
        ...
        :param tags: A list of rename rules specifying which tag keys to rename on each metric.
        :type tags: [ObservabilityPipelineRenameMetricTagsProcessorTag]

        :param type: The processor type. The value must be ``rename_metric_tags``.
        :type type: ObservabilityPipelineRenameMetricTagsProcessorType
        """
