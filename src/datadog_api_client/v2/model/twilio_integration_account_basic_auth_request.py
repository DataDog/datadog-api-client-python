...
class TwilioIntegrationAccountBasicAuthRequest(ModelNormal):
    @cached_property
    ...
    def __init__(self_, auth_type: TwilioIntegrationAccountBasicAuthType, password: str, username: str, **kwargs):
        """
