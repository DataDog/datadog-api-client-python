...
class ElasticCloudCcmAccountUpdateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.elastic_cloud_ccm_account_update_attributes import (
            ElasticCloudCcmAccountUpdateAttributes,
    ...
    def __init__(self_, attributes: ElasticCloudCcmAccountUpdateAttributes, type: IntegrationAccountType, **kwargs):
        """
        Data envelope for updating an Elastic Cloud CCM account.

        :param attributes: Updatable attributes of an Elastic Cloud CCM account. Every field is optional; only the fields provided are changed.
        :type attributes: ElasticCloudCcmAccountUpdateAttributes
