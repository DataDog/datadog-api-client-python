...
class LogsArchiveCreateRequestAttributes(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'destination': (logs_archive_create_request_destination.LogsArchiveCreateRequestDestination,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'query': (str,),  # noqa: E501
        }
    ...
    def __init__(self, destination, name, query, *args, **kwargs):  # noqa: E501
        """logs_archive_create_request_attributes.LogsArchiveCreateRequestAttributes - a model defined in OpenAPI

        Args:
            destination (logs_archive_create_request_destination.LogsArchiveCreateRequestDestination):
