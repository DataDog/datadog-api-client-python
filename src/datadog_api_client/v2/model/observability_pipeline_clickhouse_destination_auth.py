...
class ObservabilityPipelineClickhouseDestinationAuth(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.observability_pipeline_clickhouse_destination_auth_strategy import (
            ObservabilityPipelineClickhouseDestinationAuthStrategy,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param password_key: Name of the environment variable or secret that contains the ClickHouse password.
        :type password_key: str, optional

        :param strategy: The authentication strategy for ClickHouse HTTP requests. Only ``basic`` is supported.
        :type strategy: ObservabilityPipelineClickhouseDestinationAuthStrategy

        :param username_key: Name of the environment variable or secret that contains the ClickHouse username.
