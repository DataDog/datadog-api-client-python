...
class NullableUserRelationship(ModelNormal):
    _nullable = True
    ...
    def __init__(self_, data: Union[NullableUserRelationshipData, none_type], **kwargs):
        """
        Relationship to user.

        :param data: Relationship to user object.
        :type data: NullableUserRelationshipData, none_type
        """
