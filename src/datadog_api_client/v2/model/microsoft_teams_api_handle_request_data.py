...
class MicrosoftTeamsApiHandleRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.microsoft_teams_api_handle_request_attributes import (
            MicrosoftTeamsApiHandleRequestAttributes,
    ...
    def __init__(
        self_, attributes: MicrosoftTeamsApiHandleRequestAttributes, type: MicrosoftTeamsApiHandleType, **kwargs
    ):
        """
        Handle data from a response.

        :param attributes: Handle attributes.
        :type attributes: MicrosoftTeamsApiHandleRequestAttributes
