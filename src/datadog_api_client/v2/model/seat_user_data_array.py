...
class SeatUserDataArray(ModelNormal):
    ...
    def __init__(
        self_,
        data: Union[List[SeatUserData], none_type, UnsetType] = unset,
        meta: Union[SeatUserMeta, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :type data: [SeatUserData], none_type, optional
