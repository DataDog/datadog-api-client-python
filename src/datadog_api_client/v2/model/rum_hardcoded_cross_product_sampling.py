...
class RumHardcodedCrossProductSampling(ModelNormal):
    validations = {
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param session_replay_enabled: Indicates whether Session Replay cross-product retention is active.
        ...
        :param trace_enabled: Indicates whether Trace cross-product retention is active.
