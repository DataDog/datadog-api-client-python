...
class IncidentJiraTemplateResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_jira_template_data_response import IncidentJiraTemplateDataResponse
    ...
    def __init__(self_, data: IncidentJiraTemplateDataResponse, **kwargs):
        """
        Response with a single incident Jira template.

        :param data: Incident Jira template data in a response.
