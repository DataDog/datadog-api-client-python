...
class ObservabilityPipelineSensitiveDataScannerProcessorRule(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param keyword_options: The definition of ``ObservabilityPipelineSensitiveDataScannerProcessorKeywordOptions`` object.
        ...
        :param on_match: The definition of ``ObservabilityPipelineSensitiveDataScannerProcessorAction`` object.
        ...
        :param scope: The definition of ``ObservabilityPipelineSensitiveDataScannerProcessorScope`` object.
