...
class OwnershipUntaggedFindingsResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.ownership_untagged_findings_data import OwnershipUntaggedFindingsData
    ...
    def __init__(self_, data: OwnershipUntaggedFindingsData, **kwargs):
        """
        The response returned when counting findings without a team tag by ownership confidence.

        :param data: The data wrapper for an ownership untagged findings response.
        :type data: OwnershipUntaggedFindingsData
        """
