...
class SecurityMonitoringDatasetUpdateRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.security_monitoring_dataset_update_data import (
    ...
    def __init__(self_, data: SecurityMonitoringDatasetUpdateData, **kwargs):
        """
        Request body for updating a Cloud SIEM dataset.

        :param data: The data wrapper of a dataset update request.
        :type data: SecurityMonitoringDatasetUpdateData
        """
