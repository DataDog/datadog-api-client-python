...
class IncidentAIPostmortemDataAttributesResponse(ModelNormal):
    ...
    def __init__(
        ...
        key_insights: Union[str, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param key_insights: Key insights from the incident.
        :type key_insights: str, optional
        ...
        if key_insights is not unset:
            kwargs["key_insights"] = key_insights
