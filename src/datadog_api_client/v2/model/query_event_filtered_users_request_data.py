...
class QueryEventFilteredUsersRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.query_event_filtered_users_request_data_attributes import (
            QueryEventFilteredUsersRequestDataAttributes,
    ...
    def __init__(
        self_,
        type: QueryEventFilteredUsersRequestDataType,
        attributes: Union[QueryEventFilteredUsersRequestDataAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type type: QueryEventFilteredUsersRequestDataType
        """
