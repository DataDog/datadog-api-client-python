...
class ListConnectionGroupsResponseMeta(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.integration_counts import IntegrationCounts
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param total: The total number of connection groups.
        :type total: int

        :param total_filtered: The total number of connection groups that match the specified filters.
