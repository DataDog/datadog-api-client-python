...
class ObservabilityPipelineRsyslogDestination(ModelNormal):
    validations = {
        "keepalive": {
            "inclusive_minimum": 0,
        },
    ...
    def __init__(
        ...
        **Supported pipeline types:** logs
        ...
        :param endpoint_url_key: Name of the environment variable or secret that holds the syslog server endpoint URL.
