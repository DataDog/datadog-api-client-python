...
class DegradationTemplate(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.degradation_template_data import DegradationTemplateData
        from datadog_api_client.v2.model.degradation_included import DegradationIncluded
    ...
    def __init__(
        self_,
        data: Union[DegradationTemplateData, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param data: The data object for a degradation template.
        :type data: DegradationTemplateData, optional
