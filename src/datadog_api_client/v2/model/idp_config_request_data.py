...
class IDPConfigRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.idp_config_request_attributes import IDPConfigRequestAttributes
        from datadog_api_client.v2.model.idp_config_type import IDPConfigType
    ...
    def __init__(self_, attributes: IDPConfigRequestAttributes, type: IDPConfigType, **kwargs):
        """
        IDP configuration request data.

        :param attributes: IDP configuration request attributes.
        :type attributes: IDPConfigRequestAttributes
