...
class DatabricksDataObservabilityQualityMonitoringIntegrationDataflowSettingsRequest(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param do_crawlers_cron: Cron expression setting how often Datadog connects to your Databricks warehouse to collect metadata. Currently, only hourly ( ``0 * * * *`` ) and daily ( ``0 0 * * *`` ) are supported. Defaults to hourly.
