...
class DatabricksIntegrationAccountResponseData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.databricks_integration_account_response_attributes import (
            DatabricksIntegrationAccountResponseAttributes,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: Attributes of a Databricks integration account returned in responses.
        :type attributes: DatabricksIntegrationAccountResponseAttributes

        :param id: Server-generated unique identifier of the Databricks integration account.
        :type id: str
