...
if TYPE_CHECKING:
    ...
    from datadog_api_client.v2.model.case_jira_issue import CaseJiraIssue
...
class FindingCaseResponseDataAttributes(ModelNormal):
    ...
    def __init__(
        ...
        assigned_to: Union[SecurityUser, UnsetType] = unset,
        ...
        jira_issue: Union[CaseJiraIssue, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param assigned_to:
        :type assigned_to: SecurityUser, optional
        ...
        :type jira_issue: CaseJiraIssue, optional
