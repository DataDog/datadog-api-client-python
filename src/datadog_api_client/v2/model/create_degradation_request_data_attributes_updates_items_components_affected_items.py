...
class CreateDegradationRequestDataAttributesUpdatesItemsComponentsAffectedItems(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.status_pages_component_data_attributes_status import (
            StatusPagesComponentDataAttributesStatus,
    ...
    def __init__(
        self_, id: str, status: StatusPagesComponentDataAttributesStatus, name: Union[str, UnsetType] = unset, **kwargs
    ):
        """
