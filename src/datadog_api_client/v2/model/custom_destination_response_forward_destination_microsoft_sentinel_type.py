...
class CustomDestinationResponseForwardDestinationMicrosoftSentinelType(ModelSimple):
    """
    ...
    MICROSOFT_SENTINEL: ClassVar["CustomDestinationResponseForwardDestinationMicrosoftSentinelType"]
