...
class ObservabilityPipelinePrometheusRemoteWriteDestinationType(ModelSimple):
    """
    ...
    PROMETHEUS_REMOTE_WRITE: ClassVar["ObservabilityPipelinePrometheusRemoteWriteDestinationType"]
