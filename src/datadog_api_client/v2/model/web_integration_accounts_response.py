...
class WebIntegrationAccountsResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.web_integration_account_response_data import WebIntegrationAccountResponseData
    ...
    def __init__(self_, data: Union[List[WebIntegrationAccountResponseData], UnsetType] = unset, **kwargs):
        """
        The expected response schema when listing web integration accounts.

        :param data: The JSON:API data array.
