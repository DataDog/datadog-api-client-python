...
class PartialCustomFrameworkData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.custom_framework_data_handle_and_version import (
    ...
    def __init__(self_, attributes: CustomFrameworkDataHandleAndVersion, type: CustomFrameworkType, **kwargs):
        ...
        :param attributes: Framework Handle and Version.
        :type attributes: CustomFrameworkDataHandleAndVersion

        :param type: The type of the resource. The value should always be ``custom_framework``.
