...
class TimeseriesAnomalyInvestigationAnomaly(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param detected_interval: Inclusive time interval in milliseconds since the Unix epoch.
        :type detected_interval: TimeseriesAnomalyInvestigationInterval

        :param display_interval: Inclusive time interval in milliseconds since the Unix epoch.
