...
class FleetDeploymentsV2Page(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "total_count": (int,),
    ...
    def __init__(
        ...
        :param total_count: Total number of deployments available across all pages.
        :type total_count: int, optional

        :param total_filtered_count: Total number of deployments matching the current filter query.
