...
class SnowflakeAccountUsageMetricsIntegrationDataflowRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.snowflake_account_usage_metrics_integration_dataflow_settings_request import (
            SnowflakeAccountUsageMetricsIntegrationDataflowSettingsRequest,
    ...
    def __init__(
        ...
        settings: Union[SnowflakeAccountUsageMetricsIntegrationDataflowSettingsRequest, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param settings: Settings of the account usage metrics dataflow. Only the fields provided are changed.
        :type settings: SnowflakeAccountUsageMetricsIntegrationDataflowSettingsRequest, optional
        """
