...
class ObservabilityPipelineSensitiveDataScannerProcessorScopeIncludeTarget(ModelSimple):
    """
    ...
    INCLUDE: ClassVar["ObservabilityPipelineSensitiveDataScannerProcessorScopeIncludeTarget"]
