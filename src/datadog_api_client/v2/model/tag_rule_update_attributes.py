...
class TagRuleUpdateAttributes(ModelNormal):
    ...
    def __init__(
        ...
        policy_type: Union[TagRuleType, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param policy_name: Human-readable name for the tag rule.
        :type policy_name: str, optional

        :param policy_type: How the rule is enforced. ``blocking`` rejects telemetry that violates the rule.
            ``surfacing`` only highlights non-compliant telemetry without blocking it.
        :type policy_type: TagRuleType, optional
