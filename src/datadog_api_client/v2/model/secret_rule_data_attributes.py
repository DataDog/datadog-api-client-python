...
class SecretRuleDataAttributes(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param default_included_keywords: The ``attributes`` ``default_included_keywords``.
        :type default_included_keywords: [str], optional

        :param description: The ``attributes`` ``description``.
        :type description: str, optional

        :param license: The ``attributes`` ``license``.
        :type license: str, optional

        :param match_validation: The definition of ``SecretRuleDataAttributesMatchValidation`` object.
        :type match_validation: SecretRuleDataAttributesMatchValidation, optional

        :param name: The ``attributes`` ``name``.
        :type name: str, optional

        :param pattern: The ``attributes`` ``pattern``.
        :type pattern: str, optional

        :param priority: The ``attributes`` ``priority``.
        :type priority: str, optional

        :param sds_id: The ``attributes`` ``sds_id``.
        :type sds_id: str, optional

        :param validators: The ``attributes`` ``validators``.
