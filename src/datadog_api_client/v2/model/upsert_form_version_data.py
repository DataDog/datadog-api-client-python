...
class UpsertFormVersionData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.upsert_form_version_data_attributes import UpsertFormVersionDataAttributes
        from datadog_api_client.v2.model.form_version_type import FormVersionType
    ...
    def __init__(self_, attributes: UpsertFormVersionDataAttributes, type: FormVersionType, **kwargs):
        """
        The data for creating or updating a form version.

        :param attributes: The attributes for creating or updating a form version.
        :type attributes: UpsertFormVersionDataAttributes
