...
class CIAppPipelineEventInProgressJob(ModelNormal):
    validations = {
        "queue_time": {
            "inclusive_minimum": 0,
        },
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param id: The UUID for the job. It must match the ID of the corresponding finished job.
        :type id: str
        ...
        :param status: The in-progress status of the job.
        :type status: CIAppPipelineEventJobInProgressStatus
