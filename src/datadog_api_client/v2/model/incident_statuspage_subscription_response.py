...
class IncidentStatuspageSubscriptionResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_statuspage_subscription_data_response import (
            IncidentStatuspageSubscriptionDataResponse,
    ...
    def __init__(self_, data: IncidentStatuspageSubscriptionDataResponse, **kwargs):
        """
        Response with a single email subscription.

        :param data: Email subscription data in a response.
