...
class GetRuleVersionHistoryResponse(ModelNormal):
    ...
    def __init__(self_, data: Union[GetRuleVersionHistoryData, UnsetType] = unset, **kwargs):
        """
        Response for getting the rule version history.

        :param data: Data for the rule version history.
        :type data: GetRuleVersionHistoryData, optional
        """
