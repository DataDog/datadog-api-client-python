...
class IncidentZoomIntegrationResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
    ...
    def __init__(self_, data: IncidentZoomIntegrationDataResponse, **kwargs):
        """
        Response with Zoom integration metadata.

        :param data: Zoom integration data in a response.
        :type data: IncidentZoomIntegrationDataResponse
        """
