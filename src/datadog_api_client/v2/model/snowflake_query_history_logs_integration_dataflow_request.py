...
class SnowflakeQueryHistoryLogsIntegrationDataflowRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.snowflake_query_history_logs_integration_dataflow_settings_request import (
            SnowflakeQueryHistoryLogsIntegrationDataflowSettingsRequest,
    ...
    def __init__(
        ...
        settings: Union[SnowflakeQueryHistoryLogsIntegrationDataflowSettingsRequest, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param settings: Settings of the query history logs dataflow. Only the fields provided are changed.
        :type settings: SnowflakeQueryHistoryLogsIntegrationDataflowSettingsRequest, optional
        """
