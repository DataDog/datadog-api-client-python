...
class SensitiveDataScannerMeta(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param has_highlight_enabled: (Deprecated) Whether or not scanned events are highlighted in Logs or RUM for the org. Can no longer be configured user-side. **Deprecated**.
