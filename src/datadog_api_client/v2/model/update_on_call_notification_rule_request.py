...
class UpdateOnCallNotificationRuleRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.update_on_call_notification_rule_request_data import (
            UpdateOnCallNotificationRuleRequestData,
    ...
    def __init__(self_, data: UpdateOnCallNotificationRuleRequestData, **kwargs):
        """
        A top-level wrapper for updating a notification rule for a user

        :param data: Data for updating an on-call notification rule
        :type data: UpdateOnCallNotificationRuleRequestData
        """
