...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.case_jira_issue_result import CaseJiraIssueResult


class CaseJiraIssue(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.case_jira_issue_result import CaseJiraIssueResult
    ...
    def __init__(
        ...
        result: Union[CaseJiraIssueResult, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type result: CaseJiraIssueResult, optional
