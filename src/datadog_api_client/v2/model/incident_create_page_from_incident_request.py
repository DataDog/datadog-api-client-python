...
class IncidentCreatePageFromIncidentRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_create_page_from_incident_data import (
    ...
    def __init__(self_, data: IncidentCreatePageFromIncidentData, **kwargs):
        """
        Request to create a page from an incident.

        :param data: Data for creating a page from an incident.
