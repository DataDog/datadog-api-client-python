...
class IncidentPostmortemCreateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_postmortem_create_attributes import IncidentPostmortemCreateAttributes
        from datadog_api_client.v2.model.incident_postmortem_type import IncidentPostmortemType
    ...
    def __init__(self_, attributes: IncidentPostmortemCreateAttributes, type: IncidentPostmortemType, **kwargs):
        """
        The postmortem resource for a creation request.

        :param attributes: The postmortem's attributes for a creation request.
        :type attributes: IncidentPostmortemCreateAttributes
