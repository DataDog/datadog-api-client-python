...
class CustomDestinationResponseAttributes(ModelNormal):
    validations = {
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param forward_tags_restriction_list: List of `keys of tags <https://docs.datadoghq.com/getting_started/tagging/#define-tags>`_ to be filtered.
        ...
        :type forwarder_destination: CustomDestinationResponseForwardDestination, optional
