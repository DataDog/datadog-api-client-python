...
class IncidentPostmortemData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_postmortem_attributes import IncidentPostmortemAttributes
        from datadog_api_client.v2.model.incident_postmortem_relationships import IncidentPostmortemRelationships
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: The postmortem's attributes.
        :type attributes: IncidentPostmortemAttributes

        :param id: The UUID of the postmortem.
        :type id: str

        :param relationships: The postmortem's relationships.
        :type relationships: IncidentPostmortemRelationships
