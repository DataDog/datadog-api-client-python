...
class UsageQuotaResponseData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.usage_quota_response_attributes import UsageQuotaResponseAttributes
        from datadog_api_client.v2.model.usage_quota_type import UsageQuotaType
    ...
    def __init__(self_, attributes: UsageQuotaResponseAttributes, id: str, type: UsageQuotaType, **kwargs):
        """
        A usage quota resource.

        :param attributes: Attributes of a usage quota.
        :type attributes: UsageQuotaResponseAttributes
