...
class AWSAccountCreateRequestAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.aws_auth_config import AWSAuthConfig
        from datadog_api_client.v2.model.aws_account_partition import AWSAccountPartition
    ...
    def __init__(
        self_,
        auth_config: Union[AWSAuthConfig, AWSAuthConfigKeys, AWSAuthConfigRole],
        aws_account_id: str,
        aws_partition: AWSAccountPartition,
        ...
        **kwargs,
        ...
        self_.auth_config = auth_config
        self_.aws_account_id = aws_account_id
        self_.aws_partition = aws_partition
