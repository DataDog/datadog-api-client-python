...
class ElasticCloudMonitoringAccountUpdateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.elastic_cloud_monitoring_account_update_attributes import (
            ElasticCloudMonitoringAccountUpdateAttributes,
    ...
    def __init__(
        self_, attributes: ElasticCloudMonitoringAccountUpdateAttributes, type: IntegrationAccountType, **kwargs
    ):
        """
        Data envelope for updating an Elastic Cloud monitoring account.

        :param attributes: Updatable attributes of an Elastic Cloud monitoring account. Every field is optional; only the fields provided are changed.
        :type attributes: ElasticCloudMonitoringAccountUpdateAttributes
