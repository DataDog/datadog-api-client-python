...
class STIXObject(ModelNormal):
    ...
    def __init__(
        ...
        spec_version: Union[str, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param spec_version: The STIX specification version declared on the object. Objects with an unsupported version are accepted and counted in the ``unsupported`` response counter.
        :type spec_version: str, optional
