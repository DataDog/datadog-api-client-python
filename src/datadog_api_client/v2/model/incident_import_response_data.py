...
class IncidentImportResponseData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_import_response_attributes import IncidentImportResponseAttributes
        from datadog_api_client.v2.model.incident_import_response_relationships import (
    ...
    def __init__(
        ...
        id: str,
        type: IncidentType,
        attributes: Union[IncidentImportResponseAttributes, UnsetType] = unset,
        relationships: Union[IncidentImportResponseRelationships, UnsetType] = unset,
        **kwargs,
    ):
        """
        Incident data from an import response.

        :param attributes: The incident's attributes from an import response.
        :type attributes: IncidentImportResponseAttributes, optional

        :param id: The incident's ID.
        :type id: str

        :param relationships: The incident's relationships from an import response.
        :type relationships: IncidentImportResponseRelationships, optional
