...
class EventEmailAddressRevokedByRelationship(ModelNormal):
    _nullable = True
    ...
    def __init__(self_, data: Union[EventEmailAddressUserData, UnsetType] = unset, **kwargs):
        """
        Relationship to the user who revoked the email address.

        :param data: A user data reference in a relationship.
        :type data: EventEmailAddressUserData, optional
        """
