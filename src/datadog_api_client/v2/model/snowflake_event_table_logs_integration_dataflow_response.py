...
class SnowflakeEventTableLogsIntegrationDataflowResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.snowflake_event_table_logs_integration_dataflow_settings_response import (
            SnowflakeEventTableLogsIntegrationDataflowSettingsResponse,
    ...
    def __init__(
        ...
        settings: Union[SnowflakeEventTableLogsIntegrationDataflowSettingsResponse, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param settings: Settings of the event table dataflow. Each record type is collected independently so that you can control ingestion costs, and every record type is ingested into Datadog as logs tagged with its ``record_type``.
        :type settings: SnowflakeEventTableLogsIntegrationDataflowSettingsResponse, optional
        """
