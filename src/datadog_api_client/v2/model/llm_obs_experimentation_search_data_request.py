...
class LLMObsExperimentationSearchDataRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.llm_obs_experimentation_search_data_attributes_request import (
            LLMObsExperimentationSearchDataAttributesRequest,
    ...
    def __init__(
        self_, attributes: LLMObsExperimentationSearchDataAttributesRequest, type: LLMObsExperimentationType, **kwargs
    ):
        """
        Data object for an experimentation search request.

        :param attributes: Attributes for an experimentation search request.
        :type attributes: LLMObsExperimentationSearchDataAttributesRequest
