...
class SyntheticsNetworkTestRequest(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param destination_service: Destination service name.
        :type destination_service: str, optional

        :param e2e_queries: Number of end-to-end queries.
        :type e2e_queries: int

        :param host: Host name to query.
        :type host: str

        :param max_ttl: Maximum TTL for network packets.
        :type max_ttl: int
        ...
        :param source_service: Source service name.
        :type source_service: str, optional

        :param tcp_method: For TCP tests, the TCP method to use.
        :type tcp_method: SyntheticsNetworkTestRequestTCPMethod, optional

        :param timeout: Timeout in seconds.
        :type timeout: int, optional

        :param traceroute_queries: Number of traceroute queries.
