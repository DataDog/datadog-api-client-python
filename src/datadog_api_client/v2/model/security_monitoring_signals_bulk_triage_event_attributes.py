...
class SecurityMonitoringSignalsBulkTriageEventAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.security_monitoring_triage_user import SecurityMonitoringTriageUser
        from datadog_api_client.v2.model.security_monitoring_signal_archive_reason import (
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param archive_comment_timestamp: Timestamp of the last edit to the archive comment.
        ...
        :param state_update_timestamp: Timestamp of the last state update.
