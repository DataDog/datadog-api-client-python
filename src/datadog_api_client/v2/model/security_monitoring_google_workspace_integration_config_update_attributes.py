...
class SecurityMonitoringGoogleWorkspaceIntegrationConfigUpdateAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.security_monitoring_integration_type_google_workspace import (
            SecurityMonitoringIntegrationTypeGoogleWorkspace,
    ...
    def __init__(
        ...
        secrets: Union[SecurityMonitoringIntegrationConfigGoogleWorkspaceSecrets, UnsetType] = unset,
