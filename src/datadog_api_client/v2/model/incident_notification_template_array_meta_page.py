...
class IncidentNotificationTemplateArrayMetaPage(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "total_count": (int,),
    ...
    def __init__(
        ...
        :param total_count: Total number of notification templates.
        :type total_count: int, optional

        :param total_filtered_count: Total number of notification templates matching the filter.
