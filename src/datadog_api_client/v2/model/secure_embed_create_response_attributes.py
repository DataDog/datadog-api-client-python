...
class SecureEmbedCreateResponseAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.secure_embed_global_time import SecureEmbedGlobalTime
        from datadog_api_client.v2.model.secure_embed_selectable_template_variable import (
    ...
    def __init__(
        ...
        credential: Union[str, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param credential: The secret credential used for HMAC signing. Returned only on creation. Store securely — it cannot be retrieved again.
