...
class StatuspageUrlSettingResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.statuspage_url_setting_response_data import StatuspageUrlSettingResponseData
    ...
    def __init__(self_, data: StatuspageUrlSettingResponseData, **kwargs):
        """
        Response containing a Statuspage URL setting.

        :param data: Statuspage URL setting data from a response.
