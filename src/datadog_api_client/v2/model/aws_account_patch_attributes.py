...
class AWSAccountPatchAttributes(ModelNormal):
    validations = {
        "aws_account_id": {},
    }
    ...
    def __init__(
        ...
        aws_account_name: Union[str, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param aws_account_name: AWS Account name
        :type aws_account_name: str, optional
        ...
        if aws_account_name is not unset:
            kwargs["aws_account_name"] = aws_account_name
