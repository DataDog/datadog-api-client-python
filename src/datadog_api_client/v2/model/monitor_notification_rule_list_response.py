...
class MonitorNotificationRuleListResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.monitor_notification_rule_data import MonitorNotificationRuleData
        from datadog_api_client.v2.model.monitor_notification_rule_response_included_item import (
    ...
    def __init__(
        self_,
        data: Union[List[MonitorNotificationRuleData], UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param data: A list of monitor notification rules.
        :type data: [MonitorNotificationRuleData], optional

        :param included: Array of objects related to the monitor notification rules.
