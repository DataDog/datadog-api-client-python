...
class ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param per_tag_limits: A list of per-tag cardinality overrides that apply within this metric.
        :type per_tag_limits: [ObservabilityPipelineTagCardinalityLimitProcessorPerTagLimit], optional

        :param value_limit: The maximum number of distinct tag value combinations allowed for this metric.
