...
class CreateDataDeletionResponseBody(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.data_deletion_response_item import DataDeletionResponseItem
        from datadog_api_client.v2.model.data_deletion_response_meta import DataDeletionResponseMeta
    ...
    def __init__(
        self_,
        data: Union[DataDeletionResponseItem, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param data: The created data deletion request information.
