...
class ASMExclusionFilterUpdateAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.asm_exclusion_filter_rule_target import ASMExclusionFilterRuleTarget
        from datadog_api_client.v2.model.asm_exclusion_filter_scope import ASMExclusionFilterScope
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param description: The description of the Exclusion filter.
        :type description: str, optional

        :param enabled: Whether the Exclusion filter is enabled.
