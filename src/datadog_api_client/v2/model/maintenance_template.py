...
class MaintenanceTemplate(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.maintenance_template_data import MaintenanceTemplateData
        from datadog_api_client.v2.model.degradation_included import DegradationIncluded
    ...
    def __init__(
        self_,
        data: Union[MaintenanceTemplateData, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param data: The data object for a maintenance template.
        :type data: MaintenanceTemplateData, optional
