...
class TeamOnCallRespondersDataRelationshipsRespondersDataItemsType(ModelSimple):
    """
    ...
    USERS: ClassVar["TeamOnCallRespondersDataRelationshipsRespondersDataItemsType"]
