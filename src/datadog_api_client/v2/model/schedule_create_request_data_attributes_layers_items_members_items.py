...
class ScheduleCreateRequestDataAttributesLayersItemsMembersItems(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.schedule_create_request_data_attributes_layers_items_members_items_user import (
            ScheduleCreateRequestDataAttributesLayersItemsMembersItemsUser,
    ...
    def __init__(
        ...
        :type user: ScheduleCreateRequestDataAttributesLayersItemsMembersItemsUser, optional
        """
