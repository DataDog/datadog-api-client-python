...
class ListDashboardsUsageResponseLinks(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "first": (str,),
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param last: Link to the last page, or ``null`` if the total is unknown.
        :type last: str, none_type, optional

        :param next: Link to the next page. Absent when there is no next page.
        :type next: str, none_type, optional

        :param prev: Link to the previous page. Absent when there is no previous page.
