...
class ObservabilityPipelineAmazonS3SourceType(ModelSimple):
    ...
    AMAZON_S3: ClassVar["ObservabilityPipelineAmazonS3SourceType"]
...
ObservabilityPipelineAmazonS3SourceType.AMAZON_S3 = ObservabilityPipelineAmazonS3SourceType("amazon_s3")
