...
class SecretRuleDataAttributesMatchValidation(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param endpoint: The ``match_validation`` ``endpoint``.
        :type endpoint: str, optional

        :param hosts: The ``match_validation`` ``hosts``.
        :type hosts: [str], optional

        :param http_method: The ``match_validation`` ``http_method``.
        :type http_method: str, optional

        :param invalid_http_status_code: The ``match_validation`` ``invalid_http_status_code``.
        :type invalid_http_status_code: [SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems], optional

        :param request_headers: The ``match_validation`` ``request_headers``.
        :type request_headers: {str: (str,)}, optional

        :param timeout_seconds: The ``match_validation`` ``timeout_seconds``.
        :type timeout_seconds: int, optional

        :param type: The ``match_validation`` ``type``.
        :type type: str, optional

        :param valid_http_status_code: The ``match_validation`` ``valid_http_status_code``.
