...
class DatabricksDataObservabilityQualityMonitoringIntegrationDataflowRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.databricks_data_observability_quality_monitoring_integration_dataflow_settings_request import (
            DatabricksDataObservabilityQualityMonitoringIntegrationDataflowSettingsRequest,
    ...
    def __init__(
        ...
        settings: Union[
            DatabricksDataObservabilityQualityMonitoringIntegrationDataflowSettingsRequest, UnsetType
        ] = unset,
        **kwargs,
    ):
        """
        ...
        :type settings: DatabricksDataObservabilityQualityMonitoringIntegrationDataflowSettingsRequest, optional
        """
