...
class SankeyRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.sankey_request_data_attributes import SankeyRequestDataAttributes
        from datadog_api_client.v2.model.sankey_request_data_type import SankeyRequestDataType
    ...
    def __init__(
        self_,
        type: SankeyRequestDataType,
        attributes: Union[SankeyRequestDataAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param attributes:
        :type attributes: SankeyRequestDataAttributes, optional

        :param id:
        :type id: str, optional

        :param type:
        :type type: SankeyRequestDataType
        """
