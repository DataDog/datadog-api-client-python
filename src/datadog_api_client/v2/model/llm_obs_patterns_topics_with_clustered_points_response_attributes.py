...
class LLMObsPatternsTopicsWithClusteredPointsResponseAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.llm_obs_patterns_config_snapshot import LLMObsPatternsConfigSnapshot
        from datadog_api_client.v2.model.llm_obs_patterns_topic_with_clustered_points import (
        ...
        return {
            ...
            "previous_run_id": (str,),
            "run_id": (str,),
            "topics": ([LLMObsPatternsTopicWithClusteredPoints],),
        }
    ...
    def __init__(
        ...
        previous_run_id: str,
        run_id: str,
        topics: List[LLMObsPatternsTopicWithClusteredPoints],
        ...
        **kwargs,
        ...
        :param topics: List of discovered topics with their clustered points.
        :type topics: [LLMObsPatternsTopicWithClusteredPoints]
        """
