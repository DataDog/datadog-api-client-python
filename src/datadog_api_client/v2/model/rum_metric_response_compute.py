...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.rum_metric_response_compute_aggregation_type import (
        RumMetricResponseComputeAggregationType,
    )


class RumMetricResponseCompute(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.rum_metric_response_compute_aggregation_type import (
            RumMetricResponseComputeAggregationType,
    ...
    def __init__(
        self_,
        aggregation_type: Union[RumMetricResponseComputeAggregationType, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type aggregation_type: RumMetricResponseComputeAggregationType, optional
