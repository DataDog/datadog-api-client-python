...
class FeatureFlagListItem(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.feature_flag_list_item_attributes import FeatureFlagListItemAttributes
        from datadog_api_client.v2.model.create_feature_flag_data_type import CreateFeatureFlagDataType
    ...
    def __init__(self_, attributes: FeatureFlagListItemAttributes, id: UUID, type: CreateFeatureFlagDataType, **kwargs):
        """
        A feature flag resource for list responses.

        :param attributes: Attributes of a feature flag in list responses.
        :type attributes: FeatureFlagListItemAttributes
