...
class EscalationPolicyUpdateRequestDataRelationshipsTeamsDataItems(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.escalation_policy_update_request_data_relationships_teams_data_items_type import (
            EscalationPolicyUpdateRequestDataRelationshipsTeamsDataItemsType,
    ...
    def __init__(self_, id: str, type: EscalationPolicyUpdateRequestDataRelationshipsTeamsDataItemsType, **kwargs):
        """
        ...
        :type type: EscalationPolicyUpdateRequestDataRelationshipsTeamsDataItemsType
        """
