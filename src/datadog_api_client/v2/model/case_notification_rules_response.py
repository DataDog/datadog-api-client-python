...
class CaseNotificationRulesResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.case_notification_rule import CaseNotificationRule
    ...
    def __init__(self_, data: Union[List[CaseNotificationRule], UnsetType] = unset, **kwargs):
        """
        Response with notification rules

        :param data: Notification rules data
