...
class ManagedOrgsRelationshipToOrgs(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.org_relationship_data import OrgRelationshipData
    ...
    def __init__(self_, data: List[OrgRelationshipData], **kwargs):
        """
        Relationship to the managed organizations.

        :param data: List of managed organization references.
