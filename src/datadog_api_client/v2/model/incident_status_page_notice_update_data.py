...
class IncidentStatusPageNoticeUpdateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_status_page_notice_update_data_attributes import (
            IncidentStatusPageNoticeUpdateDataAttributes,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: Attributes for updating a status page notice.
        :type attributes: IncidentStatusPageNoticeUpdateDataAttributes
