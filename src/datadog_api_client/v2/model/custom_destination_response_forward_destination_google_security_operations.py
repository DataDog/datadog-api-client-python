...
class CustomDestinationResponseForwardDestinationGoogleSecurityOperations(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.custom_destination_response_google_security_operations_destination_auth import (
            CustomDestinationResponseGoogleSecurityOperationsDestinationAuth,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param regional_endpoint: The ``CustomDestinationResponseForwardDestinationGoogleSecurityOperations`` ``regional_endpoint``.
        :type regional_endpoint: str

        :param type: Type of the Google Security Operations destination.
        :type type: CustomDestinationResponseForwardDestinationGoogleSecurityOperationsType
        """
