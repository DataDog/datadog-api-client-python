...
class AlertEventCustomAttributesStatus(ModelSimple):
    ...
    :param value: Must be one of ["info", "warn", "error", "ok"].
    :type value: str
    """
    ...
    INFO: ClassVar["AlertEventCustomAttributesStatus"]
...
AlertEventCustomAttributesStatus.INFO = AlertEventCustomAttributesStatus("info")
