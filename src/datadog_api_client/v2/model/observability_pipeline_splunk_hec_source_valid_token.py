...
class ObservabilityPipelineSplunkHecSourceValidToken(ModelNormal):
    validations = {
        "token_key": {},
    }
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param token_key: Name of the environment variable or secret that holds the expected HEC token value.
        :type token_key: str
        """
