...
class SecurityMonitoringSentinelOneIntegrationConfigUpdateAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.security_monitoring_integration_type_sentinel_one import (
            SecurityMonitoringIntegrationTypeSentinelOne,
    ...
    def __init__(
        ...
        secrets: Union[SecurityMonitoringIntegrationConfigSentinelOneSecrets, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type secrets: SecurityMonitoringIntegrationConfigSentinelOneSecrets, optional
