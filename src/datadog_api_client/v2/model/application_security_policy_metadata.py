...
class ApplicationSecurityPolicyMetadata(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "added_at": (datetime,),
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param added_at: The date and time the WAF policy was created.
        :type added_at: datetime, optional

        :param added_by: The handle of the user who created the WAF policy.
        :type added_by: str, optional

        :param added_by_name: The name of the user who created the WAF policy.
        :type added_by_name: str, optional

        :param modified_at: The date and time the WAF policy was last updated.
        :type modified_at: datetime, optional

        :param modified_by: The handle of the user who last updated the WAF policy.
        :type modified_by: str, optional

        :param modified_by_name: The name of the user who last updated the WAF policy.
