...
class SegmentData(ModelNormal):
    ...
    def __init__(
        self_,
        type: SegmentDataType,
        attributes: Union[SegmentDataAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param attributes:
        :type attributes: SegmentDataAttributes, optional

        :param id:
        :type id: str, optional

        :param type:
        :type type: SegmentDataType
        """
