...
class TwilioAccountUpdateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.twilio_account_update_attributes import TwilioAccountUpdateAttributes
        from datadog_api_client.v2.model.integration_account_type import IntegrationAccountType
    ...
    def __init__(self_, attributes: TwilioAccountUpdateAttributes, type: IntegrationAccountType, **kwargs):
        """
        Data envelope for updating a Twilio integration account.

        :param attributes: Updatable attributes of a Twilio integration account. Every field is optional; only the fields provided are changed.
        :type attributes: TwilioAccountUpdateAttributes
