...
class SecurityMonitoringSuppressionsMeta(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.security_monitoring_suppressions_page_meta import (
            SecurityMonitoringSuppressionsPageMeta,
    ...
    def __init__(self_, page: Union[SecurityMonitoringSuppressionsPageMeta, UnsetType] = unset, **kwargs):
        """
        Metadata for the suppression list response.

        :param page: Pagination metadata.
        :type page: SecurityMonitoringSuppressionsPageMeta, optional
        """
