...
class SecurityMonitoringRuleTypeCreate(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The rule type.., must be one of ["log_detection", "workload_security", ]  # noqa: E501

        Keyword Args:
            value (str): The rule type.., must be one of ["log_detection", "workload_security", ]  # noqa: E501
