...
class TestOptimizationUpdateServiceSettingsRequestData(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: Attributes for updating Test Optimization service settings. All non-required fields are optional; only provided fields will be updated.
        :type attributes: TestOptimizationUpdateServiceSettingsRequestAttributes

        :param type: JSON:API type for update service settings request. The value must always be ``test_optimization_update_service_settings_request``.
