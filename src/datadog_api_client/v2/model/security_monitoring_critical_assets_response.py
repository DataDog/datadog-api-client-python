...
class SecurityMonitoringCriticalAssetsResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.security_monitoring_critical_asset import SecurityMonitoringCriticalAsset
    ...
    def __init__(self_, data: Union[List[SecurityMonitoringCriticalAsset], UnsetType] = unset, **kwargs):
        """
        Response object containing the available critical assets.

        :param data: A list of critical assets objects.
