...
class IncidentCreatePageFromIncidentDataAttributesRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_page_role_reference import IncidentPageRoleReference
        from datadog_api_client.v2.model.incident_page_target import IncidentPageTarget
    ...
    def __init__(
        ...
        incident_public_id: Union[str, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param incident_public_id: The public ID of the incident.
        :type incident_public_id: str, optional
        ...
        if incident_public_id is not unset:
            kwargs["incident_public_id"] = incident_public_id
