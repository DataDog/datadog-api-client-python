...
class SnowflakeIntegrationAccountPrivateKeyAuthRequest(ModelNormal):
    @cached_property
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param private_key_passphrase: Passphrase that decrypts the private key. Provide it only when the key is encrypted. Because an update replaces the authentication object entirely, omitting it removes any stored passphrase, so an encrypted key must always be sent together with its passphrase.
