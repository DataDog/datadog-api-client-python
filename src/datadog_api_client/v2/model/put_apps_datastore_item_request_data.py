...
class PutAppsDatastoreItemRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.put_apps_datastore_item_request_data_attributes import (
            PutAppsDatastoreItemRequestDataAttributes,
    ...
    def __init__(
        self_,
        type: PutAppsDatastoreItemRequestDataType,
        attributes: Union[PutAppsDatastoreItemRequestDataAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param attributes: The definition of ``PutAppsDatastoreItemRequestDataAttributes`` object.
        :type attributes: PutAppsDatastoreItemRequestDataAttributes, optional

        :param id: The ``PutAppsDatastoreItemRequestData`` ``id``.
        :type id: str, optional

        :param type: Items resource type.
        :type type: PutAppsDatastoreItemRequestDataType
        """
