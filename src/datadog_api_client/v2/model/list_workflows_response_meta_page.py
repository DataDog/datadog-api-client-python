...
class ListWorkflowsResponseMetaPage(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "total_count": (int,),
    ...
    def __init__(
        ...
        :param total_count: The total number of workflows in the organization.
        :type total_count: int, optional

        :param total_filtered_count: The total number of workflows matching the applied filters.
