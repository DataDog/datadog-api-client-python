...
class IssuesResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.issue import Issue
        from datadog_api_client.v2.model.issue_included import IssueIncluded
    ...
    def __init__(
        self_,
        data: Union[List[Issue], UnsetType] = unset,
        included: Union[List[Union[IssueIncluded, Case, IssueUser, IssueTeam]], UnsetType] = unset,
        **kwargs,
    ):
        """
        Search issues response payload.

        :param data: Array of issues matching the search query.
        :type data: [Issue], optional

        :param included: Array of resources related to the issues.
