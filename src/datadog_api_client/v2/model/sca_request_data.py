...
class ScaRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.sca_request_data_attributes import ScaRequestDataAttributes
        from datadog_api_client.v2.model.sca_request_data_type import ScaRequestDataType
    ...
    def __init__(
        self_,
        type: ScaRequestDataType,
        attributes: Union[ScaRequestDataAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param attributes: The definition of ``ScaRequestDataAttributes`` object.
        :type attributes: ScaRequestDataAttributes, optional

        :param id: The ``ScaRequestData`` ``id``.
        :type id: str, optional

        :param type: Scarequests resource type.
