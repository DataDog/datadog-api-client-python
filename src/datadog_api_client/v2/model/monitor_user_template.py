...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.monitor_user_template_monitor_definition import (
        MonitorUserTemplateMonitorDefinition,
    )
...
class MonitorUserTemplate(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.monitor_user_template_monitor_definition import (
            MonitorUserTemplateMonitorDefinition,
        ...
        return {
            ...
            "title": (str,),
            "version": (int,),
            "versions": ([SimpleMonitorUserTemplate],),
        }
    ...
    def __init__(
        ...
        monitor_definition: Union[MonitorUserTemplateMonitorDefinition, UnsetType] = unset,
        ...
        versions: Union[List[SimpleMonitorUserTemplate], UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :type monitor_definition: MonitorUserTemplateMonitorDefinition, optional
        ...
        :param versions: All versions of the monitor user template.
        :type versions: [SimpleMonitorUserTemplate], optional
        """
