...
class RestrictionQueryWithRelationships(ModelNormal):
    ...
    def __init__(
        ...
        relationships: Union[RestrictionQueryRelationships, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param relationships: Relationships of the restriction query object.
        :type relationships: RestrictionQueryRelationships, optional
