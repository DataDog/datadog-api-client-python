...
class RestrictionQueryListResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
    ...
    def __init__(self_, data: Union[List[RestrictionQueryWithoutRelationships], UnsetType] = unset, **kwargs):
        """
        Response containing information about multiple restriction queries.

        :param data: Array of returned restriction queries.
