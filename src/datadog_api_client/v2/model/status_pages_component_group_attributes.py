...
class StatusPagesComponentGroupAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.status_pages_component_group_attributes_components_items import (
            StatusPagesComponentGroupAttributesComponentsItems,
        ...
        return {
            "components": ([StatusPagesComponentGroupAttributesComponentsItems],),
            "created_at": (datetime,),
    ...
    def __init__(
        self_,
        type: CreateComponentRequestDataAttributesType,
        components: Union[List[StatusPagesComponentGroupAttributesComponentsItems], UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type components: [StatusPagesComponentGroupAttributesComponentsItems], optional

        :param created_at: Timestamp of when the component was created.
        :type created_at: datetime, optional

        :param modified_at: Timestamp of when the component was last modified.
