...
class ObservabilityPipelineAmazonS3DestinationCompressionZstd(ModelNormal):
    validations = {
        "level": {
            "inclusive_maximum": 21,
            "inclusive_minimum": 1,
        },
    }
    ...
    def __init__(self_, algorithm: ObservabilityPipelineAmazonS3DestinationCompressionZstdType, level: int, **kwargs):
        """
        Zstd compression.

        :param algorithm: The compression type. Always ``zstd``.
        :type algorithm: ObservabilityPipelineAmazonS3DestinationCompressionZstdType
