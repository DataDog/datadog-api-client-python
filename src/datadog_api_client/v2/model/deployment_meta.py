...
class DeploymentMeta(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "created_at": (str,),
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param created_at: The ``DeploymentMeta`` ``created_at``.
        :type created_at: str, optional

        :param user_id: The ``DeploymentMeta`` ``user_id``.
        :type user_id: int, optional

        :param user_name: The ``DeploymentMeta`` ``user_name``.
        :type user_name: str, optional

        :param user_uuid: The ``DeploymentMeta`` ``user_uuid``.
