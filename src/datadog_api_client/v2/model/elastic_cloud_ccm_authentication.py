...
class ElasticCloudCcmAuthentication(ModelComposed):
    def __init__(self, **kwargs):
        ...
        :param api_key: Billing API key. An Elastic Cloud API key with read access to both Billing and Deployments. Create one under Organization settings > API Keys.
        :type api_key: str
