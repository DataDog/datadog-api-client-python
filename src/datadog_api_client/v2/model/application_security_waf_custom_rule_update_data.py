...
class ApplicationSecurityWafCustomRuleUpdateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.application_security_waf_custom_rule_update_attributes import (
            ApplicationSecurityWafCustomRuleUpdateAttributes,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: Update a WAF custom rule.
        :type attributes: ApplicationSecurityWafCustomRuleUpdateAttributes
