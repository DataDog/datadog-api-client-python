...
if TYPE_CHECKING:
    ...
    from datadog_api_client.v2.model.dora_deployment_event_item import DORADeploymentEventItem
...
class DORADeploymentObjectAttributes(ModelNormal):
    ...
    def openapi_types(_):
        ...
        return {
            ...
            "change_failure": (bool,),
            "commits": ([DORADeploymentEventItem],),
            "created_at": (datetime,),
            "custom": (
                {
                    str: (
            ...
            "pull_requests": ([DORADeploymentEventItem],),
    ...
    def __init__(
        ...
        commits: Union[List[DORADeploymentEventItem], UnsetType] = unset,
        ...
        pull_requests: Union[List[DORADeploymentEventItem], UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type commits: [DORADeploymentEventItem], optional
        ...
        :type pull_requests: [DORADeploymentEventItem], optional
