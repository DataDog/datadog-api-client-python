...
class SnowflakeIntegrationAccountResponseData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.snowflake_integration_account_response_attributes import (
            SnowflakeIntegrationAccountResponseAttributes,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: Attributes of a Snowflake integration account returned in responses.
        :type attributes: SnowflakeIntegrationAccountResponseAttributes

        :param id: Server-generated unique identifier of the Snowflake integration account.
        :type id: str
