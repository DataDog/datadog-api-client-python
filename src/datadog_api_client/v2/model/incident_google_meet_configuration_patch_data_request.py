...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.incident_google_meet_configuration_patch_data_attributes_request import (
...
class IncidentGoogleMeetConfigurationPatchDataRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_google_meet_configuration_patch_data_attributes_request import (
            IncidentGoogleMeetConfigurationPatchDataAttributesRequest,
    ...
    def __init__(
        ...
        id: UUID,
        type: IncidentGoogleMeetConfigurationType,
        attributes: Union[IncidentGoogleMeetConfigurationPatchDataAttributesRequest, UnsetType] = unset,
        **kwargs,
    ):
        """
        Google Meet configuration data in a patch request.

        :param attributes: Attributes for patching a Google Meet configuration. All fields are optional.
        :type attributes: IncidentGoogleMeetConfigurationPatchDataAttributesRequest, optional
