...
class SnowflakeIntegrationAccountCreateAttributes(ModelNormal):
    ...
    def __init__(
        ...
        authentication: Union[
            SnowflakeIntegrationAccountAuthenticationRequest, SnowflakeIntegrationAccountPrivateKeyAuthRequest
        ],
        name: str,
        settings: SnowflakeIntegrationAccountSettingsRequest,
        ...
        **kwargs,
        ...
        :param authentication: Authentication for creating the Snowflake integration account. Exactly one method is set.
