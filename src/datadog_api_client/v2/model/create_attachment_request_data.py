...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.create_attachment_request_data_attributes import (
...
class CreateAttachmentRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.create_attachment_request_data_attributes import (
            CreateAttachmentRequestDataAttributes,
    ...
    def __init__(
        self_,
        type: IncidentAttachmentType,
        attributes: Union[CreateAttachmentRequestDataAttributes, UnsetType] = unset,
