...
class UpdateResourceEvaluationFiltersRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.resource_filter_attributes import ResourceFilterAttributes
        from datadog_api_client.v2.model.resource_filter_request_type import ResourceFilterRequestType
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param id: The ``UpdateResourceEvaluationFiltersRequestData`` ``id``.
        :type id: str, optional

        :param type: Constant string to identify the resource type.
