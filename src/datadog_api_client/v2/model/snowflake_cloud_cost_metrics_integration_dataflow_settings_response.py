...
class SnowflakeCloudCostMetricsIntegrationDataflowSettingsResponse(ModelNormal):
    ...
    def __init__(self_, query_tags: Union[str, UnsetType] = unset, **kwargs):
        ...
        :param query_tags: Snowflake query tags ingested as a comma-separated list of tag names, so that cost data can be broken down by them in Cloud Cost Management.
