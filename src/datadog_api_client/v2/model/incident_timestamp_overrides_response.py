...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.incident_timestamp_override_data_response import (
        IncidentTimestampOverrideDataResponse,
    )
    from datadog_api_client.v2.model.incident_user_data import IncidentUserData


class IncidentTimestampOverridesResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_timestamp_override_data_response import (
            IncidentTimestampOverrideDataResponse,
    ...
    def __init__(
        self_,
        data: List[IncidentTimestampOverrideDataResponse],
        ...
        **kwargs,
        ...
        :param data: List of timestamp overrides.
        :type data: [IncidentTimestampOverrideDataResponse]
