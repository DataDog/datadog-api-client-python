...
class ScheduleOnCallResponderDataType(ModelSimple):
    """
...
ScheduleOnCallResponderDataType.SCHEDULE_ONCALL_RESPONDER = ScheduleOnCallResponderDataType("schedule_oncall_responder")
