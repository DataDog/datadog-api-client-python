...
class UnassignSeatsUserRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.unassign_seats_user_request_data_attributes import (
            UnassignSeatsUserRequestDataAttributes,
    ...
    def __init__(
        self_,
        type: SeatAssignmentsDataType,
        attributes: Union[UnassignSeatsUserRequestDataAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param attributes:
        :type attributes: UnassignSeatsUserRequestDataAttributes, optional
