...
class SyntheticsTestResultData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.synthetics_test_result_attributes import SyntheticsTestResultAttributes
        from datadog_api_client.v2.model.synthetics_test_result_relationships import SyntheticsTestResultRelationships
    ...
    def __init__(
        self_,
        attributes: Union[SyntheticsTestResultAttributes, UnsetType] = unset,
        id: Union[str, UnsetType] = unset,
        relationships: Union[SyntheticsTestResultRelationships, UnsetType] = unset,
        type: Union[SyntheticsTestResultType, UnsetType] = unset,
        **kwargs,
    ):
        """
        Wrapper object for a Synthetic test result.

        :param attributes: Attributes of a Synthetic test result.
        :type attributes: SyntheticsTestResultAttributes, optional
        ...
        :param type: Type of the Synthetic test result resource, ``result``.
        :type type: SyntheticsTestResultType, optional
        """
