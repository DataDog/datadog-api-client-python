...
class SecurityMonitoringDatasetUpdateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.security_monitoring_dataset_attributes_request import (
            SecurityMonitoringDatasetAttributesRequest,
        )
        from datadog_api_client.v2.model.security_monitoring_dataset_update_type import (
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param type: The type of resource for a dataset update request.
        :type type: SecurityMonitoringDatasetUpdateType
        """
