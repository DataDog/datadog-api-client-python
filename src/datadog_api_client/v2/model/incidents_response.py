...
class IncidentsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([IncidentResponseData],),  # noqa: E501
            'included': ([IncidentResponseIncludedItem],),  # noqa: E501
    ...
    def __init__(self, data, *args, **kwargs):  # noqa: E501
        """IncidentsResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            included ([IncidentResponseIncludedItem]): Included related resources that the user requested.. [optional]  # noqa: E501
