...
class CloudWorkloadSecurityAgentPolicyAttributes(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param content_pack_update_available: Whether an update is available for the content pack this policy is based on
        ...
        :param source_default_policy_id: The ID of the Datadog managed policy this policy is derived from
