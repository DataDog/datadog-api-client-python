...
class DatabricksIntegrationDataflowsResponse(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param databricks_model_serving_metrics: Health and usage metrics for your Databricks model serving endpoints. Not supported on accounts that authenticate with ``private-action-runner`` ; on those accounts this dataflow collects no data.
