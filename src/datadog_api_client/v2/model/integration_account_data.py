...
class IntegrationAccountData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.integration_account_attributes import IntegrationAccountAttributes
        from datadog_api_client.v2.model.integration_account_type import IntegrationAccountType
    ...
    def __init__(self_, attributes: IntegrationAccountAttributes, id: str, type: IntegrationAccountType, **kwargs):
        """
        Data envelope of an integration account, including server-assigned identity.

        :param attributes: Attributes of an integration account. The ``integration`` field is a strongly-typed, per-integration union.
        :type attributes: IntegrationAccountAttributes
