...
class TestOptimizationUpdateServiceSettingsRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.test_optimization_update_service_settings_request_data import (
            TestOptimizationUpdateServiceSettingsRequestData,
    ...
    def __init__(self_, data: TestOptimizationUpdateServiceSettingsRequestData, **kwargs):
        """
        Request object for updating Test Optimization service settings.

        :param data: Data object for update service settings request.
        :type data: TestOptimizationUpdateServiceSettingsRequestData
        """
