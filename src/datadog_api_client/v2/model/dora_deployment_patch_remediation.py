...
class DORADeploymentPatchRemediation(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param id: The ID of the remediation deployment. Required when the type field is provided.
        :type id: str, optional

        :param type: The type of remediation action taken. Required when the id field is provided.
