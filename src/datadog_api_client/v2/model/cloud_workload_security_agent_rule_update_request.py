...
def lazy_import():
    ...
    globals()["CloudWorkloadSecurityAgentRuleUpdateData"] = CloudWorkloadSecurityAgentRuleUpdateData
...
class CloudWorkloadSecurityAgentRuleUpdateRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):
        ...
        self = super(CloudWorkloadSecurityAgentRuleUpdateRequest, cls)._from_openapi_data(kwargs)
