...
class CycloneDXComponent(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param bom_ref: A unique reference identifier used to link vulnerabilities to this component.
        :type bom_ref: str

        :param name: The name of the component.
        :type name: str

        :param purl: The Package URL (PURL) of the component. Required when ``type`` is ``library``.
        :type purl: str, optional

        :param type: The type of the scanned component.
