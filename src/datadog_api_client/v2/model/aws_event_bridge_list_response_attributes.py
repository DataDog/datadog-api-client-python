...
class AWSEventBridgeListResponseAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.aws_event_bridge_account_configuration import (
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param is_installed: True if the EventBridge integration is enabled for your organization.
