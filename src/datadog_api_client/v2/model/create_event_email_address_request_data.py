...
class CreateEventEmailAddressRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.create_event_email_address_request_data_attributes import (
            CreateEventEmailAddressRequestDataAttributes,
    ...
    def __init__(
        self_,
        type: EventEmailsType,
        attributes: Union[CreateEventEmailAddressRequestDataAttributes, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param attributes:
        :type attributes: CreateEventEmailAddressRequestDataAttributes, optional
