...
class OrgAuthorizedClientResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.org_authorized_client_data import OrgAuthorizedClientData
    ...
    def __init__(self_, data: OrgAuthorizedClientData, **kwargs):
        """
        Response containing a single org authorized client.

        :param data: Data object representing an org authorized client.
