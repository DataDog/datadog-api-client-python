...
class SnowflakeCloudCostMetricsIntegrationDataflowResponse(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Cost data aggregated from the Snowflake ``ORGANIZATION_USAGE`` schema. Requires `Cloud Cost Management <https://docs.datadoghq.com/cloud_cost_management/>`_ to be set up for your organization, and the ORGANIZATION_BILLING_VIEWER database role on the Snowflake role; without both this dataflow collects no data.
