...
class ObservabilityPipelineAmazonS3DestinationCompressionGzipType(ModelSimple):
    """
    ...
    GZIP: ClassVar["ObservabilityPipelineAmazonS3DestinationCompressionGzipType"]
