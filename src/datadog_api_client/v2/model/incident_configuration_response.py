...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.incident_configuration_data_response import IncidentConfigurationDataResponse
    from datadog_api_client.v2.model.incident_user_data import IncidentUserData


class IncidentConfigurationResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_configuration_data_response import IncidentConfigurationDataResponse
        from datadog_api_client.v2.model.incident_user_data import IncidentUserData
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param data: Incident configuration data in a response.
        :type data: IncidentConfigurationDataResponse
