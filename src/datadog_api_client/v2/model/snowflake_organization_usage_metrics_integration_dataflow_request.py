...
class SnowflakeOrganizationUsageMetricsIntegrationDataflowRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.snowflake_organization_usage_metrics_integration_dataflow_settings_request import (
            SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsRequest,
    ...
    def __init__(
        ...
        settings: Union[SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsRequest, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param settings: Settings of the organization usage metrics dataflow. Only the fields provided are changed.
        :type settings: SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsRequest, optional
        """
