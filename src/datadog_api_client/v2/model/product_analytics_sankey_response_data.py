...
class ProductAnalyticsSankeyResponseData(ModelNormal):
    ...
    def __init__(
        self_,
        attributes: Union[ProductAnalyticsSankeyResponseAttributes, UnsetType] = unset,
        id: Union[str, UnsetType] = unset,
        type: Union[ProductAnalyticsSankeyResponseType, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param attributes:
        :type attributes: ProductAnalyticsSankeyResponseAttributes, optional

        :param id:
        :type id: str, optional

        :param type:
        :type type: ProductAnalyticsSankeyResponseType, optional
        """
