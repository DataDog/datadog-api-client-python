...
class SAMLConfigurationUpdateData(ModelNormal):
    validations = {
        "id": {
            "max_length": 39,
        },
    ...
    def __init__(
        ...
        id: str,
        type: SAMLConfigurationsType,
        attributes: Union[SAMLConfigurationUpdateAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param attributes: Attributes for updating a SAML configuration.
        :type attributes: SAMLConfigurationUpdateAttributes, optional

        :param id: The UUID of the SAML configuration to update. Must match the UUID in the URL path.
        :type id: str
