...
class ScheduleTriggerWrapper(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.schedule_trigger import ScheduleTrigger
    ...
    def __init__(
        self_, schedule_trigger: ScheduleTrigger, start_step_names: Union[List[str], UnsetType] = unset, **kwargs
    ):
        """
        ...
        self_.schedule_trigger = schedule_trigger
