...
class SnowflakeIntegrationDataflowsResponse(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param snowflake_task_history_logs: Execution logs for your scheduled Snowflake tasks, covering start time, end time, status, and any error message.
