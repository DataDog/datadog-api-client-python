...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.datastore_data_attributes_primary_key_generation_strategy import (
...
class DatastoreDataAttributes(ModelNormal):
    ...
    def __init__(
        ...
        primary_key_generation_strategy: Union[DatastoreDataAttributesPrimaryKeyGenerationStrategy, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param creator_user_id: The ``attributes`` ``creator_user_id``.
        :type creator_user_id: int, optional

        :param creator_user_uuid: The ``attributes`` ``creator_user_uuid``.
        ...
        :type primary_key_generation_strategy: DatastoreDataAttributesPrimaryKeyGenerationStrategy, optional
        """
