...
class IncidentAutomationDataResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_automation_data_data_response import (
    ...
    def __init__(self_, data: IncidentAutomationDataDataResponse, **kwargs):
        """
        Response with automation data.

        :param data: Automation data in a response.
        :type data: IncidentAutomationDataDataResponse
        """
