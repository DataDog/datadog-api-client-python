...
class ApplicationSecurityExclusionFilterOnMatch(ModelSimple):
    """
    ...
    MONITOR: ClassVar["ApplicationSecurityExclusionFilterOnMatch"]
...
ApplicationSecurityExclusionFilterOnMatch.MONITOR = ApplicationSecurityExclusionFilterOnMatch("monitor")
