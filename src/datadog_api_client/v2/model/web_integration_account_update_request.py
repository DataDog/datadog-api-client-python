...
class WebIntegrationAccountUpdateRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.web_integration_account_update_request_data import (
            WebIntegrationAccountUpdateRequestData,
    ...
    def __init__(self_, data: WebIntegrationAccountUpdateRequestData, **kwargs):
        """
        Payload for updating a web integration account.

        :param data: Data object for updating a web integration account.
        :type data: WebIntegrationAccountUpdateRequestData
        """
