...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.incident_impact_field_data_response import IncidentImpactFieldDataResponse
    from datadog_api_client.v2.model.incident_user_data import IncidentUserData


class IncidentImpactFieldsResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.incident_impact_field_data_response import IncidentImpactFieldDataResponse
        from datadog_api_client.v2.model.incident_user_data import IncidentUserData
    ...
    def __init__(
        self_,
        data: List[IncidentImpactFieldDataResponse],
        ...
        **kwargs,
        ...
        :param data: List of impact fields.
        :type data: [IncidentImpactFieldDataResponse]
