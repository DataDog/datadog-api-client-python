...
class CreateJiraIssueRequestDataAttributes(ModelNormal):
    ...
    def __init__(self_, fields: Union[CreateJiraIssueRequestDataAttributesFields, UnsetType] = unset, **kwargs):
        ...
        :param fields: Custom fields of the Jira issue to create. You can refer to the `Jira documentation <https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-issues/#api-rest-api-2-issue-createmeta-projectidorkey-issuetypes-issuetypeid-get>`_ for the list of available fields.
