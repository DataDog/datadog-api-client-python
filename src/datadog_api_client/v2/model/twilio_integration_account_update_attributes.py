...
class TwilioIntegrationAccountUpdateAttributes(ModelNormal):
    ...
    def __init__(
        ...
        settings: Union[TwilioIntegrationAccountSettingsUpdate, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param settings: Settings for updating the Twilio integration account. Only the fields provided are changed.
        :type settings: TwilioIntegrationAccountSettingsUpdate, optional
        """
