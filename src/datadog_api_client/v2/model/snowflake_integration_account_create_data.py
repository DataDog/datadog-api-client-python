...
class SnowflakeIntegrationAccountCreateData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.snowflake_integration_account_create_attributes import (
            SnowflakeIntegrationAccountCreateAttributes,
    ...
    def __init__(
        self_, attributes: SnowflakeIntegrationAccountCreateAttributes, type: IntegrationAccountType, **kwargs
    ):
        """
        Data envelope for creating a Snowflake integration account.

        :param attributes: Writable attributes used to create a Snowflake integration account.
        :type attributes: SnowflakeIntegrationAccountCreateAttributes
