...
class SnowflakeSecurityLogsIntegrationDataflowSettingsRequest(ModelNormal):
    @cached_property
    ...
    def __init__(self_, security_logs_interval_min: Union[int, UnsetType] = unset, **kwargs):
        ...
        :param security_logs_interval_min: How often security logs are collected, in minutes. One of ``5`` , ``15`` , ``30`` , ``60`` , ``360`` , ``720`` , or ``1440``. Defaults to ``5``.
