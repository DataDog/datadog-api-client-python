...
class EventPayload(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param aggregation_key: An arbitrary string to use for aggregation when correlating events. If you specify a key, events are deduplicated to alerts based on this key. Limited to 100 characters.
        :type aggregation_key: str, optional

        :param attributes: JSON object for custom attributes. Schema is different per event category.
        :type attributes: EventPayloadAttributes

        :param category: Event category to identify the type of event.
        :type category: EventCategory

        :param integration_id: Integration IDs sourced from integration manifests. Only ``custom-events`` is supported.
        ...
        :param tags: A list of tags to apply to the event. Maximum of 100 tags allowed.
