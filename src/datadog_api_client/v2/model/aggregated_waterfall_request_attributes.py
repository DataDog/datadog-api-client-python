...
class AggregatedWaterfallRequestAttributes(ModelNormal):
    validations = {
        "sample_size": {
    ...
    def openapi_types(_):
        ...
        return {
            ...
            "filter": (str,),
            "_from": (int,),
            "include_global_appearance": (bool,),
            "sample_size": (int,),
            "to": (int,),
            "view_name": (str,),
        }
    ...
    def __init__(
        ...
        include_global_appearance: Union[bool, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param include_global_appearance: When true, enriches each resource with cross-view appearance statistics.
        :type include_global_appearance: bool, optional
        ...
        if include_global_appearance is not unset:
            kwargs["include_global_appearance"] = include_global_appearance
