...
class LLMObsAnnotationsDataResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.llm_obs_annotations_data_attributes_response import (
            LLMObsAnnotationsDataAttributesResponse,
    ...
    def __init__(
        self_, attributes: LLMObsAnnotationsDataAttributesResponse, id: str, type: LLMObsAnnotationsType, **kwargs
    ):
        """
        Data object for the annotations response.

        :param attributes: Attributes of the annotations response.
        :type attributes: LLMObsAnnotationsDataAttributesResponse
