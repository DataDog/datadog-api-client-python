...
class ExternalUserGroup(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.external_user_group_members_items import ExternalUserGroupMembersItems
        from datadog_api_client.v2.model.external_user_group_meta import ExternalUserGroupMeta
        ...
        return {
            ...
            "external_id": (str,),
            "id": (str,),
            "members": ([ExternalUserGroupMembersItems],),
    ...
    def __init__(
        ...
        members: Union[List[ExternalUserGroupMembersItems], UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param members: Members of the SCIM group.
        :type members: [ExternalUserGroupMembersItems], optional
