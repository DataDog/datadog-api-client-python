...
class IOSSourcemapData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.ios_sourcemap_attributes import IOSSourcemapAttributes
        from datadog_api_client.v2.model.sourcemap_data_type import SourcemapDataType
    ...
    def __init__(self_, attributes: IOSSourcemapAttributes, id: str, type: SourcemapDataType, **kwargs):
        """
        iOS dSYM source map data object.

        :param attributes: Attributes of an iOS dSYM source map.
        :type attributes: IOSSourcemapAttributes
