...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.list_connections_response_data_attributes import (
...
class ListConnectionsResponseData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.list_connections_response_data_attributes import (
            ListConnectionsResponseDataAttributes,
    ...
    def __init__(
        self_,
        type: ListConnectionsResponseDataType,
        attributes: Union[ListConnectionsResponseDataAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type type: ListConnectionsResponseDataType
        """
