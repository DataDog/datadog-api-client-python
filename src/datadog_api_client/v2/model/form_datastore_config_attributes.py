...
class FormDatastoreConfigAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "datastore_id": (UUID,),
    ...
    def __init__(self_, datastore_id: UUID, primary_column_name: str, primary_key_generation_strategy: str, **kwargs):
        ...
        :param primary_column_name: The name of the primary column in the datastore.
        :type primary_column_name: str

        :param primary_key_generation_strategy: The strategy used to generate primary keys in the datastore.
