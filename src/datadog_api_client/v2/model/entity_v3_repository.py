...
class EntityV3Repository(ModelNormal):
    @cached_property
    ...
    def __init__(
        ...
        kind: EntityV3RepositoryKind,
        metadata: EntityV3Metadata,
        datadog: Union[EntityV3RepositoryDatadog, UnsetType] = unset,
        extensions: Union[Dict[str, Any], UnsetType] = unset,
        integrations: Union[EntityV3Integrations, UnsetType] = unset,
        spec: Union[EntityV3RepositorySpec, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param datadog: Datadog product integrations for the repository entity.
        :type datadog: EntityV3RepositoryDatadog, optional
        ...
        :param kind: The definition of Entity V3 Repository Kind object.
        :type kind: EntityV3RepositoryKind

        :param metadata: The definition of Entity V3 Metadata object.
        :type metadata: EntityV3Metadata

        :param spec: The definition of Entity V3 Repository Spec object.
        :type spec: EntityV3RepositorySpec, optional
        """
