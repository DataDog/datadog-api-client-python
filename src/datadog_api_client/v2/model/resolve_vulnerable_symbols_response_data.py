...
class ResolveVulnerableSymbolsResponseData(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: The definition of ``ResolveVulnerableSymbolsResponseDataAttributes`` object.
        :type attributes: ResolveVulnerableSymbolsResponseDataAttributes, optional

        :param id: The ``ResolveVulnerableSymbolsResponseData`` ``id``.
        :type id: str, optional

        :param type: Resolve vulnerable symbols response resource type.
