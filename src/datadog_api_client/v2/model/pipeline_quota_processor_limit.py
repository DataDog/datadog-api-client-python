...
class PipelineQuotaProcessorLimit(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.pipeline_quota_processor_limit_enforce_type import (
            PipelineQuotaProcessorLimitEnforceType,
    ...
    def __init__(self_, enforce: PipelineQuotaProcessorLimitEnforceType, limit: int, **kwargs):
        """
        The maximum amount of data or number of events allowed before the quota is enforced. Can be specified in bytes or events.

        :param enforce: Unit for quota enforcement in bytes for data size or events for count.
        :type enforce: PipelineQuotaProcessorLimitEnforceType
