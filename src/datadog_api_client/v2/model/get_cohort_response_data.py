...
class GetCohortResponseData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.get_cohort_response_data_attributes import GetCohortResponseDataAttributes
        from datadog_api_client.v2.model.get_cohort_response_data_type import GetCohortResponseDataType
    ...
    def __init__(
        self_,
        type: GetCohortResponseDataType,
        attributes: Union[GetCohortResponseDataAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param attributes:
        :type attributes: GetCohortResponseDataAttributes, optional

        :param id:
        :type id: str, optional

        :param type:
        :type type: GetCohortResponseDataType
        """
