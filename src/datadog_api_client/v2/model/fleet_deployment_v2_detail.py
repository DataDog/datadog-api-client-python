...
class FleetDeploymentV2Detail(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.fleet_deployment_v2_detail_attributes import FleetDeploymentV2DetailAttributes
        from datadog_api_client.v2.model.fleet_deployment_resource_type import FleetDeploymentResourceType
    ...
    def __init__(
        self_, attributes: FleetDeploymentV2DetailAttributes, id: str, type: FleetDeploymentResourceType, **kwargs
    ):
        """
        Detailed information about a deployment.

        :param attributes: Attributes of a deployment detail response.
        :type attributes: FleetDeploymentV2DetailAttributes
