...
class ReportScheduleListResponseLinks(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "first": (str, none_type),
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :type first: str, none_type, optional

        :param last: Link to the last page, or ``null`` if it is unavailable.
        :type last: str, none_type, optional

        :param next: Link to the next page, or ``null`` if it is unavailable.
        :type next: str, none_type, optional

        :param prev: Link to the previous page, or ``null`` if it is unavailable.
        :type prev: str, none_type, optional

        :param self: Link to the current page.
        :type self: str, none_type, optional
        """
