...
class ApplicationSecurityPolicyListResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.application_security_policy_data import ApplicationSecurityPolicyData
    ...
    def __init__(self_, data: Union[List[ApplicationSecurityPolicyData], UnsetType] = unset, **kwargs):
        """
        Response object that includes a list of WAF policies.

        :param data: The WAF policy data.
