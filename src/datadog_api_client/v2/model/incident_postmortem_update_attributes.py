...
class IncidentPostmortemUpdateAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.postmortem_status import PostmortemStatus
    ...
    def __init__(self_, status: Union[PostmortemStatus, UnsetType] = unset, **kwargs):
        """
        The postmortem's attributes for an update request.

        :param status: The status of the postmortem.
        :type status: PostmortemStatus, optional
        """
