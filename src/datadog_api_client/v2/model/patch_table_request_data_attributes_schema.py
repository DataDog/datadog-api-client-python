...
class PatchTableRequestDataAttributesSchema(ModelNormal):
    ...
    def openapi_types(_):
        ...
        return {
            "fields": ([PatchTableRequestDataAttributesSchemaFieldsItems],),
            "primary_keys": ([str],),
        }
    ...
    def __init__(
        ...
        :param primary_keys: List of field names that serve as primary keys for the table. Currently only 1 primary key is supported, and it is used as an ID to retrieve rows.
