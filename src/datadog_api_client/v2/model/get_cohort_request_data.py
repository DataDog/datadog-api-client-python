...
class GetCohortRequestData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.get_cohort_request_data_attributes import GetCohortRequestDataAttributes
        from datadog_api_client.v2.model.get_cohort_request_data_type import GetCohortRequestDataType
    ...
    def __init__(
        self_,
        type: GetCohortRequestDataType,
        attributes: Union[GetCohortRequestDataAttributes, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param attributes:
        :type attributes: GetCohortRequestDataAttributes, optional

        :param id:
        :type id: str, optional

        :param type:
        :type type: GetCohortRequestDataType
        """
