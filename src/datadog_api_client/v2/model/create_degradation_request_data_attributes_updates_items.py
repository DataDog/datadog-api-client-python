...
class CreateDegradationRequestDataAttributesUpdatesItems(ModelNormal):
    ...
    def __init__(
        ...
        components_affected: Union[
            List[CreateDegradationRequestDataAttributesUpdatesItemsComponentsAffectedItems], UnsetType
        ] = unset,
        ...
        **kwargs,
        ...
        :type components_affected: [CreateDegradationRequestDataAttributesUpdatesItemsComponentsAffectedItems], optional
