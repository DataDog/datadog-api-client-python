...
class CreateDegradationRequestDataAttributesUpdatesItems(ModelNormal):
    ...
    def openapi_types(_):
        ...
        return {
            "components_affected": ([CreateDegradationRequestDataAttributesUpdatesItemsComponentsAffectedItems],),
            "description": (str,),
            "started_at": (datetime,),
    ...
    def __init__(
        self_,
        components_affected: List[CreateDegradationRequestDataAttributesUpdatesItemsComponentsAffectedItems],
        description: str,
        started_at: datetime,
        status: CreateDegradationRequestDataAttributesStatus,
        **kwargs,
        ...
        :type components_affected: [CreateDegradationRequestDataAttributesUpdatesItemsComponentsAffectedItems]
