...
if TYPE_CHECKING:
    ...
    from datadog_api_client.v2.model.create_apps_datastore_request_data_type import CreateAppsDatastoreRequestDataType
...
class CreateAppsDatastoreRequestData(ModelNormal):
    ...
    def openapi_types(_):
        ...
        from datadog_api_client.v2.model.create_apps_datastore_request_data_type import (
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: The definition of ``CreateAppsDatastoreRequestDataAttributes`` object.
        :type attributes: CreateAppsDatastoreRequestDataAttributes, optional

        :param id: The ``CreateAppsDatastoreRequestData`` ``id``.
        :type id: str, optional

        :param type: Datastores resource type.
        :type type: CreateAppsDatastoreRequestDataType
        """
