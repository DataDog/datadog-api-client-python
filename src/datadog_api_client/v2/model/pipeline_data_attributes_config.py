...
class PipelineDataAttributesConfig(ModelNormal):
    ...
    def openapi_types(_):
        return {
            ...
            "sources": ([DatadogAgentSource, KafkaSource],),
        }
    ...
    def __init__(
        ...
        sources: List[Union[DatadogAgentSource, KafkaSource]],
        **kwargs,
    ):
        """
        ...
        :type processors: [FilterProcessor, ParseJSONProcessor, QuotaProcessor, AddFieldsProcessor, RemoveFieldsProcessor, RenameFieldsProcessor]

        :param sources: The ``PipelineDataAttributesConfig`` ``sources``.
        :type sources: [DatadogAgentSource, KafkaSource]
        """
