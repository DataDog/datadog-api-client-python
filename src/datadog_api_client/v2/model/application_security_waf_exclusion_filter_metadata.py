...
class ApplicationSecurityWafExclusionFilterMetadata(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "added_at": (datetime,),
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param added_at: The creation date of the exclusion filter.
        :type added_at: datetime, optional

        :param added_by: The handle of the user who created the exclusion filter.
        :type added_by: str, optional

        :param added_by_name: The name of the user who created the exclusion filter.
        :type added_by_name: str, optional

        :param modified_at: The last modification date of the exclusion filter.
        :type modified_at: datetime, optional

        :param modified_by: The handle of the user who last modified the exclusion filter.
        :type modified_by: str, optional

        :param modified_by_name: The name of the user who last modified the exclusion filter.
