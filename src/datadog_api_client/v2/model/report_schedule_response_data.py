...
class ReportScheduleResponseData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.report_schedule_response_attributes import ReportScheduleResponseAttributes
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: The configuration and derived state of a report schedule.
        :type attributes: ReportScheduleResponseAttributes
