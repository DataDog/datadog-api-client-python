...
class CreateAppsDatastoreRequestDataAttributes(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param org_access: The organization access level for the datastore (e.g., 'contributor').
        :type org_access: str, optional

        :param primary_column_name: The name of the column that will serve as the primary key for items in this datastore. Cannot exceed 63 characters.
