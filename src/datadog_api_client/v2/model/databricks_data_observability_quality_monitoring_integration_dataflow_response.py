...
class DatabricksDataObservabilityQualityMonitoringIntegrationDataflowResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.databricks_data_observability_quality_monitoring_integration_dataflow_settings_response import (
            DatabricksDataObservabilityQualityMonitoringIntegrationDataflowSettingsResponse,
    ...
    def __init__(
        ...
        settings: Union[
            DatabricksDataObservabilityQualityMonitoringIntegrationDataflowSettingsResponse, UnsetType
        ] = unset,
        **kwargs,
    ):
        """
        ...
        :param settings: Settings of the Data Observability dataflow.
        :type settings: DatabricksDataObservabilityQualityMonitoringIntegrationDataflowSettingsResponse, optional
        """
