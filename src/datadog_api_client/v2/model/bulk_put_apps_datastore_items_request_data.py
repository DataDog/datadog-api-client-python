...
class BulkPutAppsDatastoreItemsRequestData(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: The definition of ``BulkPutAppsDatastoreItemsRequestDataAttributes`` object.
        :type attributes: BulkPutAppsDatastoreItemsRequestDataAttributes, optional

        :param id: The ``BulkPutAppsDatastoreItemsRequestData`` ``id``.
        :type id: str, optional

        :param type: Items resource type.
        :type type: BulkPutAppsDatastoreItemsRequestDataType
        """
