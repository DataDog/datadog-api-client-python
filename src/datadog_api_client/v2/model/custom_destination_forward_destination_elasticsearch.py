...
class CustomDestinationForwardDestinationElasticsearch(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.custom_destination_elasticsearch_destination_auth import (
            CustomDestinationElasticsearchDestinationAuth,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :type auth: CustomDestinationElasticsearchDestinationAuth
        ...
        :type type: CustomDestinationForwardDestinationElasticsearchType
        """
