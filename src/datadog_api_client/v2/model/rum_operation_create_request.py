...
class RUMOperationCreateRequest(ModelNormal):
    ...
    def __init__(self_, data: RUMOperationCreateRequestData, **kwargs):
        """
        The request body for creating a RUM operation.

        :param data: The data object for creating a RUM operation.
        :type data: RUMOperationCreateRequestData
        """
