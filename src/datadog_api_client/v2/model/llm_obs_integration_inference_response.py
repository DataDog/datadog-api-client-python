...
class LLMObsIntegrationInferenceResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.llm_obs_anthropic_metadata import LLMObsAnthropicMetadata
        from datadog_api_client.v2.model.llm_obs_azure_open_ai_metadata import LLMObsAzureOpenAIMetadata
    ...
    def __init__(
        ...
        error_response: Union[LLMObsInferenceErrorResponse, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param error_response: Error details returned when an inference provider returns an error.
        :type error_response: LLMObsInferenceErrorResponse, optional

        :param frequency_penalty: Frequency penalty that was applied.
        :type frequency_penalty: float, none_type, optional

        :param json_schema: JSON schema that was applied for structured output.
        :type json_schema: str, none_type, optional

        :param max_completion_tokens: Maximum number of completion tokens that were configured.
        :type max_completion_tokens: int, none_type, optional

        :param max_tokens: Maximum number of tokens that were configured.
        ...
        :param model_id: The model identifier used for inference.
        :type model_id: str
        ...
        :param presence_penalty: Presence penalty that was applied.
        :type presence_penalty: float, none_type, optional

        :param response: The output of a completed LLM inference call.
        :type response: LLMObsInferenceRunResult

        :param temperature: Sampling temperature that was used.
        ...
        :param top_k: Top-K sampling parameter that was used.
        :type top_k: int, none_type, optional

        :param top_p: Nucleus sampling parameter that was used.
        ...
        if error_response is not unset:
            kwargs["error_response"] = error_response
