...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.monitor_downtime_match_list_item_response import (
        MonitorDowntimeMatchListItemResponse,
    )
...
class MonitorDowntimeMatchResponse(ModelNormal):
    ...
    def openapi_types(_):
        ...
        return {
            "data": ([MonitorDowntimeMatchListItemResponse],),
            "meta": (DowntimeMeta,),
        }
    ...
    def __init__(
        self_,
        data: Union[List[MonitorDowntimeMatchListItemResponse], UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type data: [MonitorDowntimeMatchListItemResponse], optional
