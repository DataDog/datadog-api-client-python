...
class CreateDegradationRequestDataRelationships(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.create_degradation_request_data_relationships_template import (
            CreateDegradationRequestDataRelationshipsTemplate,
    ...
    def __init__(
        self_, template: Union[CreateDegradationRequestDataRelationshipsTemplate, UnsetType] = unset, **kwargs
    ):
        """
        The supported relationships for creating a degradation.

        :param template: The template used to create the degradation.
        :type template: CreateDegradationRequestDataRelationshipsTemplate, optional
        """
