...
class EscalationPolicyUpdateRequestDataAttributesStepsItemsTargetsItems(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.escalation_policy_update_request_data_attributes_steps_items_targets_items_type import (
            EscalationPolicyUpdateRequestDataAttributesStepsItemsTargetsItemsType,
    ...
    def __init__(
        ...
        type: Union[EscalationPolicyUpdateRequestDataAttributesStepsItemsTargetsItemsType, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :type type: EscalationPolicyUpdateRequestDataAttributesStepsItemsTargetsItemsType, optional
        """
        if id is not unset:
            kwargs["id"] = id
