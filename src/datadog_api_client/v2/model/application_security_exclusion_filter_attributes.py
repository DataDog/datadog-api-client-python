...
class ApplicationSecurityExclusionFilterAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.application_security_exclusion_filter_on_match import (
            ApplicationSecurityExclusionFilterOnMatch,
        ...
        return {
            ...
            "parameters": ([str],),
            "path_glob": (str,),
            "rules_target": ([ApplicationSecurityExclusionFilterRulesTarget],),
            "scope": ([ApplicationSecurityExclusionFilterScope],),
        }
    ...
    def __init__(
        ...
        on_match: Union[ApplicationSecurityExclusionFilterOnMatch, UnsetType] = unset,
        parameters: Union[List[str], UnsetType] = unset,
        path_glob: Union[str, UnsetType] = unset,
        rules_target: Union[List[ApplicationSecurityExclusionFilterRulesTarget], UnsetType] = unset,
        scope: Union[List[ApplicationSecurityExclusionFilterScope], UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param event_query: The event query matched by the legacy exclusion filter.
        ...
        :type on_match: ApplicationSecurityExclusionFilterOnMatch, optional
        ...
        :type rules_target: [ApplicationSecurityExclusionFilterRulesTarget], optional

        :param scope: The services where the exclusion filter is deployed.
        :type scope: [ApplicationSecurityExclusionFilterScope], optional
        """
