...
class UpdateAppProtectionLevelRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
    ...
    def __init__(self_, data: Union[UpdateAppProtectionLevelRequestData, UnsetType] = unset, **kwargs):
        """
        A request to update an app's publication protection level.

        :param data: Data for updating an app's publication protection level.
        :type data: UpdateAppProtectionLevelRequestData, optional
        """
