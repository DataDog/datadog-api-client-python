...
class SyntheticsApiMultistepParentTestAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "child_name": (str,),
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param child_name: The name of the child subtest.
        :type child_name: str, optional

        :param child_public_id: The public ID of the child subtest.
        ...
        :param overall_state: The overall state of the parent test.
        ...
        :param public_id: The public ID of the parent test.
