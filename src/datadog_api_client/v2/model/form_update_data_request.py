...
class FormUpdateDataRequest(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.form_update_attributes import FormUpdateAttributes
        from datadog_api_client.v2.model.form_type import FormType
    ...
    def __init__(self_, attributes: FormUpdateAttributes, type: FormType, id: Union[UUID, UnsetType] = unset, **kwargs):
        """


        :param attributes: Attributes for updating a form.
        :type attributes: FormUpdateAttributes
