...
class ProductAnalyticsSankeyLink(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param column: Zero-based index of the column the link starts from.
        :type column: int, optional

        :param id: Unique identifier for the link.
        :type id: str, optional

        :param source: Identifier of the node the link starts at.
        :type source: str, optional

        :param target: Identifier of the node the link ends at.
        :type target: str, optional

        :param value: Number of sessions flowing along the link.
