...
class DatabricksIntegrationAccountsResponse(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.databricks_integration_account_response_data import (
            DatabricksIntegrationAccountResponseData,
    ...
    def __init__(self_, data: List[DatabricksIntegrationAccountResponseData], **kwargs):
        """
        Response payload for a list of Databricks integration accounts.

        :param data: List of Databricks integration accounts.
