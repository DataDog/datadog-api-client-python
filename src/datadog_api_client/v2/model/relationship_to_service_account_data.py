...
class RelationshipToServiceAccountData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.service_account_type import ServiceAccountType
    ...
    def __init__(self_, id: str, type: ServiceAccountType, **kwargs):
        """
        ...
        :param type: Service account resource type.
        :type type: ServiceAccountType
        """
