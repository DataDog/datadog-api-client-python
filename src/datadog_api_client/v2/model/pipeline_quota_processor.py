...
class PipelineQuotaProcessor(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.pipeline_quota_processor_limit import PipelineQuotaProcessorLimit
        from datadog_api_client.v2.model.pipeline_quota_processor_override import PipelineQuotaProcessorOverride
        ...
        return {
            ...
            "name": (str,),
            "overrides": ([PipelineQuotaProcessorOverride],),
    ...
    def __init__(
        ...
        overrides: Union[List[PipelineQuotaProcessorOverride], UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type limit: PipelineQuotaProcessorLimit
        ...
        :type overrides: [PipelineQuotaProcessorOverride], optional
        ...
        :type type: PipelineQuotaProcessorType
        """
