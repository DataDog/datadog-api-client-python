...
if TYPE_CHECKING:
    from datadog_api_client.v2.model.attributes import Attributes
...
class RestrictionPolicy(ModelNormal):
    ...
    def __init__(self_, attributes: Attributes, id: str, type: RestrictionPolicyType, **kwargs):
        """
        ...
        :param id: The identifier, always equivalent to resource_id.
        :type id: str
