...
class IssueAttributes(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param first_seen_version: Version where the issue was first observed.
        ...
        :param impacted_sessions: Count of sessions impacted by the issue.
        :type impacted_sessions: int, optional

        :param impacted_users: Count of users impacted by the issue.
        ...
        :param last_seen_version: Version where the issue was last observed.
