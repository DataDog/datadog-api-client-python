...
class ElasticCloudIntegrationAccountUpdateData(ModelNormal):
    ...
    def __init__(
        self_, attributes: ElasticCloudIntegrationAccountUpdateAttributes, type: IntegrationAccountType, **kwargs
    ):
        """
        Data envelope for updating an Elastic Cloud integration account.

        :param attributes: Updatable attributes of an Elastic Cloud integration account. Every field is optional; only the fields provided are changed.
