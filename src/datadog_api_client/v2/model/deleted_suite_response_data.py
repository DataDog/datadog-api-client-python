...
if TYPE_CHECKING:
    ...
    from datadog_api_client.v2.model.deleted_suite_type import DeletedSuiteType
...
class DeletedSuiteResponseData(ModelNormal):
    ...
    def __init__(
        ...
        type: Union[DeletedSuiteType, UnsetType] = unset,
        **kwargs,
    ):
        """
        ...
        :param type:
        :type type: DeletedSuiteType, optional
        """
