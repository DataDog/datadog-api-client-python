...
class SyntheticsTestResultCertificateValidity(ModelNormal):
    @cached_property
    def openapi_types(_):
        return {
            "_from": (int,),
    ...
    def __init__(self_, _from: Union[int, UnsetType] = unset, to: Union[int, UnsetType] = unset, **kwargs):
        ...
        :param _from: Unix timestamp (ms) of when the certificate became valid.
        :type _from: int, optional

        :param to: Unix timestamp (ms) of when the certificate expires.
