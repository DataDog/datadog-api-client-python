...
class AWSEventBridgeCreateResponseData(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.aws_event_bridge_create_response_attributes import (
            AWSEventBridgeCreateResponseAttributes,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param attributes: A created EventBridge source.
        :type attributes: AWSEventBridgeCreateResponseAttributes

        :param id: The ID of the Amazon EventBridge create response data.
