...
class SlackIntegrationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_slack_integration_channel(self, account_name, body, **kwargs):
        ...
        self.create_slack_integration_channel = _Endpoint(
            settings={
            ...
            callable=__create_slack_integration_channel,
        )

        def __get_slack_integration_channel(self, account_name, channel_name, **kwargs):
        ...
        self.get_slack_integration_channel = _Endpoint(
            settings={
                "response_type": (SlackIntegrationChannel,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
            ...
            api_client=api_client,
            callable=__get_slack_integration_channel,
        )

        def __get_slack_integration_channels(self, account_name, **kwargs):
        ...
        self.get_slack_integration_channels = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_slack_integration_channels,
        )

        def __remove_slack_integration_channel(self, account_name, channel_name, **kwargs):
        ...
        self.remove_slack_integration_channel = _Endpoint(
            settings={
                "response_type": None,
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v1/integration/slack/configuration/accounts/{account_name}/channels/{channel_name}",
            ...
            api_client=api_client,
            callable=__remove_slack_integration_channel,
        )

        def __update_slack_integration_channel(self, account_name, channel_name, body, **kwargs):
        ...
        self.update_slack_integration_channel = _Endpoint(
            settings={
                "response_type": (SlackIntegrationChannel,),
                "auth": ["apiKeyAuth", "appKeyAuth"],
                "endpoint_path": "/api/v1/integration/slack/configuration/accounts/{account_name}/channels/{channel_name}",
            ...
            headers_map={"accept": ["application/json"], "content_type": ["application/json"]},
            api_client=api_client,
            callable=__update_slack_integration_channel,
        )
