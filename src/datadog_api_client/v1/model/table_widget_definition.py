...
class TableWidgetDefinition(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'requests': ([table_widget_request.TableWidgetRequest],),  # noqa: E501
            'type': (table_widget_definition_type.TableWidgetDefinitionType,),  # noqa: E501
    ...
    def __init__(self, requests, type, *args, **kwargs):  # noqa: E501
        """table_widget_definition.TableWidgetDefinition - a model defined in OpenAPI

        Args:
            requests ([table_widget_request.TableWidgetRequest]): Widget definition.
            type (table_widget_definition_type.TableWidgetDefinitionType):
