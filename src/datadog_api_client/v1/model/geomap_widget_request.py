...
class GeomapWidgetRequest(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param conditional_formats: Threshold (numeric) conditional formatting rules may be used by the regions layer.
        ...
        :param text_formats: Text formatting rules may be used by the points layer.
