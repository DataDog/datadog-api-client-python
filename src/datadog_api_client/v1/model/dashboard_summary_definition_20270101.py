...
class DashboardSummaryDefinition_20270101(ModelNormal):
    validations = {
        "popularity": {
            "inclusive_maximum": 5,
        },
    ...
    def openapi_types(_):
        ...
        return {
            ...
            "icon": (str, none_type),
            "id": (DashboardSummaryID_20270101,),
    ...
    def __init__(
        ...
        id: Union[DashboardSummaryID_20270101, str, int, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :type id: DashboardSummaryID_20270101, optional
