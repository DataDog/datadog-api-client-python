...
class SyntheticsTestConfig(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Keyword Args:
            ...
            assertions ([SyntheticsAssertion]): Array of assertions used for the test. Required for single API tests.. [optional] if omitted the server will use the default value of []
