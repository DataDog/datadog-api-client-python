...
class ViewingPreferences(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param high_density: Whether the widgets on the shared dash should be displayed with high density.
        :type high_density: bool, optional

        :param theme: The theme of the shared dashboard view. "system" will follow your system's default viewing theme.
