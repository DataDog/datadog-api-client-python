...
class SyntheticsMobileStepParams(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param delay: Number of milliseconds to wait between inputs in a TYPE_TEXT step type.
        :type delay: int, optional

        :param direction: The direction of the scroll for a SCROLL_TO_ELEMENT step type.
        ...
        :param enable: Boolean to change the state of the wifi for a TOGGLE_WIFI step type.
        :type enable: bool, optional

        :param max_scrolls: Maximum number of scrolls to do for a SCROLL_TO_ELEMENT step type.
        ...
        :param subtest_public_id: Public Id of the test to be played as part of a PLAY_SUBTEST step type.
        :type subtest_public_id: str, optional

        :param value: Values used in the step. Used in multiple step types.
        :type value: str, optional

        :param variable: Variable object for EXTRACT_VARIABLE step type.
        :type variable: SyntheticsMobileStepParamsVariable, optional

        :param with_enter: Boolean to signal if ``Enter`` should be pressed at the end of the TYPE_TEXT step type.
