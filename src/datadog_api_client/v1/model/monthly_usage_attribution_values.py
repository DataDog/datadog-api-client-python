...
class MonthlyUsageAttributionValues(ModelNormal):
    ...
    def __init__(
        ...
        code_security_host_percentage: Union[float, UnsetType] = unset,
        code_security_host_usage: Union[float, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param code_security_host_percentage: The percentage of Code Security host usage by tag(s).
        :type code_security_host_percentage: float, optional

        :param code_security_host_usage: The Code Security host usage by tag(s).
