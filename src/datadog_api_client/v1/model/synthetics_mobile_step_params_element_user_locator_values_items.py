...
class SyntheticsMobileStepParamsElementUserLocatorValuesItems(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param type: The definition of ``SyntheticsMobileStepParamsElementUserLocatorValuesItemsType`` object.
        :type type: SyntheticsMobileStepParamsElementUserLocatorValuesItemsType, optional

        :param value: The ``SyntheticsMobileStepParamsElementUserLocatorValuesItems`` ``value``.
