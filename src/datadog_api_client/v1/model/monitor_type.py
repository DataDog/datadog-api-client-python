...
class MonitorType(ModelSimple):
    ...
    allowed_values = {
        ("value",): {
            ...
            "LOG_ALERT": "log alert",
            "METRIC_ALERT": "process alert",
            "PROCESS_ALERT": "query alert",
            "QUERY_ALERT": "rum alert",
            "RUM_ALERT": "service check",
            "SERVICE_CHECK": "synthetics alert",
            "SYNTHETICS_ALERT": "trace-analytics alert",
            "TRACE_ANALYTICS_ALERT": "slo alert",
            "SLO_ALERT": "event-v2 alert",
            "EVENT_V2_ALERT": "audit alert",
        },
    }
