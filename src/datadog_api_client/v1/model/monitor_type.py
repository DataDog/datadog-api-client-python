...
class MonitorType(ModelSimple):
    ...
    allowed_values = {
        ("value",): {
            ...
            "METRIC_SLO_ALERT": "metric-slo alert",
            "MONITOR_SLO_ALERT": "monitor-slo alert",
        },
    }
