...
class ChangeWidgetDefinition(ModelNormal):
    ...
    def __init__(self, requests, type, *args, **kwargs):  # noqa: E501
        """change_widget_definition.ChangeWidgetDefinition - a model defined in OpenAPI

        Args:
            requests ([change_widget_request.ChangeWidgetRequest]): Array of one request object to display in the widget.  See the dedicated [Request JSON schema documentation](https://docs.datadoghq.com/dashboards/graphing_json/request_json)  to learn how to build the &#x60;REQUEST_SCHEMA&#x60;.
            type (change_widget_definition_type.ChangeWidgetDefinitionType):
