...
class UsageSummaryResponse(ModelNormal):
    ...
    def openapi_types(_):
        ...
        return {
            ...
            "do_jobs_monitoring_serverless_job_hours_agg_sum": (int,),
            "end_date": (datetime,),
    ...
    def __init__(
        ...
        do_jobs_monitoring_serverless_job_hours_agg_sum: Union[int, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param do_jobs_monitoring_serverless_job_hours_agg_sum: Shows the sum of all serverless job hours over all hours in the current month for all organizations.
        :type do_jobs_monitoring_serverless_job_hours_agg_sum: int, optional
        ...
        if do_jobs_monitoring_serverless_job_hours_agg_sum is not unset:
            kwargs["do_jobs_monitoring_serverless_job_hours_agg_sum"] = do_jobs_monitoring_serverless_job_hours_agg_sum
