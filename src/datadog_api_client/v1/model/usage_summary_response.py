...
class UsageSummaryResponse(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param cloud_cost_management_oci_host_count_avg_sum: Sum of the host count average for Cloud Cost Management for OCI.
        ...
        :param eph_infra_host_proxmox_agg_sum: Shows the sum of all ephemeral infrastructure hosts for Proxmox over all hours in the current month for all organizations.
        ...
        :param proxmox_host_agg_sum: Shows the sum of all Proxmox hosts over all hours in the current month for all organizations.
        :type proxmox_host_agg_sum: int, optional

        :param proxmox_host_top99p_sum: Shows the sum of the 99th percentile of all Proxmox hosts over all hours in the current month for all organizations.
