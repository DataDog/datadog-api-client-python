...
class UsageSummaryResponse(ModelNormal):
    ...
    def openapi_types(_):
        ...
        return {
            ...
            "end_date": (datetime,),
            "eph_infra_basic_agent_agg_sum": (int,),
            "eph_infra_basic_vsphere_agg_sum": (int,),
            ...
            "infra_basic_agent_host_top99p_sum": (int,),
            "infra_basic_vsphere_host_top99p_sum": (int,),
    ...
    attribute_map = {
        ...
        "end_date": "end_date",
        "eph_infra_basic_agent_agg_sum": "eph_infra_basic_agent_agg_sum",
        "eph_infra_basic_vsphere_agg_sum": "eph_infra_basic_vsphere_agg_sum",
        ...
        "infra_basic_agent_host_top99p_sum": "infra_basic_agent_host_top99p_sum",
        "infra_basic_vsphere_host_top99p_sum": "infra_basic_vsphere_host_top99p_sum",
    ...
    def __init__(
        ...
        eph_infra_basic_agent_agg_sum: Union[int, UnsetType] = unset,
        eph_infra_basic_vsphere_agg_sum: Union[int, UnsetType] = unset,
        ...
        infra_basic_agent_host_top99p_sum: Union[int, UnsetType] = unset,
        infra_basic_vsphere_host_top99p_sum: Union[int, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param eph_infra_basic_agent_agg_sum: Shows the sum of all ephemeral infrastructure hosts for Basic with the Datadog Agent over all hours in the current month for all organizations.
        :type eph_infra_basic_agent_agg_sum: int, optional

        :param eph_infra_basic_vsphere_agg_sum: Shows the sum of all ephemeral infrastructure hosts for Basic on vSphere over all hours in the current month for all organizations.
        :type eph_infra_basic_vsphere_agg_sum: int, optional
        ...
        :param eph_infra_host_basic_agg_sum: Shows the sum of all ephemeral infrastructure hosts for Basic over all hours in the current month for all organizations.
        ...
        :param infra_basic_agent_host_top99p_sum: Shows the 99th percentile of all distinct infrastructure hosts for Basic with the Datadog Agent over all hours in the current month for all organizations.
        :type infra_basic_agent_host_top99p_sum: int, optional

        :param infra_basic_vsphere_host_top99p_sum: Shows the 99th percentile of all distinct infrastructure hosts for Basic on vSphere over all hours in the current month for all organizations.
        :type infra_basic_vsphere_host_top99p_sum: int, optional
        ...
        :param infra_host_basic_top99p_sum: Shows the 99th percentile of all distinct infrastructure hosts for Basic over all hours in the current month for all organizations.
        ...
        if eph_infra_basic_agent_agg_sum is not unset:
            kwargs["eph_infra_basic_agent_agg_sum"] = eph_infra_basic_agent_agg_sum
        if eph_infra_basic_vsphere_agg_sum is not unset:
            kwargs["eph_infra_basic_vsphere_agg_sum"] = eph_infra_basic_vsphere_agg_sum
        ...
        if infra_basic_agent_host_top99p_sum is not unset:
            kwargs["infra_basic_agent_host_top99p_sum"] = infra_basic_agent_host_top99p_sum
        if infra_basic_vsphere_host_top99p_sum is not unset:
            kwargs["infra_basic_vsphere_host_top99p_sum"] = infra_basic_vsphere_host_top99p_sum
