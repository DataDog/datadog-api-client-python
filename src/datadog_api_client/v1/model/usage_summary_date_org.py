...
class UsageSummaryDateOrg(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param cloud_cost_management_oci_host_count_avg: Host count average of Cloud Cost Management for OCI for the given date and given org.
        ...
        :param eph_infra_host_proxmox_sum: Shows the sum of all ephemeral infrastructure hosts for Proxmox over all hours in the current date for the given org.
        ...
        :param proxmox_host_sum: Shows the sum of all Proxmox hosts over all hours in the current date for the given org.
        :type proxmox_host_sum: int, optional

        :param proxmox_host_top99p: Shows the 99th percentile of all Proxmox hosts over all hours in the current date for the given org.
