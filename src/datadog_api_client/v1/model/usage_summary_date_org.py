...
class UsageSummaryDateOrg(ModelNormal):
    ...
    def __init__(
        ...
        ccm_anthropic_spend_last: Union[int, UnsetType] = unset,
        ccm_aws_spend_last: Union[int, UnsetType] = unset,
        ccm_azure_spend_last: Union[int, UnsetType] = unset,
        ccm_confluent_spend_last: Union[int, UnsetType] = unset,
        ccm_databricks_spend_last: Union[int, UnsetType] = unset,
        ccm_elastic_spend_last: Union[int, UnsetType] = unset,
        ccm_fastly_spend_last: Union[int, UnsetType] = unset,
        ccm_gcp_spend_last: Union[int, UnsetType] = unset,
        ccm_github_spend_last: Union[int, UnsetType] = unset,
        ccm_mongodb_spend_last: Union[int, UnsetType] = unset,
        ccm_oci_spend_last: Union[int, UnsetType] = unset,
        ccm_openai_spend_last: Union[int, UnsetType] = unset,
        ccm_snowflake_spend_last: Union[int, UnsetType] = unset,
        ccm_spend_monitored_ent_last: Union[int, UnsetType] = unset,
        ccm_spend_monitored_pro_last: Union[int, UnsetType] = unset,
        ccm_twilio_spend_last: Union[int, UnsetType] = unset,
        ...
        serverless_apps_apm_apm_gcp_gke_autopilot_pods_avg: Union[int, UnsetType] = unset,
        ...
        serverless_apps_apm_excl_fargate_apm_gcp_gke_autopilot_pods_avg: Union[int, UnsetType] = unset,
        ...
        serverless_apps_excl_fargate_infra_gcp_gke_autopilot_pods_avg: Union[int, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param llm_observability_15day_retention_spans_sum: Shows the sum of all Agent Observability 15-day retention spans over all hours in the current date for the given org.
        :type llm_observability_15day_retention_spans_sum: int, optional

        :param llm_observability_30day_retention_spans_sum: Shows the sum of all Agent Observability 30-day retention spans over all hours in the current date for the given org.
        :type llm_observability_30day_retention_spans_sum: int, optional

        :param llm_observability_60day_retention_spans_sum: Shows the sum of all Agent Observability 60-day retention spans over all hours in the current date for the given org.
        :type llm_observability_60day_retention_spans_sum: int, optional

        :param llm_observability_90day_retention_spans_sum: Shows the sum of all Agent Observability 90-day retention spans over all hours in the current date for the given org.
        :type llm_observability_90day_retention_spans_sum: int, optional

        :param llm_observability_min_spend_sum: Shows the sum of all Agent Observability minimum spend over all hours in the current date for the given org.
        :type llm_observability_min_spend_sum: int, optional

        :param llm_observability_sum: Shows the sum of all Agent observability sessions over all hours in the current date for the given org.
