...
class UsageSummaryDate(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param cloud_cost_management_aws_host_count_avg: Host count average of Cloud Cost Management for AWS for the given date for all organizations.
        :type cloud_cost_management_aws_host_count_avg: int, optional

        :param cloud_cost_management_azure_host_count_avg: Host count average of Cloud Cost Management for Azure for the given date for all organizations.
        :type cloud_cost_management_azure_host_count_avg: int, optional

        :param cloud_cost_management_gcp_host_count_avg: Host count average of Cloud Cost Management for GCP for the given date for all organizations.
        :type cloud_cost_management_gcp_host_count_avg: int, optional

        :param cloud_cost_management_host_count_avg: Host count average of Cloud Cost Management for all cloud providers for the given date for all organizations.
        ...
        :param csm_host_enterprise_aws_host_count_top99p: Shows the 99th percentile of all Cloud Security Management Enterprise AWS hosts over all hours in the current date for all organizations.
        :type csm_host_enterprise_aws_host_count_top99p: int, optional

        :param csm_host_enterprise_azure_host_count_top99p: Shows the 99th percentile of all Cloud Security Management Enterprise Azure hosts over all hours in the current date for all organizations.
        :type csm_host_enterprise_azure_host_count_top99p: int, optional

        :param csm_host_enterprise_compliance_host_count_top99p: Shows the 99th percentile of all Cloud Security Management Enterprise compliance hosts over all hours in the current date for all organizations.
        :type csm_host_enterprise_compliance_host_count_top99p: int, optional

        :param csm_host_enterprise_cws_host_count_top99p: Shows the 99th percentile of all Cloud Security Management Enterprise Cloud Workload Security hosts over all hours in the current date for all organizations.
        ...
        :param sds_logs_scanned_bytes_sum: Shows the sum of all bytes scanned of logs usage by the Sensitive Data Scanner over all hours in the current date for all organizations.
        ...
        :param sds_total_scanned_bytes_sum: Shows the sum of all bytes scanned across all usage types by the Sensitive Data Scanner over all hours in the current date for all organizations.
        :type sds_total_scanned_bytes_sum: int, optional

        :param serverless_apps_azure_count_avg: Shows the average of the number of Serverless Apps for Azure for the given date for all organizations.
        :type serverless_apps_azure_count_avg: int, optional

        :param serverless_apps_google_count_avg: Shows the average of the number of Serverless Apps for Google Cloud for the given date for all organizations.
        :type serverless_apps_google_count_avg: int, optional

        :param serverless_apps_total_count_avg: Shows the average of the number of Serverless Apps for Azure and Google Cloud for the given date for all organizations.
        ...
        :param universal_service_monitoring_host_top99p: Shows the 99th percentile of all universal service management hosts over all hours in the current date for all organizations.
        ...
        :param vuln_management_host_count_top99p: Shows the 99th percentile of all Application Vulnerability Management hosts over all hours in the current date for all organizations.
