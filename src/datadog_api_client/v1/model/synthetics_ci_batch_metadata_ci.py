...
def lazy_import():
    ...
    globals()["SyntheticsCIBatchMetadataPipeline"] = SyntheticsCIBatchMetadataPipeline
    globals()["SyntheticsCIBatchMetadataProvider"] = SyntheticsCIBatchMetadataProvider
