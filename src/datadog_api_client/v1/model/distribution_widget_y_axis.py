...
class DistributionWidgetYAxis(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """DistributionWidgetYAxis - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            scale (str): Specifies the scale type. Possible values are `linear` or `log`.. [optional] if omitted the server will use the default value of "linear"  # noqa: E501
        """
