...
class UsageCIVisibilityHour(ModelNormal):
    ...
    def openapi_types():
        return {
            ...
            "ci_visibility_combo_committers": (int,),
    ...
    def __init__(self, *args, **kwargs):
        """UsageCIVisibilityHour - a model defined in OpenAPI
        ...
        :param ci_visibility_combo_committers: The number of combined test and pipeline committers in the queried hour.
        :type ci_visibility_combo_committers: int, optional

        :param ci_visibility_pipeline_committers: The number of pipeline committers in the queried hour.
        :type ci_visibility_pipeline_committers: int, optional

        :param ci_visibility_test_committers: The number of test committers in the queried hour.
