...
class HeatMapWidgetXAxis(ModelNormal):
    ...
    def __init__(self_, num_buckets: Union[int, UnsetType] = unset, **kwargs):
        ...
        :param num_buckets: Number of time buckets to target, aka the resolution of the time bins. This is only applicable for distribution of points (group distributions use the roll-up modifier).
