...
HourlyUsageAttributionUsageType.BITS_AI_INVESTIGATIONS_USAGE = HourlyUsageAttributionUsageType(
    "bits_ai_investigations_usage"
)
HourlyUsageAttributionUsageType.BROWSER_USAGE = HourlyUsageAttributionUsageType("browser_usage")
HourlyUsageAttributionUsageType.CI_CODE_COVERAGE_COMMITTERS_PERCENTAGE = HourlyUsageAttributionUsageType(
    "ci_code_coverage_committers_percentage"
)
HourlyUsageAttributionUsageType.CI_CODE_COVERAGE_COMMITTERS_USAGE = HourlyUsageAttributionUsageType(
    "ci_code_coverage_committers_usage"
)
...
HourlyUsageAttributionUsageType.PRODUCT_ANALYTICS_SESSION_USAGE = HourlyUsageAttributionUsageType(
    "product_analytics_session_usage"
)
...
HourlyUsageAttributionUsageType.RUM_SESSION_REPLAY_ADD_ON_USAGE = HourlyUsageAttributionUsageType(
    "rum_session_replay_add_on_usage"
)
