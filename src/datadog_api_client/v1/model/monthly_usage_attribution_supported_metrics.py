...
MonthlyUsageAttributionSupportedMetrics.BITS_AI_INVESTIGATIONS_USAGE = MonthlyUsageAttributionSupportedMetrics(
    "bits_ai_investigations_usage"
)
MonthlyUsageAttributionSupportedMetrics.BITS_AI_INVESTIGATIONS_PERCENTAGE = MonthlyUsageAttributionSupportedMetrics(
    "bits_ai_investigations_percentage"
)
...
MonthlyUsageAttributionSupportedMetrics.FLEX_LOGS_STARTER_USAGE = MonthlyUsageAttributionSupportedMetrics(
    "flex_logs_starter_usage"
)
MonthlyUsageAttributionSupportedMetrics.FLEX_LOGS_STARTER_PERCENTAGE = MonthlyUsageAttributionSupportedMetrics(
    "flex_logs_starter_percentage"
)
MonthlyUsageAttributionSupportedMetrics.FLEX_STORED_LOGS_USAGE = MonthlyUsageAttributionSupportedMetrics(
    "flex_stored_logs_usage"
)
MonthlyUsageAttributionSupportedMetrics.FLEX_STORED_LOGS_PERCENTAGE = MonthlyUsageAttributionSupportedMetrics(
    "flex_stored_logs_percentage"
)
...
MonthlyUsageAttributionSupportedMetrics.INFRA_HOST_BASIC_USAGE = MonthlyUsageAttributionSupportedMetrics(
    "infra_host_basic_usage"
)
MonthlyUsageAttributionSupportedMetrics.INFRA_HOST_BASIC_PERCENTAGE = MonthlyUsageAttributionSupportedMetrics(
    "infra_host_basic_percentage"
)
...
MonthlyUsageAttributionSupportedMetrics.LLM_SPANS_PERCENTAGE = MonthlyUsageAttributionSupportedMetrics(
    "llm_spans_percentage"
)
...
MonthlyUsageAttributionSupportedMetrics.SERVERLESS_APPS_APM_USAGE = MonthlyUsageAttributionSupportedMetrics(
    "serverless_apps_apm_usage"
)
MonthlyUsageAttributionSupportedMetrics.SERVERLESS_APPS_APM_PERCENTAGE = MonthlyUsageAttributionSupportedMetrics(
    "serverless_apps_apm_percentage"
)
...
MonthlyUsageAttributionSupportedMetrics.SIEM_12MO_RETENTION_USAGE = MonthlyUsageAttributionSupportedMetrics(
    "siem_12mo_retention_usage"
)
MonthlyUsageAttributionSupportedMetrics.SIEM_12MO_RETENTION_PERCENTAGE = MonthlyUsageAttributionSupportedMetrics(
    "siem_12mo_retention_percentage"
)
MonthlyUsageAttributionSupportedMetrics.SIEM_6MO_RETENTION_USAGE = MonthlyUsageAttributionSupportedMetrics(
    "siem_6mo_retention_usage"
)
MonthlyUsageAttributionSupportedMetrics.SIEM_6MO_RETENTION_PERCENTAGE = MonthlyUsageAttributionSupportedMetrics(
    "siem_6mo_retention_percentage"
)
