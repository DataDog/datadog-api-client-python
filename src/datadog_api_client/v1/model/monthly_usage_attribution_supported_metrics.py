...
class MonthlyUsageAttributionSupportedMetrics(ModelSimple):
    ...
    SDS_EVT_EVENTS: ClassVar["MonthlyUsageAttributionSupportedMetrics"]
    SDS_LOG_EVENTS: ClassVar["MonthlyUsageAttributionSupportedMetrics"]
    SDS_SPANS_EVENTS: ClassVar["MonthlyUsageAttributionSupportedMetrics"]
    SDS_RUM_EVENTS: ClassVar["MonthlyUsageAttributionSupportedMetrics"]
...
MonthlyUsageAttributionSupportedMetrics.SDS_EVT_EVENTS = MonthlyUsageAttributionSupportedMetrics("sds_evt_events")
MonthlyUsageAttributionSupportedMetrics.SDS_LOG_EVENTS = MonthlyUsageAttributionSupportedMetrics("sds_log_events")
MonthlyUsageAttributionSupportedMetrics.SDS_SPANS_EVENTS = MonthlyUsageAttributionSupportedMetrics("sds_spans_events")
MonthlyUsageAttributionSupportedMetrics.SDS_RUM_EVENTS = MonthlyUsageAttributionSupportedMetrics("sds_rum_events")
