...
class SyntheticsMobileStepParamsElement(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param context_type: The definition of ``SyntheticsMobileStepParamsElementContextType`` object.
        :type context_type: SyntheticsMobileStepParamsElementContextType, optional

        :param element_description: The ``element`` ``elementDescription``.
        :type element_description: str, optional

        :param multi_locator: The ``element`` ``multiLocator``.
        :type multi_locator: dict, optional

        :param relative_position: The definition of ``SyntheticsMobileStepParamsElementRelativePosition`` object.
        :type relative_position: SyntheticsMobileStepParamsElementRelativePosition, optional

        :param text_content: The ``element`` ``textContent``.
        :type text_content: str, optional

        :param user_locator: The definition of ``SyntheticsMobileStepParamsElementUserLocator`` object.
        :type user_locator: SyntheticsMobileStepParamsElementUserLocator, optional

        :param view_name: The ``element`` ``viewName``.
