...
*SyntheticsApi* | [**get_synthetics_ci_batch**](SyntheticsApi.md#get_synthetics_ci_batch) | **GET** /api/v1/synthetics/ci/batch/{batch_id} | Get details of batch
...
*UsageMeteringApi* | [**get_usage_dbm**](UsageMeteringApi.md#get_usage_dbm) | **GET** /api/v1/usage/dbm | Get hourly usage for Database Monitoring
...
*UsageMeteringApi* | [**get_usage_sds**](UsageMeteringApi.md#get_usage_sds) | **GET** /api/v1/usage/sds | Get hourly usage for Sensitive Data Scanner
